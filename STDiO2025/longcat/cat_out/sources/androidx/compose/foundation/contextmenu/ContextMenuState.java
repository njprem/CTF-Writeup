        ...
        public static final class Open extends Status {
            ...
            public boolean equals(Object other) {
                ...
                if (other instanceof Open) {
                    return Offset.m3548equalsimpl0(this.offset, ((Open) other).offset);
                }
                return false;
            }
            ...
            public int hashCode() {
                return Offset.m3553hashCodeimpl(this.offset);
            }

            public String toString() {
                return "Open(offset=" + ((Object) Offset.m3559toStringimpl(this.offset)) + ')';
            }
