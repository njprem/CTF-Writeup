...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo306calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(IntOffset.m6361getXimpl(this.localPosition) + anchorBounds.getLeft(), IntSize.m6403getWidthimpl(popupContentSize), IntSize.m6403getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(IntOffset.m6362getYimpl(this.localPosition) + anchorBounds.getTop(), IntSize.m6402getHeightimpl(popupContentSize), IntSize.m6402getHeightimpl(windowSize), false, 8, null));
    }
