...
public final class ContextMenuScope {
    ...
    public static /* synthetic */ void item$default(ContextMenuScope contextMenuScope, Function2 function2, Modifier modifier, boolean z, Function3 function3, Function0 function0, int i2, Object obj) {
        if ((i2 & 2) != 0) {
    ...
    public final void Content$foundation_release(final ContextMenuColors contextMenuColors, Composer composer, final int i2) {
        ...
        int i3 = (i2 & 6) == 0 ? (composerStartRestartGroup.changed(contextMenuColors) ? 4 : 2) | i2 : i2;
        if ((i2 & 48) == 0) {
        ...
        if ((i3 & 19) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                snapshotStateList.get(i4).invoke(contextMenuColors, composerStartRestartGroup, Integer.valueOf(i3 & 14));
            }
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuScope$Content$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    this.$tmp0_rcvr.Content$foundation_release(contextMenuColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public final void item(final Function2<? super Composer, ? super Integer, String> label, final Modifier modifier, final boolean enabled, final Function3<? super Color, ? super Composer, ? super Integer, Unit> leadingIcon, final Function0<Unit> onClick) {
        this.composables.add(ComposableLambdaKt.composableLambdaInstance(262103052, true, new Function3<ContextMenuColors, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuScope.item.1
            ...
            public final void invoke(ContextMenuColors contextMenuColors, Composer composer, int i2) {
                ...
                ContextMenuUi_androidKt.ContextMenuItem(strInvoke, enabled, contextMenuColors, modifier, leadingIcon, onClick, composer, (i2 << 6) & 896, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
