...
public interface PageSize {
    ...
    public static final class Fixed implements PageSize {
        ...
        @Override // androidx.compose.foundation.pager.PageSize
        public int calculateMainAxisPageSize(Density density, int i2, int i3) {
            return density.mo328roundToPx0680j_4(this.pageSize);
        }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof Fixed) {
                return Dp.m6238equalsimpl0(this.pageSize, ((Fixed) other).pageSize);
            }
            return false;
        }
        ...
        public int hashCode() {
            return Dp.m6239hashCodeimpl(this.pageSize);
        }
