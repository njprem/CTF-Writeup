...
public final class PagerSnapDistanceMaxPages implements PagerSnapDistance {
    ...
    public int calculateTargetPage(int startPage, int suggestedTargetPage, float velocity, int pageSize, int pageSpacing) {
        long j2 = startPage;
        return RangesKt.coerceIn(suggestedTargetPage, (int) RangesKt.coerceAtLeast(j2 - this.pagesLimit, 0L), (int) RangesKt.coerceAtMost(j2 + this.pagesLimit, 2147483647L));
    }
