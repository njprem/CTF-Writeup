...
public abstract class TextFieldKeyEventHandler {
    ...
    private final float getVisibleTextLayoutHeight(TextLayoutState textLayoutState) {
        ...
        if (rectLocalBoundingBoxOf$default != null) {
            return Size.m3617getHeightimpl(rectLocalBoundingBoxOf$default.m3584getSizeNHjbRc());
        }
        return Float.NaN;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m5714equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
            return;
        }
        state.m1189selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* renamed from: onKeyEvent-6ptp14s */
    public boolean mo1093onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange textRangeM5709boximpl;
        Integer numM955consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m4842equalsimpl0(KeyEvent_androidKt.m4850getTypeZmokQxo(event), KeyEventType.INSTANCE.m4846getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1039isTypedEventZmokQxo(event) && (numM955consumeZmokQxo = this.deadKeyCombiner.m955consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM955consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1161isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand keyCommandMo957mapZmokQxo = this.keyMapping.mo957mapZmokQxo(event);
        if (keyCommandMo957mapZmokQxo != null && (!keyCommandMo957mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1161isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo957mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case AndroidComposeViewAccessibilityDelegateCompat.AccessibilitySliderStepsCount /* 20 */:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (numValueOf.intValue() == -1) {
                            numValueOf = null;
                        }
                        textRangeM5709boximpl = numValueOf != null ? TextRange.m5709boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m5716getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (textRangeM5709boximpl != null) {
                            TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5709boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 21:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        textRangeM5709boximpl = numValueOf2 != null ? TextRange.m5709boximpl(TextRangeKt.TextRange(TextRange.m5721getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                        if (textRangeM5709boximpl != null) {
                            TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5709boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5716getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    } else {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                ...
                case 23:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5721getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    } else {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                ...
                case 24:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5716getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    } else {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                ...
                case 25:
                    if (TextRange.m5715getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5721getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    } else {
                        TransformedTextFieldState.m1182replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
            ...
            if (!TextRange.m5714equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1189selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    public boolean mo1094onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5715getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m956cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
