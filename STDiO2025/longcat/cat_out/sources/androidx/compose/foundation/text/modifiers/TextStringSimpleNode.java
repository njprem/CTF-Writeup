...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (layoutCache != null) {
            layoutCache.m1271updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult textLayoutResultSlowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(textStyle.m5766mergedA7vx0o((16609104 & 1) != 0 ? Color.INSTANCE.m3828getUnspecified0d7_KjU() : colorProducer != null ? colorProducer.mo1693invoke0d7_KjU() : Color.INSTANCE.m3828getUnspecified0d7_KjU(), (16609104 & 2) != 0 ? TextUnit.INSTANCE.m6437getUnspecifiedXSAIIZE() : 0L, (16609104 & 4) != 0 ? null : null, (16609104 & 8) != 0 ? null : null, (16609104 & 16) != 0 ? null : null, (16609104 & 32) != 0 ? null : null, (16609104 & 64) != 0 ? null : null, (16609104 & 128) != 0 ? TextUnit.INSTANCE.m6437getUnspecifiedXSAIIZE() : 0L, (16609104 & Fields.RotationX) != 0 ? null : null, (16609104 & 512) != 0 ? null : null, (16609104 & 1024) != 0 ? null : null, (16609104 & Fields.CameraDistance) != 0 ? Color.INSTANCE.m3828getUnspecified0d7_KjU() : 0L, (16609104 & 4096) != 0 ? null : null, (16609104 & 8192) != 0 ? null : null, (16609104 & Fields.Clip) != 0 ? null : null, (16609104 & Fields.CompositingStrategy) != 0 ? TextAlign.INSTANCE.m6128getUnspecifiede0LSkKk() : 0, (16609104 & 65536) != 0 ? TextDirection.INSTANCE.m6141getUnspecifieds_7Xco() : 0, (16609104 & Fields.RenderEffect) != 0 ? TextUnit.INSTANCE.m6437getUnspecifiedXSAIIZE() : 0L, (16609104 & 262144) != 0 ? null : null, (16609104 & 524288) != 0 ? null : null, (16609104 & 1048576) != 0 ? LineBreak.INSTANCE.m6055getUnspecifiedrAG3T2k() : 0, (16609104 & 2097152) != 0 ? Hyphens.INSTANCE.m6034getUnspecifiedvmbZdU8() : 0, (16609104 & 4194304) != 0 ? null : null, (16609104 & 8388608) != 0 ? null : null));
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1271updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            if (didOverflow) {
                float fM6403getWidthimpl = IntSize.m6403getWidthimpl(layoutCache.getLayoutSize());
                float fM6402getHeightimpl = IntSize.m6402getHeightimpl(layoutCache.getLayoutSize());
                canvas.save();
                Canvas.m3764clipRectN_I0leg$default(canvas, 0.0f, 0.0f, fM6403getWidthimpl, fM6402getHeightimpl, 0, 16, null);
            }
            try {
                ...
                if (brush != null) {
                    Paragraph.m5596painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ...
                    Paragraph.m5594paintLG529CI$default(paragraph, canvas, jMo1693invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
                if (didOverflow) {
                    canvas.restore();
                }
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        boolean zM1269layoutWithConstraintsK40F9xA = layoutCache.m1269layoutWithConstraintsK40F9xA(j2, measureScope.getLayoutDirection());
        ...
        if (zM1269layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(Constraints.INSTANCE.m6195fitPrioritizingWidthZbe2FdA(IntSize.m6403getWidthimpl(layoutSize), IntSize.m6403getWidthimpl(layoutSize), IntSize.m6402getHeightimpl(layoutSize), IntSize.m6402getHeightimpl(layoutSize)));
        int iM6403getWidthimpl = IntSize.m6403getWidthimpl(layoutSize);
        int iM6402getHeightimpl = IntSize.m6402getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6403getWidthimpl, iM6402getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public final boolean m1278updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i2, boolean z, int i3, int i4, ColorProducer colorProducer, int i5, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i2, boolean z, int i3, int i4, ColorProducer colorProducer) {
        this.text = str;
    ...
    public static final /* data */ class TextSubstitutionValue {
        ...
        public static /* synthetic */ TextSubstitutionValue copy$default(TextSubstitutionValue textSubstitutionValue, String str, String str2, boolean z, ParagraphLayoutCache paragraphLayoutCache, int i2, Object obj) {
            if ((i2 & 1) != 0) {
