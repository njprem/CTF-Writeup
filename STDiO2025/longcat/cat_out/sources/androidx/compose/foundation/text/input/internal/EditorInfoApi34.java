...
final class EditorInfoApi34 {
    ...
    public final void setHandwritingGestures(EditorInfo editorInfo) {
        editorInfo.setSupportedHandwritingGestures(CollectionsKt.listOf((Object[]) new Class[]{e.l(), e.x(), e.s(), e.v(), e.z(), e.B(), e.D()}));
        editorInfo.setSupportedHandwritingGesturePreviews(SetsKt.setOf((Object[]) new Class[]{e.l(), e.x(), e.s(), e.v()}));
    }
}
