...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo2measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j2) {
        return MeasureScope.layout$default(measureScope, Constraints.m6186getMaxWidthimpl(j2), Constraints.m6185getMaxHeightimpl(j2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (listMeasureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        Pair pair = (Pair) listMeasureWithTextRangeMeasureConstraints.get(i2);
                        Placeable placeable = (Placeable) pair.component1();
                        Function0 function0 = (Function0) pair.component2();
                        Placeable.PlacementScope.m5184place70tqf50$default(placementScope, placeable, function0 != null ? ((IntOffset) function0.invoke()).getPackedValue() : IntOffset.INSTANCE.m6371getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
