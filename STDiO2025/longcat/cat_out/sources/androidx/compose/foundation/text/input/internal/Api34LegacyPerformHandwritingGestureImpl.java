...
final class Api34LegacyPerformHandwritingGestureImpl {
    ...
    public final void performHandwritingGesture(LegacyTextFieldState legacyTextFieldState, TextFieldSelectionManager textFieldSelectionManager, HandwritingGesture gesture, ViewConfiguration viewConfiguration, Executor executor, IntConsumer consumer, Function1<? super EditCommand, Unit> editCommandConsumer) {
        int iPerformHandwritingGesture$foundation_release = legacyTextFieldState != null ? HandwritingGestureApi34.INSTANCE.performHandwritingGesture$foundation_release(legacyTextFieldState, gesture, textFieldSelectionManager, viewConfiguration, editCommandConsumer) : 3;
        if (consumer == null) {
            return;
        }
        if (executor != null) {
            executor.execute(new d(consumer, iPerformHandwritingGesture$foundation_release, 0));
        } else {
