...
public final class TextFieldCharSequence implements CharSequence {
    ...
    public boolean equals(Object other) {
        ...
        return TextRange.m5714equalsimpl0(this.selection, textFieldCharSequence.selection) && Intrinsics.areEqual(this.composition, textFieldCharSequence.composition) && Intrinsics.areEqual(this.highlight, textFieldCharSequence.highlight) && contentEquals(textFieldCharSequence.text);
    }
    ...
    public int hashCode() {
        int iM5722hashCodeimpl = (TextRange.m5722hashCodeimpl(this.selection) + (this.text.hashCode() * 31)) * 31;
        TextRange textRange = this.composition;
        int iM5722hashCodeimpl2 = (iM5722hashCodeimpl + (textRange != null ? TextRange.m5722hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
        Pair<TextHighlightType, TextRange> pair = this.highlight;
        return iM5722hashCodeimpl2 + (pair != null ? pair.hashCode() : 0);
    }
    ...
    private TextFieldCharSequence(CharSequence charSequence, long j2, TextRange textRange, Pair<TextHighlightType, TextRange> pair) {
        ...
        this.selection = TextRangeKt.m5727coerceIn8ffj60Q(j2, 0, charSequence.length());
        this.composition = textRange != null ? TextRange.m5709boximpl(TextRangeKt.m5727coerceIn8ffj60Q(textRange.getPackedValue(), 0, charSequence.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m5709boximpl(TextRangeKt.m5727coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, charSequence.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(String str, long j2, TextRange textRange, Pair pair, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? "" : str, (i2 & 2) != 0 ? TextRange.INSTANCE.m5726getZerod9O1mEE() : j2, (i2 & 4) != 0 ? null : textRange, (i2 & 8) != 0 ? null : pair, null);
    }
}
