    ...
    public MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
        ...
        if (listInvoke != null) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                Pair pair = rect != null ? new Pair(((Measurable) arrayList.get(i3)).mo5120measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m6352boximpl(IntOffsetKt.IntOffset(Math.round(rect.getLeft()), Math.round(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList3.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m6186getMaxWidthimpl(j2), Constraints.m6185getMaxHeightimpl(j2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (list2 != null) {
                    ...
                    for (int i5 = 0; i5 < size4; i5++) {
                        ...
                        Placeable.PlacementScope.m5184place70tqf50$default(placementScope, pair2.component1(), pair2.component2().getPackedValue(), 0.0f, 2, null);
                    }
                }
                ...
                if (list3 != null) {
                    ...
                    for (int i6 = 0; i6 < size5; i6++) {
                        ...
                        Placeable.PlacementScope.m5184place70tqf50$default(placementScope, placeableComponent1, function0Component2 != null ? function0Component2.invoke().getPackedValue() : IntOffset.INSTANCE.m6371getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
