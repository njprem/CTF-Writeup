...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public HorizontalScrollLayoutModifier(TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText, Function0<TextLayoutResultProxy> function0) {
    ...
    public int hashCode() {
        return this.textLayoutResultProvider.hashCode() + ((this.transformedText.hashCode() + d.c(this.cursorOffset, this.scrollerPosition.hashCode() * 31, 31)) * 31);
    }

    @Override // androidx.compose.ui.layout.LayoutModifier
    /* renamed from: measure-3p2s80s */
    public MeasureResult mo28measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        long j3;
        if (measurable.maxIntrinsicWidth(Constraints.m6185getMaxHeightimpl(j2)) < Constraints.m6186getMaxWidthimpl(j2)) {
            j3 = j2;
        } else {
            j3 = j2;
            j2 = Constraints.m6177copyZbe2FdA$default(j3, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(j2);
        final int iMin = Math.min(placeableMo5120measureBRTryo0.getWidth(), Constraints.m6186getMaxWidthimpl(j3));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeableMo5120measureBRTryo0.getWidth()), iMin, placeableMo5120measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5120measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
