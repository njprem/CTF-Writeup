...
public final class RecordingInputConnection implements InputConnection {
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m5719getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5715getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo1129onImeActionKlQnJC8(iM5898getDefaulteUduSuo);
        return true;
    }
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM5719getMinimpl = composition != null ? TextRange.m5719getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m5719getMinimpl(state.getSelection()), TextRange.m5718getMaximpl(state.getSelection()), iM5719getMinimpl, composition2 != null ? TextRange.m5718getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public /* synthetic */ RecordingInputConnection(TextFieldValue textFieldValue, InputEventCallback2 inputEventCallback2, boolean z, LegacyTextFieldState legacyTextFieldState, TextFieldSelectionManager textFieldSelectionManager, ViewConfiguration viewConfiguration, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(textFieldValue, inputEventCallback2, z, (i2 & 8) != 0 ? null : legacyTextFieldState, (i2 & 16) != 0 ? null : textFieldSelectionManager, (i2 & 32) != 0 ? null : viewConfiguration);
    }
}
