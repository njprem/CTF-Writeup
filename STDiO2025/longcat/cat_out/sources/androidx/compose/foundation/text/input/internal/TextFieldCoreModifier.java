...
public final /* data */ class TextFieldCoreModifier extends ModifierNodeElement<TextFieldCoreModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return this.orientation.hashCode() + ((this.scrollState.hashCode() + J.d.i(this.writeable, (this.cursorBrush.hashCode() + ((this.textFieldSelectionState.hashCode() + ((this.textFieldState.hashCode() + ((this.textLayoutState.hashCode() + J.d.i(this.isDragHovered, Boolean.hashCode(this.isFocused) * 31, 31)) * 31)) * 31)) * 31)) * 31, 31)) * 31);
    }
