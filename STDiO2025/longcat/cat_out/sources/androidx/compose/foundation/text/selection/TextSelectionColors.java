...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3793equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m3793equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }
    ...
    public int hashCode() {
        return Color.m3799hashCodeimpl(this.backgroundColor) + (Color.m3799hashCodeimpl(this.handleColor) * 31);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("SelectionColors(selectionHandleColor=");
        d.w(this.handleColor, sb, ", selectionBackgroundColor=");
        sb.append((Object) Color.m3800toStringimpl(this.backgroundColor));
        sb.append(')');
        return sb.toString();
    }
