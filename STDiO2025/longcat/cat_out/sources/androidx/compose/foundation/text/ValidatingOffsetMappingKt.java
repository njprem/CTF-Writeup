...
public final class ValidatingOffsetMappingKt {
    ...
    public static final void validateOriginalToTransformed(int i2, int i3, int i4) {
        if (i2 < 0 || i2 > i3) {
            throw new IllegalStateException(androidx.compose.runtime.changelist.a.o(d.q("OffsetMapping.originalToTransformed returned invalid mapping: ", i4, i2, " -> ", " is not in range of transformed text [0, "), i3, ']').toString());
        }
    }
    ...
    public static final void validateTransformedToOriginal(int i2, int i3, int i4) {
        if (i2 < 0 || i2 > i3) {
            throw new IllegalStateException(androidx.compose.runtime.changelist.a.o(d.q("OffsetMapping.transformedToOriginal returned invalid mapping: ", i4, i2, " -> ", " is not in range of original text [0, "), i3, ']').toString());
        }
    }
}
