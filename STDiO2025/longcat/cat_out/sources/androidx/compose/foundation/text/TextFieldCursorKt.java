    ...
    public static final Modifier cursor(Modifier modifier, final LegacyTextFieldState legacyTextFieldState, final TextFieldValue textFieldValue, final OffsetMapping offsetMapping, final Brush brush, boolean z) {
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i2) {
                ...
                if (((WindowInfo) composer.consume(CompositionLocalsKt.getLocalWindowInfo())).isWindowFocused() && legacyTextFieldState.getHasFocus() && TextRange.m5715getCollapsedimpl(textFieldValue.getSelection()) && z2) {
                    composer.startReplaceGroup(808320157);
                    AnnotatedString annotatedString = textFieldValue.getAnnotatedString();
                    TextRange textRangeM5709boximpl = TextRange.m5709boximpl(textFieldValue.getSelection());
                    ...
                    EffectsKt.LaunchedEffect(annotatedString, textRangeM5709boximpl, (Function2) objRememberedValue2, composer, 0);
                    ...
                    if (zChangedInstance2 || objRememberedValue3 == companion.getEmpty()) {
                        objRememberedValue3 = new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1$2$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(ContentDrawScope contentDrawScope) {
                                ...
                                int iOriginalToTransformed = offsetMapping2.originalToTransformed(TextRange.m5721getStartimpl(textFieldValue2.getSelection()));
                                ...
                                float fMo334toPx0680j_4 = contentDrawScope.mo334toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                float f2 = fMo334toPx0680j_4 / 2;
                                float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f2, Size.m3620getWidthimpl(contentDrawScope.mo4342getSizeNHjbRc()) - f2), f2);
                                DrawScope.m4327drawLine1RTmtNc$default(contentDrawScope, brush3, OffsetKt.Offset(fCoerceAtLeast, rect.getTop()), OffsetKt.Offset(fCoerceAtLeast, rect.getBottom()), fMo334toPx0680j_4, 0, null, cursorAlpha, null, 0, 432, null);
                            }
                        };
