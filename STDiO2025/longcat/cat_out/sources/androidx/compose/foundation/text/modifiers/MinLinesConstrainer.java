...
public final class MinLinesConstrainer {
    ...
    public final long m1258coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        float height = this.oneLineHeightCache;
        float height2 = this.lineHeightCache;
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m5603ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & Fields.RotationX) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m5603ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & Fields.RotationX) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        return ConstraintsKt.Constraints(Constraints.m6188getMinWidthimpl(inConstraints), Constraints.m6186getMaxWidthimpl(inConstraints), minLines != 1 ? RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round((height2 * (minLines - 1)) + height), 0), Constraints.m6185getMaxHeightimpl(inConstraints)) : Constraints.m6187getMinHeightimpl(inConstraints), Constraints.m6185getMaxHeightimpl(inConstraints));
    }
