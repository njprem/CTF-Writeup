...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i2 == 0) {
                    ...
                    if (Math.abs(this.I$0) == 1) {
                        CursorAnimationState cursorAnimationState = this.this$0.cursorAnimation;
                        this.label = 1;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Integer>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode.startCursorJob.1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
    ...
    private final int m1151calculateOffsetToFollow72CqOWE(long currSelection, int currTextLayoutSize) {
        TextRange textRange = this.previousSelection;
        if (textRange == null || TextRange.m5716getEndimpl(currSelection) != TextRange.m5716getEndimpl(textRange.getPackedValue())) {
            return TextRange.m5716getEndimpl(currSelection);
        }
        TextRange textRange2 = this.previousSelection;
        if (textRange2 == null || TextRange.m5721getStartimpl(currSelection) != TextRange.m5721getStartimpl(textRange2.getPackedValue())) {
            return TextRange.m5721getStartimpl(currSelection);
        }
    ...
    private final void drawCursor(DrawScope drawScope) {
        ...
        if (cursorAlpha != 0.0f && getShowCursor()) {
            ...
            DrawScope.m4327drawLine1RTmtNc$default(drawScope, this.cursorBrush, cursorRect.m3585getTopCenterF1C5BW0(), cursorRect.m3578getBottomCenterF1C5BW0(), cursorRect.getWidth(), 0, null, cursorAlpha, null, 0, 432, null);
        }
    }
    ...
    private final void drawHighlight(DrawScope drawScope, Pair<TextHighlightType, TextRange> pair, TextLayoutResult textLayoutResult) {
        ...
        if (TextRange.m5715getCollapsedimpl(packedValue)) {
            return;
        }
        Path pathForRange = textLayoutResult.getPathForRange(TextRange.m5719getMinimpl(packedValue), TextRange.m5718getMaximpl(packedValue));
        if (!TextHighlightType.m1076equalsimpl0(value, TextHighlightType.INSTANCE.m1080getHandwritingDeletePreviewsxJuwY())) {
            DrawScope.m4332drawPathLG529CI$default(drawScope, pathForRange, ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
            return;
        }
        Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
        if (brush != null) {
            DrawScope.m4331drawPathGBMwjPU$default(drawScope, pathForRange, brush, 0.2f, null, null, 0, 56, null);
            return;
        }
        long jM5751getColor0d7_KjU = textLayoutResult.getLayoutInput().getStyle().m5751getColor0d7_KjU();
        if (jM5751getColor0d7_KjU == 16) {
            jM5751getColor0d7_KjU = Color.INSTANCE.m3818getBlack0d7_KjU();
        }
        long j2 = jM5751getColor0d7_KjU;
        DrawScope.m4332drawPathLG529CI$default(drawScope, pathForRange, Color.m3791copywmQWz5c$default(j2, Color.m3794getAlphaimpl(j2) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null), 0.0f, null, null, 0, 60, null);
    }

    /* renamed from: drawSelection-Sb-Bc2M, reason: not valid java name */
    private final void m1152drawSelectionSbBc2M(DrawScope drawScope, long j2, TextLayoutResult textLayoutResult) {
        ...
        if (iM5719getMinimpl != iM5718getMaximpl) {
            DrawScope.m4332drawPathLG529CI$default(drawScope, textLayoutResult.getPathForRange(iM5719getMinimpl, iM5718getMaximpl), ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
        }
    }
    ...
    private final MeasureResult m1153measureHorizontalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        final int iMin = Math.min(placeableMo5120measureBRTryo0.getWidth(), Constraints.m6186getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureHorizontalScroll$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1155updateScrollStatetIlFzwE(measureScope, iMin, placeableMo5120measureBRTryo0.getWidth(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5120measureBRTryo0, -this.this$0.scrollState.getValue(), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }

    /* renamed from: measureVerticalScroll-3p2s80s, reason: not valid java name */
    private final MeasureResult m1154measureVerticalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(Constraints.m6177copyZbe2FdA$default(j2, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo5120measureBRTryo0.getHeight(), Constraints.m6185getMaxHeightimpl(j2));
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), iMin, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureVerticalScroll$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1155updateScrollStatetIlFzwE(measureScope, iMin, placeableMo5120measureBRTryo0.getHeight(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5120measureBRTryo0, 0, -this.this$0.scrollState.getValue(), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    */
    public final void m1155updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density r9, int r10, int r11, long r12, androidx.compose.ui.unit.LayoutDirection r14) {
        /*
            r8 = this;
            int r0 = r11 - r10
            androidx.compose.foundation.ScrollState r1 = r8.scrollState
            r1.setMaxValue$foundation_release(r0)
            int r0 = r8.m1151calculateOffsetToFollow72CqOWE(r12, r11)
            if (r0 < 0) goto Lc6
        ...
        La9:
            r1 = 0
        Laa:
            androidx.compose.ui.text.TextRange r10 = androidx.compose.ui.text.TextRange.m5709boximpl(r12)
            ...
            androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$updateScrollState$1 r5 = new androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$updateScrollState$1
            r9 = 0
            r5.<init>(r8, r1, r0, r9)
            r7 = 0
            r3 = 0
        ...
        Lc6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode.m1155updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density, int, int, long, androidx.compose.ui.unit.LayoutDirection):void");
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (TextRange.m5715getCollapsedimpl(visualText.getSelection())) {
            ...
            if (visualText.shouldShowSelection()) {
                m1152drawSelectionSbBc2M(contentDrawScope, visualText.getSelection(), layoutResult);
            }
            drawText(contentDrawScope, layoutResult);
        }
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        return this.orientation == Orientation.Vertical ? m1154measureVerticalScroll3p2s80s(measureScope, measurable, j2) : m1153measureHorizontalScroll3p2s80s(measureScope, measurable, j2);
    }
