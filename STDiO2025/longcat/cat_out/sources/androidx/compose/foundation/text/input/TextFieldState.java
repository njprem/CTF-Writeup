...
public final class TextFieldState {
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m5721getStartimpl(textFieldState.m1070getSelectiond9O1mEE())), Integer.valueOf(TextRange.m5716getEndimpl(textFieldState.m1070getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m5714equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1099getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.getComposition(), this.mainBuffer.m1098getCompositionMzsxiRA()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight())) {
                return;
            }
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1099getSelectiond9O1mEE(), this.mainBuffer.m1098getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1099getSelectiond9O1mEE(), this.mainBuffer.m1098getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean zM5714equalsimpl0 = TextRange.m5714equalsimpl0(textFieldBuffer.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !zM5714equalsimpl0;
        if (zContentEquals && zM5714equalsimpl0) {
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1060toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        } else {
            m1071syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        }
        recordEditForUndo(value$foundation_release, getValue$foundation_release(), textFieldBuffer.getChanges(), undoBehavior);
    }

    public static /* synthetic */ void commitEditAsUser$default(TextFieldState textFieldState, InputTransformation inputTransformation, boolean z, TextFieldEditUndoBehavior textFieldEditUndoBehavior, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        if ((i2 & 4) != 0) {
    ...
    public static /* synthetic */ void editAsUser$foundation_release$default(TextFieldState textFieldState, InputTransformation inputTransformation, boolean z, TextFieldEditUndoBehavior textFieldEditUndoBehavior, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        if ((i2 & 4) != 0) {
    ...
    public final void updateValueAndNotifyListeners(TextFieldCharSequence oldValue, TextFieldCharSequence newValue, boolean restartImeIfContentChanges) {
        ...
        if (size > 0) {
            ...
            int i2 = 0;
            do {
                content[i2].onChange(oldValue, newValue, restartImeIfContentChanges);
                i2++;
            } while (i2 < size);
        }
    }
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM5714equalsimpl0 = true ^ TextRange.m5714equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1099getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1071syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM5714equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1099getSelectiond9O1mEE(), getMainBuffer().m1098getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public final TextRange m1069getCompositionMzsxiRA() {
    ...
    public final long m1070getSelectiond9O1mEE() {
    ...
    public final void m1071syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String string = this.mainBuffer.toString();
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(string, this.mainBuffer.m1099getSelectiond9O1mEE(), this.mainBuffer.m1098getCompositionMzsxiRA(), null, 8, null);
        boolean zAreEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1098getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m5721getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m5716getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m5715getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m5719getMinimpl(newComposition.getPackedValue()), TextRange.m5718getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(string, this.mainBuffer.m1099getSelectiond9O1mEE(), this.mainBuffer.m1098getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public String toString() {
        ...
        Snapshot snapshotMakeCurrentNonObservable = companion.makeCurrentNonObservable(currentThreadSnapshot);
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m5724toStringimpl(m1070getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
        }
    }
    ...
    private TextFieldState(String str, long j2, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m5727coerceIn8ffj60Q(j2, 0, str.length()), (DefaultConstructorMarker) null);
        this.isEditing = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.FALSE, null, 2, null);
        this.value = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TextFieldCharSequence(str, j2, null, null, 12, null), null, 2, null);
    ...
    public /* synthetic */ TextFieldState(String str, long j2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        str = (i2 & 1) != 0 ? "" : str;
        this(str, (i2 & 2) != 0 ? TextRangeKt.TextRange(str.length()) : j2, (DefaultConstructorMarker) null);
    }
