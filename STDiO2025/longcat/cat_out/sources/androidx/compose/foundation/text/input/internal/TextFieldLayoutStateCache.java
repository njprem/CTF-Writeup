...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public static final class CacheRecord extends StateRecord {
        ...
        public final void m1166setCompositionOEnZFl4(TextRange textRange) {
            this.composition = textRange;
        }

        /* renamed from: setConstraints-BRTryo0, reason: not valid java name */
        public final void m1167setConstraintsBRTryo0(long j2) {
            this.constraints = j2;
        }
    ...
    public static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a2, TextFieldLayoutStateCache.MeasureInputs b2) {
                ...
                return a2.getDensityValue() == b2.getDensityValue() && a2.getFontScale() == b2.getFontScale() && a2.getLayoutDirection() == b2.getLayoutDirection() && Intrinsics.areEqual(a2.getFontFamilyResolver(), b2.getFontFamilyResolver()) && Constraints.m6179equalsimpl0(a2.getConstraints(), b2.getConstraints());
            }
        };
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m6191toStringimpl(this.constraints)) + ')';
        }
    ...
    public static final class NonMeasureInputs {
        ...
        private static final SnapshotMutationPolicy<NonMeasureInputs> mutationPolicy = new SnapshotMutationPolicy<NonMeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$NonMeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.NonMeasureInputs a2, TextFieldLayoutStateCache.NonMeasureInputs b2) {
                ...
                return a2.getTextFieldState() == b2.getTextFieldState() && Intrinsics.areEqual(a2.getTextStyle(), b2.getTextStyle()) && a2.getSingleLine() == b2.getSingleLine() && a2.getSoftWrap() == b2.getSoftWrap();
            }
        };
        ...
        if (!Intrinsics.areEqual(textLayoutResultComputeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1166setCompositionOEnZFl4(visualText2.getComposition());
                    ...
                    cacheRecord3.m1167setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    public final TextLayoutResult m1163layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
