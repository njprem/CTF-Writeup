...
public final /* data */ class TextFieldHandleState {
    ...
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.INSTANCE.m3566getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    ...
    public static /* synthetic */ TextFieldHandleState m1197copyubNVwUQ$default(TextFieldHandleState textFieldHandleState, boolean z, long j2, ResolvedTextDirection resolvedTextDirection, boolean z2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textFieldHandleState.m1199copyubNVwUQ(z, j2, resolvedTextDirection, z2);
    }
    ...
    public final TextFieldHandleState m1199copyubNVwUQ(boolean visible, long position, ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m3548equalsimpl0(this.position, textFieldHandleState.position) && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }
    ...
    public int hashCode() {
        return Boolean.hashCode(this.handlesCrossed) + ((this.direction.hashCode() + ((Offset.m3553hashCodeimpl(this.position) + (Boolean.hashCode(this.visible) * 31)) * 31)) * 31);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m3559toStringimpl(this.position)) + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
