...
public final class TextDelegate {
    ...
    public static /* synthetic */ TextLayoutResult m1012layoutNN6EwU$default(TextDelegate textDelegate, long j2, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1015layoutNN6EwU(j2, layoutDirection, textLayoutResult);
    }

    /* renamed from: layoutText-K40F9xA, reason: not valid java name */
    private final MultiParagraph m1013layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM6188getMinWidthimpl = Constraints.m6188getMinWidthimpl(constraints);
        int iM6186getMaxWidthimpl = ((this.softWrap || TextOverflow.m6164equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6172getEllipsisgIe3tQ8())) && Constraints.m6182getHasBoundedWidthimpl(constraints)) ? Constraints.m6186getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i2 = (this.softWrap || !TextOverflow.m6164equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6172getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM6188getMinWidthimpl != iM6186getMaxWidthimpl) {
            iM6186getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM6188getMinWidthimpl, iM6186getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m6195fitPrioritizingWidthZbe2FdA(0, iM6186getMaxWidthimpl, 0, Constraints.m6185getMaxHeightimpl(constraints)), i2, TextOverflow.m6164equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6172getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m1015layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1048canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m5692copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m6200constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM1013layoutTextK40F9xA = m1013layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM1013layoutTextK40F9xA, ConstraintsKt.m6200constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM1013layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM1013layoutTextK40F9xA.getHeight()))), null);
    }
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i2, int i3, boolean z, int i4, Density density, FontFamily.Resolver resolver, List list, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i5 & 4) != 0 ? Integer.MAX_VALUE : i2, (i5 & 8) != 0 ? 1 : i3, (i5 & 16) != 0 ? true : z, (i5 & 32) != 0 ? TextOverflow.INSTANCE.m6171getClipgIe3tQ8() : i4, density, resolver, (i5 & Fields.RotationX) != 0 ? CollectionsKt.emptyList() : list, null);
    }
}
