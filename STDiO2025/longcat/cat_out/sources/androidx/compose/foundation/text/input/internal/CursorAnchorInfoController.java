...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4022constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4031resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo5136transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m3662setFromEL8BTi8(this.androidMatrix, this.matrix);
                    Rect rectVisibleBounds = SelectionManagerKt.visibleBounds(coreNodeCoordinates);
                    Offset.Companion companion = Offset.INSTANCE;
                    return CursorAnchorInfoBuilder_androidKt.m1096buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, rectVisibleBounds.m3588translatek4lQ0M(textLayoutNodeCoordinates.mo5129localPositionOfR5De75A(coreNodeCoordinates, companion.m3567getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m3588translatek4lQ0M(textLayoutNodeCoordinates.mo5129localPositionOfR5De75A(decoratorNodeCoordinates, companion.m3567getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
