...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1065getOriginalRangejx7JFs = changeList.mo1065getOriginalRangejx7JFs(0);
            long jMo1066getRangejx7JFs = changeList.mo1066getRangejx7JFs(0);
            if (TextRange.m5715getCollapsedimpl(jMo1065getOriginalRangejx7JFs) && TextRange.m5715getCollapsedimpl(jMo1066getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m5719getMinimpl(jMo1065getOriginalRangejx7JFs), TextRangeKt.m5728substringFDrldGo(textFieldCharSequence, jMo1065getOriginalRangejx7JFs), TextRangeKt.m5728substringFDrldGo(textFieldCharSequence2, jMo1066getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }

    public static /* synthetic */ void recordChanges$default(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            z = true;
        }
