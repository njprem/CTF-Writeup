...
public final class MultiWidgetSelectionDelegate implements Selectable {
        ...
        try {
            if (this._previousTextLayoutResult != textLayoutResult) {
                if (!textLayoutResult.getDidOverflowHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                    ...
                    int iCoerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition(IntSize.m6402getHeightimpl(textLayoutResult.getSize())), textLayoutResult.getLineCount() - 1);
                    while (iCoerceAtMost >= 0 && textLayoutResult.getLineTop(iCoerceAtMost) >= IntSize.m6402getHeightimpl(textLayoutResult.getSize())) {
                        iCoerceAtMost--;
                    }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long jMo5129localPositionOfR5De75A = containerCoordinates.mo5129localPositionOfR5De75A(layoutCoordinates, companion.m3567getZeroF1C5BW0());
        MultiWidgetSelectionDelegateKt.m1286appendSelectableInfoParwq6A(builder, textLayoutResultInvoke, Offset.m3555minusMKHz9U(builder.getCurrentPosition(), jMo5129localPositionOfR5De75A), OffsetKt.m3572isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition()) ? companion.m3566getUnspecifiedF1C5BW0() : Offset.m3555minusMKHz9U(builder.getPreviousHandlePosition(), jMo5129localPositionOfR5De75A), getSelectableId());
    }
    ...
    public long mo1284getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
    ...
    public long mo1285getRangeOfLineContainingjx7JFs(int offset) {
        TextLayoutResult textLayoutResultInvoke = this.layoutResultCallback.invoke();
        if (textLayoutResultInvoke == null) {
