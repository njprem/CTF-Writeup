...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public static /* synthetic */ BaseTextPreparedSelection apply$default(BaseTextPreparedSelection baseTextPreparedSelection, Object obj, boolean z, Function1 function1, int i2, Object obj2) {
        if (obj2 != null) {
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i2) {
        while (i2 < this.originalText.length()) {
            ...
            if (TextRange.m5716getEndimpl(jM5695getWordBoundaryjx7JFs) > i2) {
                return this.offsetMapping.transformedToOriginal(TextRange.m5716getEndimpl(jM5695getWordBoundaryjx7JFs));
            }
            i2++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i2) {
        while (i2 > 0) {
            ...
            if (TextRange.m5721getStartimpl(jM5695getWordBoundaryjx7JFs) < i2) {
                return this.offsetMapping.transformedToOriginal(TextRange.m5721getStartimpl(jM5695getWordBoundaryjx7JFs));
            }
            i2--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i2) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m5693getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX.floatValue(), lineBottom)));
    }

    private final T moveCursorNext() {
        int nextCharacterIndex;
        if (d.f(this) > 0 && (nextCharacterIndex = getNextCharacterIndex()) != -1) {
    ...
    private final T moveCursorNextByWord() {
        ...
        if (d.f(this) > 0 && (nextWordOffset = getNextWordOffset()) != null) {
    ...
    private final T moveCursorPrev() {
        ...
        if (d.f(this) > 0 && (precedingCharacterIndex = getPrecedingCharacterIndex()) != -1) {
    ...
    private final T moveCursorPrevByWord() {
        ...
        if (d.f(this) > 0 && (previousWordOffset = getPreviousWordOffset()) != null) {
    ...
    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5716getEndimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5718getMaximpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5719getMinimpl(this.selection));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final <U> T apply(U u2, boolean z, Function1<? super U, Unit> function1) {
        if (z) {
    ...
    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m5716getEndimpl(this.selection));
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m5716getEndimpl(this.selection));
    }
    ...
    public final T moveCursorNextByParagraph() {
        if (d.f(this) > 0) {
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m5718getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m5718getMaximpl(this.selection) && iFindParagraphEnd != getText$foundation_release().length()) {
    ...
    public final T moveCursorPrevByParagraph() {
        if (d.f(this) > 0) {
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m5719getMinimpl(this.selection));
    ...
    public final T moveCursorToLineEnd() {
        ...
        if (d.f(this) > 0 && (lineEndByOffset = getLineEndByOffset()) != null) {
    ...
    public final T moveCursorToLineStart() {
        ...
        if (d.f(this) > 0 && (lineStartByOffset = getLineStartByOffset()) != null) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m5721getStartimpl(this.originalSelection), TextRange.m5716getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final void m1282setSelection5zctL8(long j2) {
        this.selection = j2;
    }
