    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j2, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            ...
            /* JADX WARN: Multi-variable type inference failed */
            {
                ...
                this.lastPosition = companion.m3567getZeroF1C5BW0();
            ...
            public void mo1019onDragk4lQ0M(long delta) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    long j3 = j2;
                    if (layoutCoordinatesInvoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j3)) {
                        long jM3556plusMKHz9U = Offset.m3556plusMKHz9U(this.dragTotalDistance, delta);
                        this.dragTotalDistance = jM3556plusMKHz9U;
                        long jM3556plusMKHz9U2 = Offset.m3556plusMKHz9U(this.lastPosition, jM3556plusMKHz9U);
                        if (selectionRegistrar2.mo1344notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, jM3556plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getWord(), true)) {
                            this.lastPosition = jM3556plusMKHz9U2;
            ...
            public void mo1020onStartk4lQ0M(long startPoint) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    selectionRegistrar2.mo1345notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            private long lastPosition = Offset.INSTANCE.m3567getZeroF1C5BW0();
            ...
            public boolean mo1228onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo1344notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
            ...
            public boolean mo1229onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo1344notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo1230onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo1344notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
            ...
            public boolean mo1231onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.mo1345notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j3);
            }
