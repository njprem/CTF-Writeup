...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f2) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5726getZerod9O1mEE();
    ...
    public final int m1042getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5721getStartimpl(selection) != TextRange.m5721getStartimpl(this.previousSelection) ? TextRange.m5721getStartimpl(selection) : TextRange.m5716getEndimpl(selection) != TextRange.m5716getEndimpl(this.previousSelection) ? TextRange.m5716getEndimpl(selection) : TextRange.m5719getMinimpl(selection);
    }
    ...
    public final void m1044setPreviousSelection5zctL8(long j2) {
