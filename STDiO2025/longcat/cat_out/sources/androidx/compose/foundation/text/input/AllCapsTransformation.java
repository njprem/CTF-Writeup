...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m5930getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 126, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i2 = 0; i2 < changes.getChangeCount(); i2++) {
            long jMo1066getRangejx7JFs = changes.mo1066getRangejx7JFs(i2);
            changes.mo1065getOriginalRangejx7JFs(i2);
            if (!TextRange.m5715getCollapsedimpl(jMo1066getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m5719getMinimpl(jMo1066getRangejx7JFs), TextRange.m5718getMaximpl(jMo1066getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m5728substringFDrldGo(textFieldBuffer.asCharSequence(), jMo1066getRangejx7JFs), this.locale));
            }
        }
    }
}
