...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        TextLayoutResult textLayoutResultM1174layoutWithNewMeasureInputshBUhpc = this.textLayoutState.m1174layoutWithNewMeasureInputshBUhpc(measureScope, measureScope.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), j2);
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(Constraints.INSTANCE.m6195fitPrioritizingWidthZbe2FdA(IntSize.m6403getWidthimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize()), IntSize.m6403getWidthimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize()), IntSize.m6402getHeightimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize()), IntSize.m6402getHeightimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize())));
        this.textLayoutState.m1175setMinHeightForSingleLineField0680j_4(this.singleLine ? measureScope.mo331toDpu2uoSUM(TextDelegateKt.ceilToIntPx(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getLineBottom(0))) : Dp.m6233constructorimpl(0));
        Map<AlignmentLine, Integer> linkedHashMap = this.baselineCache;
        if (linkedHashMap == null) {
            linkedHashMap = new LinkedHashMap<>(2);
        }
        linkedHashMap.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(Math.round(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getFirstBaseline())));
        linkedHashMap.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(Math.round(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getLastBaseline())));
        this.baselineCache = linkedHashMap;
        int iM6403getWidthimpl = IntSize.m6403getWidthimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize());
        int iM6402getHeightimpl = IntSize.m6402getHeightimpl(textLayoutResultM1174layoutWithNewMeasureInputshBUhpc.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6403getWidthimpl, iM6402getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }
