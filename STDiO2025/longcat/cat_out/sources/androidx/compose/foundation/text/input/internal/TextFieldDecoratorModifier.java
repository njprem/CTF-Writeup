...
public final /* data */ class TextFieldDecoratorModifier extends ModifierNodeElement<TextFieldDecoratorModifierNode> {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (this.keyboardOptions.hashCode() + J.d.i(this.readOnly, J.d.i(this.enabled, (iHashCode + (inputTransformation == null ? 0 : inputTransformation.hashCode())) * 31, 31), 31)) * 31;
        KeyboardActionHandler keyboardActionHandler = this.keyboardActionHandler;
        return this.interactionSource.hashCode() + J.d.i(this.singleLine, (iHashCode2 + (keyboardActionHandler != null ? keyboardActionHandler.hashCode() : 0)) * 31, 31);
    }
