...
public final class TextLayoutResultProxy {
    ...
    */
    private final long m1049coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1055access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1049coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
    ...
    public static /* synthetic */ int m1050getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j2, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1051getOffsetForPosition3MmeM6k(j2, z);
    }
    ...
    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m3552getYimpl(m1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1049coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1051getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m1049coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m5693getOffsetForPositionk4lQ0M(m1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }
    ...
    public final boolean m1052isPositionOnTextk4lQ0M(long offset) {
        long jM1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1049coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m3552getYimpl(jM1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release));
        return Offset.m3551getXimpl(jM1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m3551getXimpl(jM1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release) <= this.value.getLineRight(lineForVerticalPosition);
    }
    ...
    public final long m1053translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        return layoutCoordinates3 == null ? offset : layoutCoordinates2.mo5129localPositionOfR5De75A(layoutCoordinates3, offset);
    }

    /* renamed from: translateInnerToDecorationCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1054translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 == null) {
            return offset;
        ...
        LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
        return layoutCoordinates3 == null ? offset : layoutCoordinates3.mo5129localPositionOfR5De75A(layoutCoordinates2, offset);
    }
