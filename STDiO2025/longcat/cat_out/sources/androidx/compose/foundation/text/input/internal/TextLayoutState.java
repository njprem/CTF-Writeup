...
public final class TextLayoutState {
    ...
    public static /* synthetic */ int m1169getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j2, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1172getOffsetForPosition3MmeM6k(j2, z);
    }
    ...
    */
    public final long m1170coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long r6) {
        /*
            r5 = this;
        ...
        L22:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L28:
            long r6 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1176coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextLayoutState.m1170coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long):long");
    }
    ...
    public final float m1171getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m6247unboximpl();
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1172getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (coerceInVisibleBounds) {
            position = m1170coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(position);
        }
        return layoutResult.m5693getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1177fromDecorationToTextLayoutUv8p0NA(this, position));
    }
    ...
    public final boolean m1173isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long jM1177fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1177fromDecorationToTextLayoutUv8p0NA(this, m1170coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Offset.m3552getYimpl(jM1177fromDecorationToTextLayoutUv8p0NA));
        return Offset.m3551getXimpl(jM1177fromDecorationToTextLayoutUv8p0NA) >= layoutResult.getLineLeft(lineForVerticalPosition) && Offset.m3551getXimpl(jM1177fromDecorationToTextLayoutUv8p0NA) <= layoutResult.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: layoutWithNewMeasureInputs--hBUhpc, reason: not valid java name */
    public final TextLayoutResult m1174layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult textLayoutResultM1163layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1163layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
        ...
        return textLayoutResultM1163layoutWithNewMeasureInputshBUhpc;
    }
    ...
    public final void m1175setMinHeightForSingleLineField0680j_4(float f2) {
