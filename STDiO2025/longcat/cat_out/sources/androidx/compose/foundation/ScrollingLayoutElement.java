...
public final class ScrollingLayoutElement extends ModifierNodeElement<ScrollingLayoutNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Boolean.hashCode(this.isVertical) + d.i(this.isReversed, this.scrollState.hashCode() * 31, 31);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.isReversed, inspectorInfo.getProperties(), "isReversed", inspectorInfo).set("isVertical", Boolean.valueOf(this.isVertical));
    }
