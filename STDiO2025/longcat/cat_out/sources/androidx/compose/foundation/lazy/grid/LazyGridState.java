...
public final class LazyGridState implements ScrollableState {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                this.label = 1;
                if (ScrollExtensionsKt.stopScroll$default(lazyGridState, null, this, 1, null) == coroutine_suspended) {
    ...
    public static final class C02731 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C02731(Continuation<? super C02731> continuation) {
            super(continuation);
        }
    ...
    public static /* synthetic */ void applyMeasureResult$foundation_release$default(LazyGridState lazyGridState, LazyGridMeasureResult lazyGridMeasureResult, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = false;
        }
    ...
    public final MutableState<Unit> m788getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m789getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
            boolean r0 = r8 instanceof androidx.compose.foundation.lazy.grid.LazyGridState.C02731
            if (r0 == 0) goto L13
            r0 = r8
            androidx.compose.foundation.lazy.grid.LazyGridState$scroll$1 r0 = (androidx.compose.foundation.lazy.grid.LazyGridState.C02731) r0
            int r1 = r0.label
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    for (int i4 = 0; i4 < size; i4++) {
                        Pair<Integer, Constraints> pair = listInvoke.get(i4);
                        arrayList.add(lazyGridState.getPrefetchState().m814schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                    }
    ...
    public /* synthetic */ LazyGridState(int i2, int i3, LazyGridPrefetchStrategy lazyGridPrefetchStrategy, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 0 : i2, (i4 & 2) != 0 ? 0 : i3, (i4 & 4) != 0 ? LazyGridPrefetchStrategyKt.LazyGridPrefetchStrategy$default(0, 1, null) : lazyGridPrefetchStrategy);
    }
