...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    private final long m856childConstraintsJhjzzOo(int slot, int span) {
        int i2;
        if (span == 1) {
            ...
            int i4 = (slot + span) - 1;
            i2 = (this.resolvedSlots.getPositions()[i4] + this.resolvedSlots.getSizes()[i4]) - i3;
        }
        return this.isVertical ? Constraints.INSTANCE.m6198fixedWidthOenEA2s(i2) : Constraints.INSTANCE.m6197fixedHeightOenEA2s(i2);
    }

    /* renamed from: createItem-pitSLOA */
    public abstract LazyStaggeredGridMeasuredItem mo850createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m857getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM856childConstraintsJhjzzOo = m856childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo850createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo813measure0kLqBqw(index, jM856childConstraintsJhjzzOo), jM856childConstraintsJhjzzOo);
    }
    ...
    public LazyStaggeredGridMeasuredItem mo756getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo850createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo813measure0kLqBqw(index, constraints), constraints);
    }
}
