...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m787childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        int i2;
        if (span == 1) {
        ...
        return this.isVertical ? Constraints.INSTANCE.m6198fixedWidthOenEA2s(iCoerceAtLeast) : Constraints.INSTANCE.m6197fixedHeightOenEA2s(iCoerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int iM765getCurrentLineSpanimpl = GridItemSpan.m765getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).getPackedValue());
            LazyGridMeasuredItem lazyGridMeasuredItemM786getAndMeasurem8Kt_7k = this.measuredItemProvider.m786getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i4, m787childConstraintsJhjzzOo$foundation_release(i3, iM765getCurrentLineSpanimpl), i3, iM765getCurrentLineSpanimpl, i2);
            i3 += iM765getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = lazyGridMeasuredItemM786getAndMeasurem8Kt_7k;
        }
        return createLine(lineIndex, lazyGridMeasuredItemArr, lineConfiguration.getSpans(), i2);
    }
