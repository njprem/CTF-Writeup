...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo769invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m6174boximpl(constraints));
