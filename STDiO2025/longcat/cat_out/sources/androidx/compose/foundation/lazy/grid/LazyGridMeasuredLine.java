...
public final class LazyGridMeasuredLine {
    ...
    public LazyGridMeasuredLine(int i2, LazyGridMeasuredItem[] lazyGridMeasuredItemArr, LazyGridSlots lazyGridSlots, List<GridItemSpan> list, boolean z, int i3) {
        this.index = i2;
    ...
    public final LazyGridMeasuredItem[] position(int offset, int layoutWidth, int layoutHeight) {
        ...
        while (i6 < length) {
            ...
            int i9 = i7 + 1;
            int iM765getCurrentLineSpanimpl = GridItemSpan.m765getCurrentLineSpanimpl(this.spans.get(i7).getPackedValue());
            int i10 = this.slots.getPositions()[i8];
            boolean z = this.isVertical;
            int i11 = z ? this.index : i8;
            if (z) {
                i2 = i8;
                i5 = offset;
                i3 = layoutWidth;
            ...
            lazyGridMeasuredItem.position(i5, i10, i3, i4, i11, i2);
            Unit unit = Unit.INSTANCE;
            i8 += iM765getCurrentLineSpanimpl;
            i6++;
            i7 = i9;
        }
        return this.items;
