    ...
    private final void updateCachedSemanticsValues() {
        ...
        this.scrollToIndexAction = this.userScrollEnabled ? new Function1<Integer, Boolean>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsModifierNode.updateCachedSemanticsValues.3
            ...
            public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public AnonymousClass2(LazyLayoutSemanticsModifierNode lazyLayoutSemanticsModifierNode, int i2, Continuation<? super AnonymousClass2> continuation) {
            ...
            public final Boolean invoke(int i2) {
                ...
                StringBuilder sbP = a.p(i2, "Can't scroll to index ", ", it is out of bounds [0, ");
                sbP.append(lazyLayoutItemProvider.getItemCount());
                sbP.append(')');
