...
public interface IntervalList<T> {
    ...
    public static final class Interval<T> {
        ...
        public Interval(int i2, int i3, T t) {
            ...
            this.value = t;
            if (i2 < 0) {
                throw new IllegalArgumentException(a.n("startIndex should be >= 0, but was ", i2).toString());
            }
            if (i3 <= 0) {
                throw new IllegalArgumentException(a.n("size should be >0, but was ", i3).toString());
            }
        }
