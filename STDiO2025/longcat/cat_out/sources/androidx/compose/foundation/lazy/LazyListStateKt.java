...
public final class LazyListStateKt {
    private static final float DeltaThresholdForScrollAnimation = Dp.m6233constructorimpl(1);
    ...
    public static final LazyListState rememberLazyListState(final int i2, final int i3, Composer composer, int i4, int i5) {
        ...
        boolean z = ((((i4 & 14) ^ 6) > 4 && composer.changed(i2)) || (i4 & 6) == 4) | ((((i4 & 112) ^ 48) > 32 && composer.changed(i3)) || (i4 & 48) == 32);
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3378rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final LazyListState rememberLazyListState(int i2, int i3, LazyListPrefetchStrategy lazyListPrefetchStrategy, Composer composer, int i4, int i5) {
        ...
        boolean z = ((((i4 & 14) ^ 6) > 4 && composer.changed(i6)) || (i4 & 6) == 4) | ((((i4 & 112) ^ 48) > 32 && composer.changed(i7)) || (i4 & 48) == 32) | ((((i4 & 896) ^ 384) > 256 && composer.changedInstance(lazyListPrefetchStrategy2)) || (i4 & 384) == 256);
        Object objRememberedValue2 = composer.rememberedValue();
        if (z || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new Function0<LazyListState>() { // from class: androidx.compose.foundation.lazy.LazyListStateKt$rememberLazyListState$3$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                @Override // kotlin.jvm.functions.Function0
                public final LazyListState invoke() {
                    return new LazyListState(i6, i7, lazyListPrefetchStrategy2);
                }
            };
            composer.updateRememberedValue(objRememberedValue2);
        }
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3378rememberSaveable(objArr, (Saver) saverSaver$foundation_release, (String) null, (Function0) objRememberedValue2, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return lazyListState;
