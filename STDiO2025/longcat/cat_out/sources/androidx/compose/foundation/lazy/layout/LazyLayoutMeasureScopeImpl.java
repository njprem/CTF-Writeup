...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public List<Placeable> mo813measure0kLqBqw(int index, long constraints) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(listSubcompose.get(i2).mo5120measureBRTryo0(constraints));
        }
    ...
    public int mo327roundToPxR2X_6o(long j2) {
        return this.subcomposeMeasureScope.mo327roundToPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo328roundToPx0680j_4(float f2) {
        return this.subcomposeMeasureScope.mo328roundToPx0680j_4(f2);
    }
    ...
    public float mo329toDpGaN1DYA(long j2) {
        return this.subcomposeMeasureScope.mo329toDpGaN1DYA(j2);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo331toDpu2uoSUM(int i2) {
        return this.subcomposeMeasureScope.mo331toDpu2uoSUM(i2);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo332toDpSizekrfVVM(long j2) {
        return this.subcomposeMeasureScope.mo332toDpSizekrfVVM(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo333toPxR2X_6o(long j2) {
        return this.subcomposeMeasureScope.mo333toPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo334toPx0680j_4(float f2) {
        return this.subcomposeMeasureScope.mo334toPx0680j_4(f2);
    }
    ...
    public long mo335toSizeXkaWNTQ(long j2) {
        return this.subcomposeMeasureScope.mo335toSizeXkaWNTQ(j2);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo336toSp0xMU5do(float f2) {
        return this.subcomposeMeasureScope.mo336toSp0xMU5do(f2);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo337toSpkPz2Gy4(float f2) {
        return this.subcomposeMeasureScope.mo337toSpkPz2Gy4(f2);
    }
    ...
    public float mo330toDpu2uoSUM(float f2) {
        return this.subcomposeMeasureScope.mo330toDpu2uoSUM(f2);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo338toSpkPz2Gy4(int i2) {
        return this.subcomposeMeasureScope.mo338toSpkPz2Gy4(i2);
    }
}
