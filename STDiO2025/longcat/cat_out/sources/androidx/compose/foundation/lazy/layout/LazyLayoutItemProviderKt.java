...
public final class LazyLayoutItemProviderKt {
    public static final int findIndexByKey(LazyLayoutItemProvider lazyLayoutItemProvider, Object obj, int i2) {
        int index;
        return (obj == null || lazyLayoutItemProvider.getItemCount() == 0 || (i2 < lazyLayoutItemProvider.getItemCount() && Intrinsics.areEqual(obj, lazyLayoutItemProvider.getKey(i2))) || (index = lazyLayoutItemProvider.getIndex(obj)) == -1) ? i2 : index;
    }
}
