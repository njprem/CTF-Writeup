...
public final class LazyGridStateKt {
    ...
    public static final LazyGridState rememberLazyGridState(final int i2, final int i3, Composer composer, int i4, int i5) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m3378rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final LazyGridState rememberLazyGridState(int i2, int i3, LazyGridPrefetchStrategy lazyGridPrefetchStrategy, Composer composer, int i4, int i5) {
        ...
        boolean z = ((((i4 & 14) ^ 6) > 4 && composer.changed(i6)) || (i4 & 6) == 4) | ((((i4 & 112) ^ 48) > 32 && composer.changed(i7)) || (i4 & 48) == 32) | ((((i4 & 896) ^ 384) > 256 && composer.changedInstance(lazyGridPrefetchStrategy2)) || (i4 & 384) == 256);
        Object objRememberedValue2 = composer.rememberedValue();
        if (z || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new Function0<LazyGridState>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridStateKt$rememberLazyGridState$3$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                @Override // kotlin.jvm.functions.Function0
                public final LazyGridState invoke() {
                    return new LazyGridState(i6, i7, lazyGridPrefetchStrategy2);
                }
            };
            composer.updateRememberedValue(objRememberedValue2);
        }
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m3378rememberSaveable(objArr, (Saver) saverSaver$foundation_release, (String) null, (Function0) objRememberedValue2, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return lazyGridState;
