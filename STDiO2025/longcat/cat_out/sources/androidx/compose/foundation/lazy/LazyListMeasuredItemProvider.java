...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public static /* synthetic */ LazyListMeasuredItem m755getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, long j2, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m757getAndMeasure0kLqBqw(i2, j2);
    }

    /* renamed from: createItem-X9ElhV4 */
    public abstract LazyListMeasuredItem mo745createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);

    /* renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m757getAndMeasure0kLqBqw(int index, long constraints) {
        return mo745createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo813measure0kLqBqw(index, constraints), constraints);
    }
    ...
    private LazyListMeasuredItemProvider(long j2, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        this.itemProvider = lazyListItemProvider;
        this.measureScope = lazyLayoutMeasureScope;
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m6186getMaxWidthimpl(j2) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m6185getMaxHeightimpl(j2), 5, null);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc, reason: not valid java name */
    public LazyListMeasuredItem mo756getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m757getAndMeasure0kLqBqw(index, constraints);
    }
}
