...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public int hashCode() {
        ...
        int i2 = d.i(this.enabled, (iHashCode2 + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31, 31);
        Role role = this.role;
        return this.onClick.hashCode() + ((i2 + (role != null ? Role.m5528hashCodeimpl(role.getValue()) : 0)) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("selectable");
        d.k(this.selected, inspectorInfo.getProperties(), "selected", inspectorInfo).set("interactionSource", this.interactionSource);
        inspectorInfo.getProperties().set("indicationNodeFactory", this.indicationNodeFactory);
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("role", this.role);
    ...
    public void update(SelectableNode node) {
        node.m897updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
}
