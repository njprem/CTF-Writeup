...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return this.onValueChange.hashCode() + ((i2 + (role != null ? Role.m5528hashCodeimpl(role.getValue()) : 0)) * 31);
    }
    ...
    public void update(ToggleableNode node) {
        node.m906updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
}
