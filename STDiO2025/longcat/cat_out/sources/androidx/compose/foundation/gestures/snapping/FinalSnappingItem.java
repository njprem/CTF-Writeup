...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m479constructorimpl(0);
    private static final int NextItem = m479constructorimpl(1);
    private static final int PreviousItem = m479constructorimpl(2);
    ...
    public static final /* synthetic */ FinalSnappingItem m478boximpl(int i2) {
        return new FinalSnappingItem(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m479constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m480equalsimpl(int i2, Object obj) {
        return (obj instanceof FinalSnappingItem) && i2 == ((FinalSnappingItem) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m481equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m482hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m483toStringimpl(int i2) {
        return d.m("FinalSnappingItem(value=", i2, ')');
    }
