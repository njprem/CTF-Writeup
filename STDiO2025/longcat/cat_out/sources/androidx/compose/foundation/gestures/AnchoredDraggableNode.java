...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect == null) {
                            ...
                            AnchoredDragScope.dragTo$default(anchoredDragScope2, anchoredDraggableState.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m348toFloatk4lQ0M(anchoredDraggableNode2.m346reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                            return;
                        }
                        ...
                        long jM346reverseIfNeededMKHz9U = anchoredDraggableNode.m346reverseIfNeededMKHz9U(dragDelta.getDelta());
                        int iM4886getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m4886getUserInputWNlRxjI();
                        ...
                        overscrollEffect.mo179applyToScrollRhakbz0(jM346reverseIfNeededMKHz9U, iM4886getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                return Offset.m3540boximpl(m353invokeMKHz9U(offset.getPackedValue()));
                            }

                            /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                            public final long m353invokeMKHz9U(long j2) {
                                float fNewOffsetForDelta$foundation_release = ((AnchoredDraggableNode) anchoredDraggableNode3).state.newOffsetForDelta$foundation_release(anchoredDraggableNode3.m348toFloatk4lQ0M(j2));
                                AnchoredDraggableNode<T> anchoredDraggableNode4 = anchoredDraggableNode3;
                                long jM349toOffsettuRUvjQ = anchoredDraggableNode4.m349toOffsettuRUvjQ(fNewOffsetForDelta$foundation_release - ((AnchoredDraggableNode) anchoredDraggableNode4).state.requireOffset());
                                AnchoredDragScope.dragTo$default(anchoredDragScope3, fNewOffsetForDelta$foundation_release, 0.0f, 2, null);
                                return jM349toOffsettuRUvjQ;
                            }
                        });
                    }
                };
    ...
    public final long m345reverseIfNeededAH228Gc(long j2) {
        return Velocity.m6476timesadjELrA(j2, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m346reverseIfNeededMKHz9U(long j2) {
        return Offset.m3558timestuRUvjQ(j2, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-TH1AsA0, reason: not valid java name */
    public final float m347toFloatTH1AsA0(long j2) {
        return this.orientation == Orientation.Vertical ? Velocity.m6471getYimpl(j2) : Velocity.m6470getXimpl(j2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m348toFloatk4lQ0M(long j2) {
        return this.orientation == Orientation.Vertical ? Offset.m3552getYimpl(j2) : Offset.m3551getXimpl(j2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toOffset-tuRUvjQ, reason: not valid java name */
    public final long m349toOffsettuRUvjQ(float f2) {
    ...
    public final long m350toVelocityadjELrA(float f2) {
        Orientation orientation = this.orientation;
        float f3 = orientation == Orientation.Horizontal ? f2 : 0.0f;
        if (orientation != Orientation.Vertical) {
            f2 = 0.0f;
