...
public final class Draggable2DNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Draggable2DNode$onDragStopped$1(Draggable2DNode draggable2DNode, long j2, Continuation<? super Draggable2DNode$onDragStopped$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            Velocity velocityM6461boximpl = Velocity.m6461boximpl(this.this$0.m402reverseIfNeededAH228Gc(this.$velocity));
            this.label = 1;
            if (function3.invoke(coroutineScope, velocityM6461boximpl, this) == coroutine_suspended) {
