...
final class AnchoredDraggableElement<T> extends ModifierNodeElement<AnchoredDraggableNode<T>> {
    ...
    public int hashCode() {
        ...
        int iHashCode = (i2 + (bool != null ? bool.hashCode() : 0)) * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        int i3 = d.i(this.startDragImmediately, (iHashCode + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0)) * 31, 31);
        OverscrollEffect overscrollEffect = this.overscrollEffect;
        return i3 + (overscrollEffect != null ? overscrollEffect.hashCode() : 0);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("reverseDirection", this.reverseDirection);
        inspectorInfo.getProperties().set("interactionSource", this.interactionSource);
        d.k(this.startDragImmediately, inspectorInfo.getProperties(), "startDragImmediately", inspectorInfo).set("overscrollEffect", this.overscrollEffect);
    }
