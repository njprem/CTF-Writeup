...
final class ScrollableElement extends ModifierNodeElement<ScrollableNode> {
    ...
    public int hashCode() {
        ...
        int i2 = d.i(this.reverseDirection, d.i(this.enabled, (iHashCode + (overscrollEffect != null ? overscrollEffect.hashCode() : 0)) * 31, 31), 31);
        FlingBehavior flingBehavior = this.flingBehavior;
        int iHashCode2 = (i2 + (flingBehavior != null ? flingBehavior.hashCode() : 0)) * 31;
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.reverseDirection, d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo), "reverseDirection", inspectorInfo).set("flingBehavior", this.flingBehavior);
