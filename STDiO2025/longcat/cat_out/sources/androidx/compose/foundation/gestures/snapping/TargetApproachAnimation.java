...
final class TargetApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(ScrollScope scrollScope, float f2, float f3, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        Object objAnimateWithTarget = SnapFlingBehaviorKt.animateWithTarget(scrollScope, Math.signum(f3) * Math.abs(f2), f2, AnimationStateKt.AnimationState$default(0.0f, f3, 0L, 0L, false, 28, null), this.animationSpec, function1, continuation);
