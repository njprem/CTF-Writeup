...
public final class Draggable2DKt$NoOpOnDragStopped$1 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
    int label;

    public Draggable2DKt$NoOpOnDragStopped$1(Continuation<? super Draggable2DKt$NoOpOnDragStopped$1> continuation) {
    ...
    public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
        return m398invokeLuvzFrg(coroutineScope, velocity.getPackedValue(), continuation);
    }

    /* renamed from: invoke-LuvzFrg, reason: not valid java name */
    public final Object m398invokeLuvzFrg(CoroutineScope coroutineScope, long j2, Continuation<? super Unit> continuation) {
