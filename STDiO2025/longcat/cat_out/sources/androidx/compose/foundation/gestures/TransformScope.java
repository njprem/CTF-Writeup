...
public interface TransformScope {
    ...
    static /* synthetic */ void m470transformByd4ec7I$default(TransformScope transformScope, float f2, long j2, float f3, int i2, Object obj) {
        if (obj != null) {
        ...
        transformScope.mo365transformByd4ec7I(f2, j2, f3);
    }

    /* renamed from: transformBy-d-4ec7I */
    void mo365transformByd4ec7I(float zoomChange, long panChange, float rotationChange);
}
