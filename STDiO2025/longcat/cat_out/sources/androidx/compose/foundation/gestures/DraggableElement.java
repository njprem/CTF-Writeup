...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int i2 = d.i(this.enabled, (this.orientation.hashCode() + (this.state.hashCode() * 31)) * 31, 31);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.reverseDirection, d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo), "reverseDirection", inspectorInfo).set("interactionSource", this.interactionSource);
