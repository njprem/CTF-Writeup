...
final class TransformableElement extends ModifierNodeElement<TransformableNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Boolean.hashCode(this.enabled) + d.i(this.lockRotationOnZoomPan, (this.canPan.hashCode() + (this.state.hashCode() * 31)) * 31, 31);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("lockRotationOnZoomPan", Boolean.valueOf(this.lockRotationOnZoomPan));
    }
