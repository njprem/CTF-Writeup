...
public final class DefaultFlingBehavior implements FlingBehavior {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Float>, Object> {
        ...
        public AnonymousClass2(float f2, DefaultFlingBehavior defaultFlingBehavior, ScrollScope scrollScope, Continuation<? super AnonymousClass2> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (Math.abs(this.$initialVelocity) > 1.0f) {
                    ...
                    if (SuspendAnimationKt.animateDecay$default(animationState, flingDecay, false, function1, this, 2, null) == coroutine_suspended) {
