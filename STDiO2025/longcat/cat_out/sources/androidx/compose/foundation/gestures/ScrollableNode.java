...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m446invoke3MmeM6k(offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m446invoke3MmeM6k(long j2, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m3540boximpl(j2), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            this.label = 1;
            Object objM442semanticsScrollByd4ec7I = ScrollableKt.m442semanticsScrollByd4ec7I(scrollingLogic, j2, this);
            return objM442semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM442semanticsScrollByd4ec7I;
        }
    }
    ...
    public ScrollableNode(ScrollableState scrollableState, OverscrollEffect overscrollEffect, FlingBehavior flingBehavior, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, BringIntoViewSpec bringIntoViewSpec) {
        ...
        ScrollingLogic scrollingLogic = new ScrollingLogic(scrollableState, overscrollEffect2, r1 == 0 ? defaultFlingBehavior : r1, orientation, z2, nestedScrollDispatcher);
    ...
    private final void m445processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$processMouseWheelEvent$2$1(this, scrollConfig.mo355calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size), null), 3, null);
    ...
    private final void setScrollSemanticsActions() {
        this.scrollByAction = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableNode.setScrollSemanticsActions.1
            ...
            public static final class C00211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public C00211(ScrollableNode scrollableNode, float f2, float f3, Continuation<? super C00211> continuation) {
                    super(2, continuation);
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00211(this.this$0, this.$x, this.$y, continuation);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i2 == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableKt.m442semanticsScrollByd4ec7I(scrollingLogic, jOffset, this) == coroutine_suspended) {
            ...
            public final Boolean invoke(float f2, float f3) {
                BuildersKt__Builders_commonKt.launch$default(ScrollableNode.this.getCoroutineScope(), null, null, new C00211(ScrollableNode.this, f2, f3, null), 3, null);
                return Boolean.TRUE;
            }
        };
    ...
    public void mo351onDragStartedk4lQ0M(long startedPosition) {
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    /* renamed from: onDragStopped-TH1AsA0 */
    public void mo352onDragStoppedTH1AsA0(long velocity) {
    ...
    public boolean mo169onKeyEventZmokQxo(KeyEvent event) {
        ...
        if ((!Key.m4541equalsimpl0(jM4849getKeyZmokQxo, companion.m4729getPageDownEK5gGoQ()) && !Key.m4541equalsimpl0(KeyEvent_androidKt.m4849getKeyZmokQxo(event), companion.m4730getPageUpEK5gGoQ())) || !KeyEventType.m4842equalsimpl0(KeyEvent_androidKt.m4850getTypeZmokQxo(event), KeyEventType.INSTANCE.m4846getKeyDownCS__XNY()) || KeyEvent_androidKt.m4853isCtrlPressedZmokQxo(event)) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM6402getHeightimpl = IntSize.m6402getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m4541equalsimpl0(KeyEvent_androidKt.m4849getKeyZmokQxo(event), companion.m4730getPageUpEK5gGoQ()) ? iM6402getHeightimpl : -iM6402getHeightimpl);
        } else {
            int iM6403getWidthimpl = IntSize.m6403getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m4541equalsimpl0(KeyEvent_androidKt.m4849getKeyZmokQxo(event), companion.m4730getPageUpEK5gGoQ()) ? iM6403getWidthimpl : -iM6403getWidthimpl, 0.0f);
        }
    ...
    public void mo170onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            ...
            if (getCanDrag().invoke(changes.get(i2)).booleanValue()) {
                super.mo170onPointerEventH0pRuoY(pointerEvent, pass, bounds);
                break;
            }
            i2++;
        }
        if (pass == PointerEventPass.Main && PointerEventType.m4940equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4949getScroll7fucELk())) {
            m445processMouseWheelEventO0kMr_c(pointerEvent, bounds);
        }
    }
