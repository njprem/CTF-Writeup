...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo355calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j2) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3540boximpl = Offset.m3540boximpl(Offset.INSTANCE.m3567getZeroF1C5BW0());
        int size = changes.size();
        for (int i2 = 0; i2 < size; i2++) {
            offsetM3540boximpl = Offset.m3540boximpl(Offset.m3556plusMKHz9U(offsetM3540boximpl.getPackedValue(), changes.get(i2).getScrollDelta()));
        }
        return Offset.m3558timestuRUvjQ(offsetM3540boximpl.getPackedValue(), -density.mo334toPx0680j_4(Dp.m6233constructorimpl(64)));
    }
}
