...
public final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public ScrollableKt$semanticsScrollBy$2(ScrollingLogic scrollingLogic, long j2, Ref.FloatRef floatRef, Continuation<? super ScrollableKt$semanticsScrollBy$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            float fM459toFloatk4lQ0M = this.$this_semanticsScrollBy.m459toFloatk4lQ0M(this.$offset);
            ...
            Function2<Float, Float, Unit> function2 = new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                ...
                public final void invoke(float f2, float f3) {
                    ...
                    floatRef.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m459toFloatk4lQ0M(nestedScrollScope.mo415scrollByOzD1aCk(scrollingLogic2.m460toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f4)), NestedScrollSource.INSTANCE.m4886getUserInputWNlRxjI())));
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, fM459toFloatk4lQ0M, 0.0f, null, function2, this, 12, null) == coroutine_suspended) {
