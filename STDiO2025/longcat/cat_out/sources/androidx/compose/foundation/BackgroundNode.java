...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode {
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (Color.m3793equalsimpl0(this.color, Color.INSTANCE.m3828getUnspecified0d7_KjU())) {
            contentDrawScope2 = contentDrawScope;
        } else {
            contentDrawScope2 = contentDrawScope;
            OutlineKt.m4050drawOutlinewDX37Ww$default(contentDrawScope2, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m4048drawOutlinehn5TExg$default(contentDrawScope2, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3793equalsimpl0(this.color, Color.INSTANCE.m3828getUnspecified0d7_KjU())) {
            DrawScope.m4336drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m4335drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        ...
        if (Size.m3616equalsimpl0(contentDrawScope.mo4342getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ?? r1 = this.lastOutline;
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.foundation.BackgroundNode.getOutline.1
                ...
                public final void invoke2() {
                    objectRef.element = this.getShape().mo245createOutlinePq9zytI(contentDrawScope.mo4342getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
                }
            });
        }
        this.lastOutline = (Outline) objectRef.element;
        this.lastSize = contentDrawScope.mo4342getSizeNHjbRc();
    ...
    public void onObservedReadsChanged() {
        this.lastSize = Size.INSTANCE.m3628getUnspecifiedNHjbRc();
