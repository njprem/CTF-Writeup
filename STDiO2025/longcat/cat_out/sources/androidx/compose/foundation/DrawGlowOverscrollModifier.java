...
final class DrawGlowOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final boolean drawBottomGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m251drawWithRotationAndOffsetubNVwUQ(180.0f, OffsetKt.Offset(-Size.m3620getWidthimpl(drawScope.mo4342getSizeNHjbRc()), (-Size.m3617getHeightimpl(drawScope.mo4342getSizeNHjbRc())) + drawScope.mo334toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom())), edgeEffect, canvas);
    }

    private final boolean drawLeftGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m251drawWithRotationAndOffsetubNVwUQ(270.0f, OffsetKt.Offset(-Size.m3617getHeightimpl(drawScope.mo4342getSizeNHjbRc()), drawScope.mo334toPx0680j_4(this.overscrollConfig.getDrawPadding().mo593calculateLeftPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawRightGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m251drawWithRotationAndOffsetubNVwUQ(90.0f, OffsetKt.Offset(0.0f, drawScope.mo334toPx0680j_4(this.overscrollConfig.getDrawPadding().mo594calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection())) + (-MathKt.roundToInt(Size.m3620getWidthimpl(drawScope.mo4342getSizeNHjbRc())))), edgeEffect, canvas);
    }

    private final boolean drawTopGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m251drawWithRotationAndOffsetubNVwUQ(0.0f, OffsetKt.Offset(0.0f, drawScope.mo334toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop())), edgeEffect, canvas);
    }

    /* renamed from: drawWithRotationAndOffset-ubNVwUQ, reason: not valid java name */
    private final boolean m251drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
        int iSave = canvas.save();
        canvas.rotate(rotationDegrees);
        canvas.translate(Offset.m3551getXimpl(offset), Offset.m3552getYimpl(offset));
