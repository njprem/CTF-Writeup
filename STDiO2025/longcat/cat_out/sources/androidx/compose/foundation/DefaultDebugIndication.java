...
final class DefaultDebugIndication implements IndicationNodeFactory {
    ...
    public static final class DefaultDebugIndicationInstance extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed) {
                DrawScope.m4336drawRectnJ9OG0$default(contentDrawScope, Color.m3791copywmQWz5c$default(Color.INSTANCE.m3818getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo4342getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered || this.isFocused) {
                DrawScope.m4336drawRectnJ9OG0$default(contentDrawScope, Color.m3791copywmQWz5c$default(Color.INSTANCE.m3818getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo4342getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
