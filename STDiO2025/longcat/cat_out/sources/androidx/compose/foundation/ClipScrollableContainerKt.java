...
public final class ClipScrollableContainerKt {
    ...
    private static final float MaxSupportedElevation = Dp.m6233constructorimpl(30);
    ...
    static {
        ...
        HorizontalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
            ...
            public Outline mo245createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float fMo328roundToPx0680j_4 = density.mo328roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(0.0f, -fMo328roundToPx0680j_4, Size.m3620getWidthimpl(size), Size.m3617getHeightimpl(size) + fMo328roundToPx0680j_4));
            }
        });
        VerticalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
            ...
            public Outline mo245createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float fMo328roundToPx0680j_4 = density.mo328roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(-fMo328roundToPx0680j_4, 0.0f, Size.m3620getWidthimpl(size) + fMo328roundToPx0680j_4, Size.m3617getHeightimpl(size)));
            }
        });
    }
