...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo908createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3620getWidthimpl(size) - topEnd, 0.0f);
        Path.lineTo(Size.m3620getWidthimpl(size), topEnd);
        Path.lineTo(Size.m3620getWidthimpl(size), Size.m3617getHeightimpl(size) - bottomEnd);
        Path.lineTo(Size.m3620getWidthimpl(size) - bottomEnd, Size.m3617getHeightimpl(size));
        Path.lineTo(bottomStart, Size.m3617getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3617getHeightimpl(size) - bottomStart);
        Path.close();
