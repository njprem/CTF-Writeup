...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m912toRadiusBz7bX_o(float f2) {
    ...
    public Outline mo908createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        return ((topStart + topEnd) + bottomEnd) + bottomStart == 0.0f ? new Outline.Rectangle(SizeKt.m3641toRectuvyYCjk(size)) : new Outline.Rounded(RoundRectKt.m3603RoundRectZAM2FJo(SizeKt.m3641toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
