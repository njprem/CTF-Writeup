...
final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m922copy0680j_4$default(DpCornerSize dpCornerSize, float f2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = dpCornerSize.size;
        }
        return dpCornerSize.m923copy0680j_4(f2);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m923copy0680j_4(float size) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DpCornerSize) && Dp.m6238equalsimpl0(this.size, ((DpCornerSize) other).size);
    }

    @Override // androidx.compose.ui.platform.InspectableValue
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m6231boximpl(m924getValueOverrideD9Ej5fM());
    }

    /* renamed from: getValueOverride-D9Ej5fM, reason: not valid java name */
    public float m924getValueOverrideD9Ej5fM() {
        return this.size;
    }
    ...
    public float mo916toPxTmRCtEA(long shapeSize, Density density) {
        return density.mo334toPx0680j_4(this.size);
    }
