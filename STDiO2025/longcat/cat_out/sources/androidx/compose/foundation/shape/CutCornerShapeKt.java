...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m918CutCornerShape0680j_4(float f2) {
        return CutCornerShape(CornerSizeKt.m917CornerSize0680j_4(f2));
    }

    /* renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m919CutCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new CutCornerShape(CornerSizeKt.m917CornerSize0680j_4(f2), CornerSizeKt.m917CornerSize0680j_4(f3), CornerSizeKt.m917CornerSize0680j_4(f4), CornerSizeKt.m917CornerSize0680j_4(f5));
    }

    /* renamed from: CutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ CutCornerShape m920CutCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m919CutCornerShapea9UjIt4(f2, f3, f4, f5);
    }
