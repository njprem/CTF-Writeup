...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return this.onClick.hashCode() + ((iHashCode2 + (role != null ? Role.m5528hashCodeimpl(role.getValue()) : 0)) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("clickable");
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("onClick", this.onClick);
    ...
    public void update(ClickableNode node) {
        node.m238updateQzZPfjk(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
}
