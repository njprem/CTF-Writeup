...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        CheckScrollableContainerConstraintsKt.m225checkScrollableContainerConstraintsK40F9xA(j2, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(Constraints.m6177copyZbe2FdA$default(j2, 0, this.isVertical ? Constraints.m6186getMaxWidthimpl(j2) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m6185getMaxHeightimpl(j2), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo5120measureBRTryo0.getWidth(), Constraints.m6186getMaxWidthimpl(j2));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo5120measureBRTryo0.getHeight(), Constraints.m6185getMaxHeightimpl(j2));
        final int height = placeableMo5120measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo5120measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                int i2 = this.this$0.getIsReversed() ? iCoerceIn - height : -iCoerceIn;
