...
public final class BorderStroke {
    ...
    public static /* synthetic */ BorderStroke m221copyD5KLDUw$default(BorderStroke borderStroke, float f2, Brush brush, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return borderStroke.m222copyD5KLDUw(f2, brush);
    }

    /* renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m222copyD5KLDUw(float width, Brush brush) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6238equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }
    ...
    public int hashCode() {
        return this.brush.hashCode() + (Dp.m6239hashCodeimpl(this.width) * 31);
    }
