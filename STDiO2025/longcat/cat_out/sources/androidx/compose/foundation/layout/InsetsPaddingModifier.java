...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo28measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(ConstraintsKt.m6205offsetNN6EwU(j2, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m6203constrainWidthK40F9xA(j2, placeableMo5120measureBRTryo0.getWidth() + right), ConstraintsKt.m6202constrainHeightK40F9xA(j2, placeableMo5120measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5120measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }
