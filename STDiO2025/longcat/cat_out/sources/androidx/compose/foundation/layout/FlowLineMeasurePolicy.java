...
public interface FlowLineMeasurePolicy extends RowColumnMeasurePolicy {
    ...
    default long mo557createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing) {
    ...
    default MeasureResult placeHelper(final Placeable[] placeables, final MeasureScope measureScope, final int beforeCrossAxisAlignmentLine, final int[] mainAxisPositions, int mainAxisLayoutSize, final int crossAxisLayoutSize, final int[] crossAxisOffset, final int currentLineIndex, final int startIndex, final int endIndex) {
        ...
        return MeasureScope.layout$default(measureScope, i3, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLineMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                int i4 = iArr != null ? iArr[currentLineIndex] : 0;
                int i5 = startIndex;
                while (i5 < endIndex) {
                    Placeable placeable = placeables[i5];
                    Intrinsics.checkNotNull(placeable);
                    int crossAxisPosition = this.getCrossAxisPosition(placeable, RowColumnImplKt.getRowColumnParentData(placeable), crossAxisLayoutSize, measureScope.getLayoutDirection(), beforeCrossAxisAlignmentLine) + i4;
                    if (this.isHorizontal()) {
                        placementScope2 = placementScope;
                        Placeable.PlacementScope.place$default(placementScope2, placeable, mainAxisPositions[i5 - startIndex], crossAxisPosition, 0.0f, 4, null);
                    } else {
                        placementScope2 = placementScope;
                        Placeable.PlacementScope.place$default(placementScope2, placeable, crossAxisPosition, mainAxisPositions[i5 - startIndex], 0.0f, 4, null);
                    }
                    i5++;
