...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5120measureBRTryo0, measureScope.mo328roundToPx0680j_4(this.this$0.getX()), measureScope.mo328roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo5120measureBRTryo0, measureScope.mo328roundToPx0680j_4(this.this$0.getX()), measureScope.mo328roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public final void m606setX0680j_4(float f2) {
        this.x = f2;
    }

    /* renamed from: setY-0680j_4, reason: not valid java name */
    public final void m607setY0680j_4(float f2) {
        this.y = f2;
    }
