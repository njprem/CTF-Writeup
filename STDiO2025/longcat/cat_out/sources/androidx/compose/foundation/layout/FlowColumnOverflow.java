...
public final class FlowColumnOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
                    ...
                    return ComposableLambdaKt.composableLambdaInstance(19371081, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandIndicator$seeMoreGetter$1.1
                        ...
                        public final void invoke(Composer composer, int i2) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(19371081, i2, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:262)");
                            }
        ...
        public final FlowColumnOverflow m564expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function32, int i2, float f2, Composer composer, int i3, int i4) {
            boolean z = true;
            int i5 = (i4 & 4) != 0 ? 1 : i2;
            float fM6233constructorimpl = (i4 & 8) != 0 ? Dp.m6233constructorimpl(0) : f2;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(972645562, i3, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:304)");
            }
            ...
            if (z2 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                FlowColumnOverflow flowColumnOverflow = new FlowColumnOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i5, iMo328roundToPx0680j_4, new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState flowLayoutOverflowState) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(617878374, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer composer2, int i6) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(617878374, i6, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:316)");
                                }
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState flowLayoutOverflowState) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(1004384103, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer composer2, int i6) {
                                ...
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1004384103, i6, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:323)");
                                }
                                function33.invoke(new FlowColumnOverflowScopeImpl(flowLayoutOverflowState), composer2, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
    ...
    static {
        ...
        Visible = new FlowColumnOverflow(FlowLayoutOverflow.OverflowType.Visible, 0, i2, null, function1, 30, null);
        Clip = new FlowColumnOverflow(FlowLayoutOverflow.OverflowType.Clip, i2, 0, function1, null, 30, null);
    }
