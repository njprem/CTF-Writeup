...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        return AlignmentLineKt.m491alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j2);
    }

    /* renamed from: setAfter-0680j_4, reason: not valid java name */
    public final void m504setAfter0680j_4(float f2) {
        this.after = f2;
    }
    ...
    public final void m505setBefore0680j_4(float f2) {
        this.before = f2;
    }
