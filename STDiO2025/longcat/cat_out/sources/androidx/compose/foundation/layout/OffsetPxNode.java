...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo5120measureBRTryo0, IntOffset.m6361getXimpl(packedValue), IntOffset.m6362getYimpl(packedValue), 0.0f, (Function1) null, 12, (Object) null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5120measureBRTryo0, IntOffset.m6361getXimpl(packedValue), IntOffset.m6362getYimpl(packedValue), 0.0f, (Function1) null, 12, (Object) null);
                }
            }
        }, 4, null);
    }
