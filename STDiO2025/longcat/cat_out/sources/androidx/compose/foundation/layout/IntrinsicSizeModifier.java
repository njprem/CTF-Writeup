...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo596calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j2);
    ...
    public final MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        long jMo596calculateContentConstraintsl58MMJ0 = mo596calculateContentConstraintsl58MMJ0(measureScope, measurable, j2);
        if (getEnforceIncoming()) {
            jMo596calculateContentConstraintsl58MMJ0 = ConstraintsKt.m6201constrainN9IONVI(j2, jMo596calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(jMo596calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5185placeRelative70tqf50$default(placementScope, placeableMo5120measureBRTryo0, IntOffset.INSTANCE.m6371getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
