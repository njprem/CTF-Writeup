...
public interface RowColumnMeasurePolicy {
    ...
    static /* synthetic */ long m667createConstraintsxF2OJ5Q$default(RowColumnMeasurePolicy rowColumnMeasurePolicy, int i2, int i3, int i4, int i5, boolean z, int i6, Object obj) {
        if (obj != null) {
        ...
        return rowColumnMeasurePolicy.mo557createConstraintsxF2OJ5Q(i2, i3, i4, i5, z);
    }

    /* renamed from: createConstraints-xF2OJ5Q */
    long mo557createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing);
