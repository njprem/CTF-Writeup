...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        int iM6188getMinWidthimpl = direction != direction2 ? 0 : Constraints.m6188getMinWidthimpl(j2);
        Direction direction3 = this.direction;
        Direction direction4 = Direction.Horizontal;
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(ConstraintsKt.Constraints(iM6188getMinWidthimpl, (this.direction == direction2 || !this.unbounded) ? Constraints.m6186getMaxWidthimpl(j2) : Integer.MAX_VALUE, direction3 == direction4 ? Constraints.m6187getMinHeightimpl(j2) : 0, (this.direction == direction4 || !this.unbounded) ? Constraints.m6185getMaxHeightimpl(j2) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo5120measureBRTryo0.getWidth(), Constraints.m6188getMinWidthimpl(j2), Constraints.m6186getMaxWidthimpl(j2));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo5120measureBRTryo0.getHeight(), Constraints.m6187getMinHeightimpl(j2), Constraints.m6185getMaxHeightimpl(j2));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5184place70tqf50$default(placementScope, placeableMo5120measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m6395boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo5120measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo5120measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
