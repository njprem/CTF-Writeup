...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m554copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m556copy0kLqBqw(density, j2);
    }
    ...
    public final BoxWithConstraintsScopeImpl m556copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m6179equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getConstraints-msEJaDk */
    public long mo549getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo550getMaxHeightD9Ej5fM() {
        return Constraints.m6181getHasBoundedHeightimpl(mo549getConstraintsmsEJaDk()) ? this.density.mo331toDpu2uoSUM(Constraints.m6185getMaxHeightimpl(mo549getConstraintsmsEJaDk())) : Dp.INSTANCE.m6252getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo551getMaxWidthD9Ej5fM() {
        return Constraints.m6182getHasBoundedWidthimpl(mo549getConstraintsmsEJaDk()) ? this.density.mo331toDpu2uoSUM(Constraints.m6186getMaxWidthimpl(mo549getConstraintsmsEJaDk())) : Dp.INSTANCE.m6252getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo552getMinHeightD9Ej5fM() {
        return this.density.mo331toDpu2uoSUM(Constraints.m6187getMinHeightimpl(mo549getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo553getMinWidthD9Ej5fM() {
        return this.density.mo331toDpu2uoSUM(Constraints.m6188getMinWidthimpl(mo549getConstraintsmsEJaDk()));
    }

    public int hashCode() {
        return Constraints.m6189hashCodeimpl(this.constraints) + (this.density.hashCode() * 31);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m6191toStringimpl(this.constraints)) + ')';
    }
