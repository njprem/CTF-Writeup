...
final class LimitInsets implements WindowInsets {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.insets, limitInsets.insets) && WindowInsetsSides.m722equalsimpl0(this.sides, limitInsets.sides);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        if (WindowInsetsSides.m723hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m733getBottomJoeWqyM())) {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        if (WindowInsetsSides.m723hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m729getAllowLeftInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m730getAllowLeftInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        if (WindowInsetsSides.m723hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m731getAllowRightInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m732getAllowRightInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getTop(Density density) {
        if (WindowInsetsSides.m723hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m739getTopJoeWqyM())) {
    ...
    public int hashCode() {
        return WindowInsetsSides.m724hashCodeimpl(this.sides) + (this.insets.hashCode() * 31);
    }

    public String toString() {
        return "(" + this.insets + " only " + ((Object) WindowInsetsSides.m726toStringimpl(this.sides)) + ')';
    }
