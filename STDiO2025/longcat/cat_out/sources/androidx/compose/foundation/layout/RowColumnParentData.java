...
public final /* data */ class RowColumnParentData {
    ...
    public static /* synthetic */ RowColumnParentData copy$default(RowColumnParentData rowColumnParentData, float f2, boolean z, CrossAxisAlignment crossAxisAlignment, FlowLayoutData flowLayoutData, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public int hashCode() {
        int i2 = d.i(this.fill, Float.hashCode(this.weight) * 31, 31);
        CrossAxisAlignment crossAxisAlignment = this.crossAxisAlignment;
        int iHashCode = (i2 + (crossAxisAlignment == null ? 0 : crossAxisAlignment.hashCode())) * 31;
    ...
    public /* synthetic */ RowColumnParentData(float f2, boolean z, CrossAxisAlignment crossAxisAlignment, FlowLayoutData flowLayoutData, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0.0f : f2, (i2 & 2) != 0 ? true : z, (i2 & 4) != 0 ? null : crossAxisAlignment, (i2 & 8) != 0 ? null : flowLayoutData);
    }
}
