...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        return AlignmentLineKt.m491alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m6444isUnspecifiedR2X_6o(this.before) ? measureScope.mo329toDpGaN1DYA(this.before) : Dp.INSTANCE.m6253getUnspecifiedD9Ej5fM(), !TextUnitKt.m6444isUnspecifiedR2X_6o(this.after) ? measureScope.mo329toDpGaN1DYA(this.after) : Dp.INSTANCE.m6253getUnspecifiedD9Ej5fM(), measurable, j2);
    }

    /* renamed from: setAfter--R2X_6o, reason: not valid java name */
    public final void m510setAfterR2X_6o(long j2) {
        this.after = j2;
    }
    ...
    public final void m511setBeforeR2X_6o(long j2) {
        this.before = j2;
    }
