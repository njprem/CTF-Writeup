...
public final /* data */ class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, i2, intrinsicMeasureScope.mo328roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, i2, intrinsicMeasureScope.mo328roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    /* renamed from: measure-3p2s80s */
    public MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
        return RowColumnMeasurePolicyKt.measure(this, Constraints.m6188getMinWidthimpl(j2), Constraints.m6187getMinHeightimpl(j2), Constraints.m6186getMaxWidthimpl(j2), Constraints.m6185getMaxHeightimpl(j2), measureScope.mo328roundToPx0680j_4(this.horizontalArrangement.getSpacing()), measureScope, list, new Placeable[list.size()], 0, list.size(), (3072 & 1024) != 0 ? null : null, (3072 & Fields.CameraDistance) != 0 ? 0 : 0);
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, i2, intrinsicMeasureScope.mo328roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, i2, intrinsicMeasureScope.mo328roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
        ...
        return MeasureScope.layout$default(measureScope, mainAxisLayoutSize, crossAxisLayoutSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i4 < length) {
                    ...
                    Placeable.PlacementScope.place$default(placementScope, placeable, iArr[i5], rowMeasurePolicy.getCrossAxisPosition(placeable, RowColumnImplKt.getRowColumnParentData(placeable), i2, i3), 0.0f, 4, null);
                    i4++;
                    i5++;
                }
            }
