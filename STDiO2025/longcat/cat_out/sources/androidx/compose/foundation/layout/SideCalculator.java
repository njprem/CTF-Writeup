...
interface SideCalculator {
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo668consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m3551getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo669consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m6470getXimpl(available) - remaining, 0.0f);
            }
        ...
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo668consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m3552getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo669consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m6471getYimpl(available) - remaining);
            }
        ...
        public final SideCalculator m670chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            WindowInsetsSides.Companion companion = WindowInsetsSides.INSTANCE;
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m736getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m739getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m737getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m733getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m738getStartJoeWqyM())) {
                return layoutDirection == LayoutDirection.Ltr ? LeftSideCalculator : RightSideCalculator;
            }
            if (WindowInsetsSides.m722equalsimpl0(side, companion.m734getEndJoeWqyM())) {
    ...
    long mo668consumedOffsetsMKHz9U(long available);

    /* renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo669consumedVelocityQWom1Mo(long available, float remaining);

    default float hideMotion(float x2, float y2) {
        return RangesKt.coerceAtMost(motionOf(x2, y2), 0.0f);
    }

    float motionOf(float x2, float y2);

    default float showMotion(float x2, float y2) {
        return RangesKt.coerceAtLeast(motionOf(x2, y2), 0.0f);
    }
