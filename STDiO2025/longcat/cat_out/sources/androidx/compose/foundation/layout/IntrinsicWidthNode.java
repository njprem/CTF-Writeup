...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo596calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j2) {
        int iMinIntrinsicWidth = this.width == IntrinsicSize.Min ? measurable.minIntrinsicWidth(Constraints.m6185getMaxHeightimpl(j2)) : measurable.maxIntrinsicWidth(Constraints.m6185getMaxHeightimpl(j2));
        if (iMinIntrinsicWidth < 0) {
            iMinIntrinsicWidth = 0;
        }
        return Constraints.INSTANCE.m6198fixedWidthOenEA2s(iMinIntrinsicWidth);
    }
