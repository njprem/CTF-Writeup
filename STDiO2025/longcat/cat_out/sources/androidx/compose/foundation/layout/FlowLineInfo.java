...
public final class FlowLineInfo {
    ...
    public final void m576setMaxCrossAxisSize0680j_4$foundation_layout_release(float f2) {
        this.maxCrossAxisSize = f2;
    }

    /* renamed from: setMaxMainAxisSize-0680j_4$foundation_layout_release, reason: not valid java name */
    public final void m577setMaxMainAxisSize0680j_4$foundation_layout_release(float f2) {
    ...
    public final void m578update4j6BHR0$foundation_layout_release(int lineIndex, int positionInLine, float maxMainAxisSize, float maxCrossAxisSize) {
    ...
    public /* synthetic */ FlowLineInfo(int i2, int i3, float f2, float f3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 0 : i2, (i4 & 2) != 0 ? 0 : i3, (i4 & 4) != 0 ? Dp.m6233constructorimpl(0) : f2, (i4 & 8) != 0 ? Dp.m6233constructorimpl(0) : f3, null);
    }
}
