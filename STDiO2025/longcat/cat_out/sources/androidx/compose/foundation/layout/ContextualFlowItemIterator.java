...
public final class ContextualFlowItemIterator implements Iterator<Measurable>, KMappedMarker {
    ...
    public final Measurable getNext$foundation_layout_release(FlowLineInfo info) {
        ...
        if (i2 >= this.itemCount) {
            throw new ArrayIndexOutOfBoundsException("No item returned at index call. Index: " + this.itemIndex);
        }
        List<Measurable> listInvoke = this.getMeasurables.invoke(Integer.valueOf(i2), info);
        this.itemIndex++;
