...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m6423equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m6423equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return TextUnit.m6427hashCodeimpl(this.after) + ((TextUnit.m6427hashCodeimpl(this.before) + (this.alignmentLine.hashCode() * 31)) * 31);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m511setBeforeR2X_6o(this.before);
        node.m510setAfterR2X_6o(this.after);
    }
}
