...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getBottom(Density density) {
        return density.mo328roundToPx0680j_4(this.paddingValues.getBottom());
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo328roundToPx0680j_4(this.paddingValues.mo593calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo328roundToPx0680j_4(this.paddingValues.mo594calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo328roundToPx0680j_4(this.paddingValues.getTop());
    }
    ...
    public String toString() {
        ...
        return "PaddingValues(" + ((Object) Dp.m6244toStringimpl(this.paddingValues.mo593calculateLeftPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m6244toStringimpl(this.paddingValues.getTop())) + ", " + ((Object) Dp.m6244toStringimpl(this.paddingValues.mo594calculateRightPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m6244toStringimpl(this.paddingValues.getBottom())) + ')';
    }
}
