...
final /* data */ class FlowMeasureLazyPolicy implements FlowLineMeasurePolicy {
    ...
    public /* synthetic */ FlowMeasureLazyPolicy(boolean z, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, float f2, CrossAxisAlignment crossAxisAlignment, float f3, int i2, int i3, int i4, FlowLayoutOverflowState flowLayoutOverflowState, List list, Function4 function4, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, horizontal, vertical, f2, crossAxisAlignment, f3, i2, i3, i4, flowLayoutOverflowState, list, function4);
    }
    ...
    public static /* synthetic */ FlowMeasureLazyPolicy m582copyE4Q9ldg$default(FlowMeasureLazyPolicy flowMeasureLazyPolicy, boolean z, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, float f2, CrossAxisAlignment crossAxisAlignment, float f3, int i2, int i3, int i4, FlowLayoutOverflowState flowLayoutOverflowState, List list, Function4 function4, int i5, Object obj) {
        ...
        float f4 = f3;
        return flowMeasureLazyPolicy.m584copyE4Q9ldg(z, horizontal, vertical, f2, crossAxisAlignment2, f4, i7, i8, i6, flowLayoutOverflowState2, list2, function42);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: measure-0kLqBqw, reason: not valid java name */
    public final MeasureResult m583measure0kLqBqw(final SubcomposeMeasureScope subcomposeMeasureScope, long j2) {
        if (this.itemCount <= 0 || this.maxLines == 0 || this.maxItemsInMainAxis == 0 || (Constraints.m6185getMaxHeightimpl(j2) == 0 && this.overflow.getType$foundation_layout_release() != FlowLayoutOverflow.OverflowType.Visible)) {
        ...
        this.overflow.m573setOverflowMeasurablesVKLhPVY$foundation_layout_release(this, j2, new Function2<Boolean, Integer, Measurable>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final Measurable invoke(boolean z, int i2) {
        ...
        return FlowLayoutKt.m567breakDownItemsdi9J0FM(subcomposeMeasureScope, this, contextualFlowItemIterator, this.mainAxisSpacing, this.crossAxisArrangementSpacing, OrientationIndependentConstraints.m611constructorimpl(j2, isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }
    ...
    public final Function2<SubcomposeMeasureScope, Constraints, MeasureResult> getMeasurePolicy() {
        return new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy.getMeasurePolicy.1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                return m585invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
            }

            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
            public final MeasureResult m585invoke0kLqBqw(SubcomposeMeasureScope subcomposeMeasureScope, long j2) {
                return FlowMeasureLazyPolicy.this.m583measure0kLqBqw(subcomposeMeasureScope, j2);
            }
        };
    }
    ...
    public int hashCode() {
        return this.getComposable.hashCode() + ((this.overflowComposables.hashCode() + ((this.overflow.hashCode() + d.c(this.maxItemsInMainAxis, d.c(this.maxLines, d.c(this.itemCount, d.B((this.crossAxisAlignment.hashCode() + d.B((this.verticalArrangement.hashCode() + ((this.horizontalArrangement.hashCode() + (Boolean.hashCode(this.isHorizontal) * 31)) * 31)) * 31, 31, this.mainAxisSpacing)) * 31, 31, this.crossAxisArrangementSpacing), 31), 31), 31)) * 31)) * 31);
    }
    ...
    public String toString() {
        ...
        d.u(this.crossAxisArrangementSpacing, sb, ", itemCount=");
