...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float getBottom() {
        ...
        return density.mo331toDpu2uoSUM(this.insets.getBottom(density));
    }
    ...
    public float mo593calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density density = this.density;
        return density.mo331toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo594calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density density = this.density;
        return density.mo331toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo331toDpu2uoSUM(this.insets.getTop(density));
    }
