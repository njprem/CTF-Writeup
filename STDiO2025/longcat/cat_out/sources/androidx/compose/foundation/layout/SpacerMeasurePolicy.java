...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
        return MeasureScope.layout$default(measureScope, Constraints.m6184getHasFixedWidthimpl(j2) ? Constraints.m6186getMaxWidthimpl(j2) : 0, Constraints.m6183getHasFixedHeightimpl(j2) ? Constraints.m6185getMaxHeightimpl(j2) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
