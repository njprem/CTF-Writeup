...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetDpElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m6238equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m6238equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Dp.m6239hashCodeimpl(this.after) + d.B(this.alignmentLine.hashCode() * 31, 31, this.before);
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f2, float f3, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((f2 < 0.0f && !Dp.m6238equalsimpl0(f2, Dp.INSTANCE.m6253getUnspecifiedD9Ej5fM())) || (f3 < 0.0f && !Dp.m6238equalsimpl0(f3, Dp.INSTANCE.m6253getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m505setBefore0680j_4(this.before);
        node.m504setAfter0680j_4(this.after);
    }
}
