...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m6408getZeroYbymL2g();
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m6401equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6408getZeroYbymL2g())) {
            width = IntSize.m6403getWidthimpl(this.surfaceSize);
            height = IntSize.m6402getHeightimpl(this.surfaceSize);
    ...
    public final void m183setSurfaceSizeozmzZPI(long j2) {
        this.surfaceSize = j2;
    }
}
