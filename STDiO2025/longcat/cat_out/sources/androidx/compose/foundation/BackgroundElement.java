...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public boolean equals(Object other) {
        ...
        return backgroundElement != null && Color.m3793equalsimpl0(this.color, backgroundElement.color) && Intrinsics.areEqual(this.brush, backgroundElement.brush) && this.alpha == backgroundElement.alpha && Intrinsics.areEqual(this.shape, backgroundElement.shape);
    }
    ...
    public int hashCode() {
        ...
        return this.shape.hashCode() + d.b((iM3799hashCodeimpl + (brush != null ? brush.hashCode() : 0)) * 31, 31, this.alpha);
    }
    ...
    public /* synthetic */ BackgroundElement(long j2, Brush brush, float f2, Shape shape, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Color.INSTANCE.m3828getUnspecified0d7_KjU() : j2, (i2 & 2) != 0 ? null : brush, f2, shape, function1, null);
    }
    ...
    public void update(BackgroundNode node) {
        node.m199setColor8_81llA(this.color);
