...
public abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode, FocusEventModifierNode, SemanticsModifierNode, TraversableNode {
    ...
    public final Object m168handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j2, Continuation<? super Unit> continuation) {
    ...
    public final boolean mo169onKeyEventZmokQxo(KeyEvent event) {
        initializeIndicationAndInteractionSourceIfNeeded();
        if (this.enabled && Clickable_androidKt.m244isPressZmokQxo(event)) {
            if (this.currentKeyPressInteractions.containsKey(Key.m4538boximpl(KeyEvent_androidKt.m4849getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.centerOffset, null);
            this.currentKeyPressInteractions.put(Key.m4538boximpl(KeyEvent_androidKt.m4849getKeyZmokQxo(event)), press);
            if (this.interactionSource != null) {
        ...
        if (!this.enabled || !Clickable_androidKt.m242isClickZmokQxo(event)) {
            return false;
        }
        PressInteraction.Press pressRemove = this.currentKeyPressInteractions.remove(Key.m4538boximpl(KeyEvent_androidKt.m4849getKeyZmokQxo(event)));
    ...
    public final void mo170onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        long jM6409getCenterozmzZPI = IntSizeKt.m6409getCenterozmzZPI(bounds);
        this.centerOffset = OffsetKt.Offset(IntOffset.m6361getXimpl(jM6409getCenterozmzZPI), IntOffset.m6362getYimpl(jM6409getCenterozmzZPI));
        initializeIndicationAndInteractionSourceIfNeeded();
    ...
    public final boolean mo171onPreKeyEventZmokQxo(KeyEvent event) {
        return false;
    }
    ...
    */
    public final void m172updateCommonQzZPfjk(androidx.compose.foundation.interaction.MutableInteractionSource r3, androidx.compose.foundation.IndicationNodeFactory r4, boolean r5, java.lang.String r6, androidx.compose.ui.semantics.Role r7, kotlin.jvm.functions.Function0<kotlin.Unit> r8) {
        /*
            r2 = this;
    ...
    private AbstractClickableNode(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, String str, Role role, Function0<Unit> function0) {
        ...
        this.centerOffset = Offset.INSTANCE.m3567getZeroF1C5BW0();
