...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public int hashCode() {
        ...
        int i2 = d.i(this.enabled, (iHashCode + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31, 31);
        String str = this.onClickLabel;
        int iHashCode2 = (i2 + (str != null ? str.hashCode() : 0)) * 31;
        Role role = this.role;
        int iHashCode3 = (this.onClick.hashCode() + ((iHashCode2 + (role != null ? Role.m5528hashCodeimpl(role.getValue()) : 0)) * 31)) * 31;
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("onClickLabel", this.onClickLabel);
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo246updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
}
