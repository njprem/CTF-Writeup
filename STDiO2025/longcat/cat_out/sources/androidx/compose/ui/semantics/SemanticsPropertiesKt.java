...
public final class SemanticsPropertiesKt {
    ...
    public static final int getContentDataType(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        return SemanticsProperties.INSTANCE.getContentDataType$ui_release().getValue(semanticsPropertyReceiver, $$delegatedProperties[8]).m3415unboximpl();
    }
    ...
    public static final void m5545onImeAction9UiTYpY(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2, String str, Function0<Boolean> function0) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getImeAction(), ImeAction.m5882boximpl(i2));
    ...
    public static /* synthetic */ void m5546onImeAction9UiTYpY$default(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2, String str, Function0 function0, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            str = null;
        }
        m5545onImeAction9UiTYpY(semanticsPropertyReceiver, i2, str, function0);
    }
    ...
    public static final void m5547setContentDataTypeNTL_tik(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2) {
        SemanticsProperties.INSTANCE.getContentDataType$ui_release().setValue(semanticsPropertyReceiver, $$delegatedProperties[8], ContentDataType.m3409boximpl(i2));
    }
    ...
    public static final void m5548setImeAction4L7nppU(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2) {
        SemanticsProperties.INSTANCE.getImeAction().setValue(semanticsPropertyReceiver, $$delegatedProperties[18], ImeAction.m5882boximpl(i2));
    }

    /* renamed from: setLiveRegion-hR3wRGc, reason: not valid java name */
    public static final void m5549setLiveRegionhR3wRGc(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2) {
        SemanticsProperties.INSTANCE.getLiveRegion().setValue(semanticsPropertyReceiver, $$delegatedProperties[3], LiveRegionMode.m5515boximpl(i2));
    }
    ...
    public static final void m5550setRolekuIjeqM(SemanticsPropertyReceiver semanticsPropertyReceiver, int i2) {
        SemanticsProperties.INSTANCE.getRole().setValue(semanticsPropertyReceiver, $$delegatedProperties[12], Role.m5524boximpl(i2));
    }
    ...
    public static final void m5551setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver semanticsPropertyReceiver, long j2) {
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue(semanticsPropertyReceiver, $$delegatedProperties[17], TextRange.m5709boximpl(j2));
    }
