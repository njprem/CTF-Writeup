...
public final class Actual_jvmKt {
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [androidx.compose.ui.Actual_jvmKt$tryPopulateReflectively$$inlined$sortedBy$1] */
    public static final void tryPopulateReflectively(InspectorInfo inspectorInfo, ModifierNodeElement<?> modifierNodeElement) {
        List listSortedWith = ArraysKt___ArraysKt.sortedWith(modifierNodeElement.getClass().getDeclaredFields(), (Comparator) new Comparator() { // from class: androidx.compose.ui.Actual_jvmKt$tryPopulateReflectively$$inlined$sortedBy$1
