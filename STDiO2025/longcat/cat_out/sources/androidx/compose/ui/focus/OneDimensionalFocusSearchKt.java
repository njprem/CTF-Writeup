...
public final class OneDimensionalFocusSearchKt {
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i3 == 1) {
            return backwardFocusSearch(activeChild, function1) || m3506generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3474getPreviousdhqQ8s(), function1) || (activeChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(activeChild).booleanValue());
        }
        if (i3 == 2 || i3 == 3) {
            return m3506generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3474getPreviousdhqQ8s(), function1);
        }
        if (i3 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i2 == 1) {
            FocusTargetNode activeChild = FocusTraversalKt.getActiveChild(focusTargetNode);
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m3506generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3473getNextdhqQ8s(), function1);
            }
            throw new IllegalStateException(NoActiveChild);
        }
        if (i2 == 2 || i2 == 3) {
    ...
    private static final boolean m3506generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i2, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3508searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i2, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3459searchBeyondBoundsOMvw8(focusTargetNode, i2, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean zM3508searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m3508searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i2, function1);
                Boolean boolValueOf = Boolean.valueOf(zM3508searchChildren4C6V_qg);
                if (zM3508searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                    return boolValueOf;
                }
                return null;
            }
    ...
    public static final boolean m3507oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i2, Function1<? super FocusTargetNode, Boolean> function1) {
    ...
    public static final boolean m3508searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i2, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3463equalsimpl0(i2, FocusDirection.INSTANCE.m3473getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
