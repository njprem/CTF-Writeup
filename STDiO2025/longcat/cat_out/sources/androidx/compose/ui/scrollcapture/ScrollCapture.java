...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function1<ScrollCaptureCandidate, Unit> {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM6389getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m6389getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTargetH = androidx.compose.ui.contentcapture.a.h(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m6361getXimpl(jM6389getTopLeftnOccac), IntOffset.m6362getYimpl(jM6389getTopLeftnOccac)), composeScrollCaptureCallback);
        scrollCaptureTargetH.setScrollBounds(RectHelper_androidKt.toAndroidRect(scrollCaptureCandidate.getViewportBoundsInWindow()));
        targets.accept(scrollCaptureTargetH);
    }
