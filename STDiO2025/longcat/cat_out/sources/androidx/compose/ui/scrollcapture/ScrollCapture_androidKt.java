...
public final class ScrollCapture_androidKt {
    ...
    private static final void visitDescendants(SemanticsNode semanticsNode, Function1<? super SemanticsNode, Boolean> function1) {
        ...
        while (mutableVector.isNotEmpty()) {
            SemanticsNode semanticsNode2 = (SemanticsNode) androidx.compose.runtime.changelist.a.h(mutableVector, 1);
    ...
    private static final void visitScrollCaptureCandidates(SemanticsNode semanticsNode, int i2, Function1<? super ScrollCaptureCandidate, Unit> function1) {
        ...
        while (true) {
            ...
            while (mutableVector.isNotEmpty()) {
                semanticsNode2 = (SemanticsNode) androidx.compose.runtime.changelist.a.h(mutableVector, 1);
                if (isVisible(semanticsNode2) && !semanticsNode2.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getDisabled())) {
                    ...
                    if (nodeCoordinatorFindCoordinatorToGetBounds$ui_release == null) {
                        throw androidx.compose.runtime.changelist.a.v("Expected semantics node to have a coordinator.");
                    }
    ...
    public static /* synthetic */ void visitScrollCaptureCandidates$default(SemanticsNode semanticsNode, int i2, Function1 function1, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = 0;
        }
