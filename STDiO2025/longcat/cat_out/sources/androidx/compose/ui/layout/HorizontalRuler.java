...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3552getYimpl(targetCoordinates.mo5129localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m6403getWidthimpl(sourceCoordinates.mo5128getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
