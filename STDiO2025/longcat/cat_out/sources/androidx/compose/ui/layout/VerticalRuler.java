...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3551getXimpl(targetCoordinates.mo5129localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(coordinate, IntSize.m6402getHeightimpl(sourceCoordinates.mo5128getSizeYbymL2g()) / 2.0f)));
    }
}
