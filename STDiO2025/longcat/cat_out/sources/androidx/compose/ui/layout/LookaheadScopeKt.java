...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i2) {
        ...
        if ((i3 & 3) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m3289initimpl(composerM3285constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m3292setimpl(composerM3285constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
            ...
            function3.invoke(lookaheadScopeImpl, composerStartRestartGroup, Integer.valueOf((i3 << 3) & 112));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadScope.4
                ...
                public final void invoke(Composer composer2, int i4) {
                    LookaheadScopeKt.LookaheadScope(function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public static final long m5149localLookaheadPositionOfFgt4K4Q(LookaheadScope lookaheadScope, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j2, boolean z) {
        ...
        return lookaheadCoordinates instanceof LookaheadLayoutCoordinates ? lookaheadCoordinates.mo5130localPositionOfS_NoaFU(lookaheadCoordinates2, j2, z) : lookaheadCoordinates2 instanceof LookaheadLayoutCoordinates ? Offset.m3560unaryMinusF1C5BW0(lookaheadCoordinates2.mo5130localPositionOfS_NoaFU(lookaheadCoordinates, j2, z)) : lookaheadCoordinates.mo5130localPositionOfS_NoaFU(lookaheadCoordinates, j2, z);
    }
}
