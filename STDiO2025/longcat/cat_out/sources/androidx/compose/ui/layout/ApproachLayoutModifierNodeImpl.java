...
final class ApproachLayoutModifierNodeImpl extends Modifier.Node implements ApproachLayoutModifierNode {
    ...
    public MeasureResult mo66approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j2) {
        return this.measureBlock.invoke(approachMeasureScope, measurable, Constraints.m6174boximpl(j2));
    }
    ...
    public boolean mo67isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return this.isMeasurementApproachInProgress.invoke(IntSize.m6395boximpl(lookaheadSize)).booleanValue();
    }
