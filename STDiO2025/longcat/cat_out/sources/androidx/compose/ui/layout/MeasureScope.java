...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5162roundToPxR2X_6o(MeasureScope measureScope, long j2) {
            return MeasureScope.super.mo327roundToPxR2X_6o(j2);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5163roundToPx0680j_4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo328roundToPx0680j_4(f2);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5164toDpGaN1DYA(MeasureScope measureScope, long j2) {
            return MeasureScope.super.mo329toDpGaN1DYA(j2);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5165toDpu2uoSUM(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo330toDpu2uoSUM(f2);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5167toDpSizekrfVVM(MeasureScope measureScope, long j2) {
            return MeasureScope.super.mo332toDpSizekrfVVM(j2);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5168toPxR2X_6o(MeasureScope measureScope, long j2) {
            return MeasureScope.super.mo333toPxR2X_6o(j2);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5169toPx0680j_4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo334toPx0680j_4(f2);
        }
        ...
        public static long m5170toSizeXkaWNTQ(MeasureScope measureScope, long j2) {
            return MeasureScope.super.mo335toSizeXkaWNTQ(j2);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5171toSp0xMU5do(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo336toSp0xMU5do(f2);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5172toSpkPz2Gy4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo337toSpkPz2Gy4(f2);
        }
        ...
        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5166toDpu2uoSUM(MeasureScope measureScope, int i2) {
            return MeasureScope.super.mo331toDpu2uoSUM(i2);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5173toSpkPz2Gy4(MeasureScope measureScope, int i2) {
            return MeasureScope.super.mo338toSpkPz2Gy4(i2);
        }
    }
    ...
    static /* synthetic */ MeasureResult layout$default(MeasureScope measureScope, int i2, int i3, Map map, Function1 function1, Function1 function12, int i4, Object obj) {
        ...
        return measureScope.layout(i2, i3, map2, function1, function12);
    }
}
