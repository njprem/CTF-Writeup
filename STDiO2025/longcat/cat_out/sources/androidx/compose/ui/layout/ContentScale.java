...
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM5117computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5117computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM5117computeFillMaxDimensioniLBOSCw, fM5117computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM5118computeFillMinDimensioniLBOSCw = ContentScaleKt.m5118computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM5118computeFillMinDimensioniLBOSCw, fM5118computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM5116computeFillHeightiLBOSCw = ContentScaleKt.m5116computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM5116computeFillHeightiLBOSCw, fM5116computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM5119computeFillWidthiLBOSCw = ContentScaleKt.m5119computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM5119computeFillWidthiLBOSCw, fM5119computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m3620getWidthimpl(srcSize) <= Size.m3620getWidthimpl(dstSize) && Size.m3617getHeightimpl(srcSize) <= Size.m3617getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m5119computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m5116computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
    ...
    long mo5111computeScaleFactorH7hwNQA(long srcSize, long dstSize);
}
