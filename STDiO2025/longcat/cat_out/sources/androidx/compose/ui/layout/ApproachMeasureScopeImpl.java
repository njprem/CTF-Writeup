...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public long mo5094getLookaheadConstraintsmsEJaDk() {
    ...
    public long mo5095getLookaheadSizeYbymL2g() {
    ...
    public int mo327roundToPxR2X_6o(long j2) {
        return this.coordinator.mo327roundToPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo328roundToPx0680j_4(float f2) {
        return this.coordinator.mo328roundToPx0680j_4(f2);
    }
    ...
    public float mo329toDpGaN1DYA(long j2) {
        return this.coordinator.mo329toDpGaN1DYA(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo330toDpu2uoSUM(float f2) {
        return this.coordinator.mo330toDpu2uoSUM(f2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo332toDpSizekrfVVM(long j2) {
        return this.coordinator.mo332toDpSizekrfVVM(j2);
    }
    ...
    public float mo333toPxR2X_6o(long j2) {
        return this.coordinator.mo333toPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo334toPx0680j_4(float f2) {
        return this.coordinator.mo334toPx0680j_4(f2);
    }
    ...
    public long mo335toSizeXkaWNTQ(long j2) {
        return this.coordinator.mo335toSizeXkaWNTQ(j2);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo336toSp0xMU5do(float f2) {
        return this.coordinator.mo336toSp0xMU5do(f2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo337toSpkPz2Gy4(float f2) {
        return this.coordinator.mo337toSpkPz2Gy4(f2);
    }
    ...
    public float mo331toDpu2uoSUM(int i2) {
        return this.coordinator.mo331toDpu2uoSUM(i2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo338toSpkPz2Gy4(int i2) {
        return this.coordinator.mo338toSpkPz2Gy4(i2);
    }
}
