...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
    ...
    public final List<Measurable> postLookaheadSubcompose(Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (size == i2) {
            ...
            this.postLookaheadComposedSlotIds.set(i2, slotId);
        }
    ...
    private final LayoutNode takeNodeFromReusables(Object slotId) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(getSlotIdAtIndex(i5), slotId)) {
                i2 = i5;
                break;
            }
            i5--;
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
                ...
                if (measureScope.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    final MeasureResult measureResultInvoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m6174boximpl(j2));
                ...
                final MeasureResult measureResultInvoke2 = block.invoke(LayoutNodeSubcompositionsState.this.postLookaheadMeasureScope, Constraints.m6174boximpl(j2));
    ...
    public final void makeSureStateIsConsistent() {
        ...
        if ((size - this.reusableCount) - this.precomposedCount < 0) {
            StringBuilder sbP = a.p(size, "Incorrect state. Total children ", ". Reusable children ");
            sbP.append(this.reusableCount);
            sbP.append(". Precomposed children ");
            sbP.append(this.precomposedCount);
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.2
            ...
            public void mo5146premeasure0kLqBqw(int index, long constraints) {
                LayoutNode layoutNode = (LayoutNode) LayoutNodeSubcompositionsState.this.precomposeMap.get(slotId);
                ...
                layoutNode2.ignoreRemeasureRequests = true;
                LayoutNodeKt.requireOwner(layoutNode).mo5411measureAndLayout0kLqBqw(layoutNode.getChildren$ui_release().get(index), constraints);
                layoutNode2.ignoreRemeasureRequests = false;
            }
    ...
    */
    public final java.util.List<androidx.compose.ui.layout.Measurable> subcompose(java.lang.Object r13, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r14) {
        /*
            r12 = this;
            r12.makeSureStateIsConsistent()
        ...
        L26:
            java.util.HashMap<java.lang.Object, androidx.compose.ui.node.LayoutNode> r4 = r12.slotIdToNode
            java.lang.Object r5 = r4.get(r13)
            if (r5 != 0) goto L5b
            java.util.HashMap<java.lang.Object, androidx.compose.ui.node.LayoutNode> r5 = r12.precomposeMap
            java.lang.Object r5 = r5.remove(r13)
        ...
        L44:
            int r2 = r12.precomposedCount
            int r2 = r2 + (-1)
            r12.precomposedCount = r2
            goto L58
        L4b:
            androidx.compose.ui.node.LayoutNode r2 = r12.takeNodeFromReusables(r13)
            if (r2 != 0) goto L57
            int r2 = r12.currentIndex
            androidx.compose.ui.node.LayoutNode r2 = r12.createNodeAt(r2)
        L57:
            r5 = r2
        L58:
            r4.put(r13, r5)
        L5b:
            androidx.compose.ui.node.LayoutNode r5 = (androidx.compose.ui.node.LayoutNode) r5
            androidx.compose.ui.node.LayoutNode r2 = r12.root
            ...
            r9 = 0
            r6 = r12
            move$default(r6, r7, r8, r9, r10, r11)
            goto La3
        L83:
            r6 = r12
            goto La3
        ...
        La3:
            ...
            int r2 = r2 + r3
            r6.currentIndex = r2
            r12.subcompose(r5, r13, r14)
            if (r0 == r1) goto Lb7
            androidx.compose.ui.node.LayoutNode$LayoutState r13 = androidx.compose.ui.node.LayoutNode.LayoutState.LayingOut
            if (r0 != r13) goto Lb2
            goto Lb7
        Lb2:
            java.util.List r13 = r5.getChildLookaheadMeasurables$ui_release()
            return r13
        Lb7:
            java.util.List r13 = r5.getChildMeasurables$ui_release()
            return r13
        */
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState == null) {
            NodeState nodeState2 = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m5110getLambda1$ui_release(), null, 4, null);
