...
public interface ParentDataModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static <R> R foldIn(ParentDataModifier parentDataModifier, R r2, Function2<? super R, ? super Modifier.Element, ? extends R> function2) {
            return (R) ParentDataModifier.super.foldIn(r2, function2);
        }

        @Deprecated
        public static <R> R foldOut(ParentDataModifier parentDataModifier, R r2, Function2<? super Modifier.Element, ? super R, ? extends R> function2) {
            return (R) ParentDataModifier.super.foldOut(r2, function2);
        }
