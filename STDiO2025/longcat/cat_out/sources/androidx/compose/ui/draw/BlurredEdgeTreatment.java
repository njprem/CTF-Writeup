...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m3431constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m3431constructorimpl(null);
    ...
    public static final /* synthetic */ BlurredEdgeTreatment m3430boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Shape m3431constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3432equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m3436unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3433equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3434hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m3435toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m3432equalsimpl(this.shape, obj);
    }
    ...
    public int hashCode() {
        return m3434hashCodeimpl(this.shape);
    }

    public String toString() {
        return m3435toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Shape m3436unboximpl() {
        return this.shape;
    }
}
