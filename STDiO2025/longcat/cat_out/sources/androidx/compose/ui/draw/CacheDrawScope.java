...
public final class CacheDrawScope implements Density {
    ...
    public static /* synthetic */ void m3440recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j2, Function1 function1, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 4) != 0) {
            j2 = IntSizeKt.m6414toIntSizeuvyYCjk(cacheDrawScope.m3441getSizeNHjbRc());
        }
        cacheDrawScope.m3442recordTdoYBX4(graphicsLayer, density, layoutDirection, j2, function1);
    }
    ...
    public final long m3441getSizeNHjbRc() {
        return this.cacheParams.mo3439getSizeNHjbRc();
    }
    ...
    public final void m3442recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, final long j2, final Function1<? super ContentDrawScope, Unit> function1) {
        graphicsLayer.m4436recordmLhObY(density, layoutDirection, j2, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long jSize = SizeKt.Size(IntSize.m6403getWidthimpl(j3), IntSize.m6402getHeightimpl(j3));
                ...
                drawContext.mo4264setSizeuvyYCjk(jSize);
