...
public final class InputMode {
    ...
    private static final int Touch = m4525constructorimpl(1);
    private static final int Keyboard = m4525constructorimpl(2);
    ...
    public static final class Companion {
        ...
        public final int m4531getKeyboardaOaMEAU() {
            return InputMode.Keyboard;
        }

        /* renamed from: getTouch-aOaMEAU, reason: not valid java name */
        public final int m4532getTouchaOaMEAU() {
    ...
    public static final /* synthetic */ InputMode m4524boximpl(int i2) {
    ...
    public static boolean m4526equalsimpl(int i2, Object obj) {
        return (obj instanceof InputMode) && i2 == ((InputMode) obj).getValue();
    }
    ...
    public static String m4529toStringimpl(int i2) {
        return m4527equalsimpl0(i2, Touch) ? "Touch" : m4527equalsimpl0(i2, Keyboard) ? "Keyboard" : "Error";
    }
