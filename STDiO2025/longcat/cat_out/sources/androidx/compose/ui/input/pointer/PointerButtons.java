...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m4923boximpl(int i2) {
        return new PointerButtons(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4924constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4925equalsimpl(int i2, Object obj) {
        return (obj instanceof PointerButtons) && i2 == ((PointerButtons) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4926equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4927hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4928toStringimpl(int i2) {
        return d.m("PointerButtons(packedValue=", i2, ')');
    }

    public boolean equals(Object obj) {
        return m4925equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4927hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4928toStringimpl(this.packedValue);
    }
