...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public /* synthetic */ PointerHoverIconModifierNode(PointerIcon pointerIcon, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void mo170onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m4940equalsimpl0(type, companion.m4944getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m4940equalsimpl0(pointerEvent.getType(), companion.m4945getExit7fucELk())) {
                onExit();
            }
        }
    }
