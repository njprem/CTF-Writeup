...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m5053boximpl(int i2) {
        return new PointerKeyboardModifiers(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5054constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5055equalsimpl(int i2, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i2 == ((PointerKeyboardModifiers) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5056equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5057hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5058toStringimpl(int i2) {
        return d.m("PointerKeyboardModifiers(packedValue=", i2, ')');
    }

    public boolean equals(Object obj) {
        return m5055equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m5057hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5058toStringimpl(this.packedValue);
    }
