...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m5075boximpl(int i2) {
        return new ProcessResult(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5076constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5077equalsimpl(int i2, Object obj) {
        return (obj instanceof ProcessResult) && i2 == ((ProcessResult) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5078equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m5079getAnyMovementConsumedimpl(int i2) {
        return (i2 & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m5080getDispatchedToAPointerInputModifierimpl(int i2) {
        return (i2 & 1) != 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5081hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5082toStringimpl(int i2) {
        return d.m("ProcessResult(value=", i2, ')');
    }
    ...
    public int hashCode() {
        return m5081hashCodeimpl(this.value);
    }
