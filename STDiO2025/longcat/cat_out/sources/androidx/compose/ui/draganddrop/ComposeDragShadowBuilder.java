...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m4262setSizeuvyYCjk(j2);
        Canvas.save();
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        Density density = this.density;
        outShadowSize.set(density.mo328roundToPx0680j_4(density.mo330toDpu2uoSUM(Size.m3620getWidthimpl(this.decorationSize))), density.mo328roundToPx0680j_4(density.mo330toDpu2uoSUM(Size.m3617getHeightimpl(this.decorationSize))));
