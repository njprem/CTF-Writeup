...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6379getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m6380containsgyyYBs(long offset) {
        return IntOffset.m6361getXimpl(offset) >= this.left && IntOffset.m6361getXimpl(offset) < this.right && IntOffset.m6362getYimpl(offset) >= this.top && IntOffset.m6362getYimpl(offset) < this.bottom;
    }
    ...
    public final long m6387getSizeYbymL2g() {
    ...
    public int hashCode() {
        return Integer.hashCode(this.bottom) + d.c(this.right, d.c(this.top, Integer.hashCode(this.left) * 31, 31), 31);
    }
    ...
    public final IntRect m6391translategyyYBs(long offset) {
        return new IntRect(IntOffset.m6361getXimpl(offset) + this.left, IntOffset.m6362getYimpl(offset) + this.top, IntOffset.m6361getXimpl(offset) + this.right, IntOffset.m6362getYimpl(offset) + this.bottom);
    }
}
