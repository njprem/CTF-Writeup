...
public final class IntRectKt {
    ...
    public static final IntRect m6392IntRectE1MhUcY(long j2, long j3) {
        return new IntRect(IntOffset.m6361getXimpl(j2), IntOffset.m6362getYimpl(j2), IntOffset.m6361getXimpl(j3), IntOffset.m6362getYimpl(j3));
    }

    /* renamed from: IntRect-VbeCjmY, reason: not valid java name */
    public static final IntRect m6393IntRectVbeCjmY(long j2, long j3) {
        return new IntRect(IntOffset.m6361getXimpl(j2), IntOffset.m6362getYimpl(j2), IntSize.m6403getWidthimpl(j3) + IntOffset.m6361getXimpl(j2), IntSize.m6402getHeightimpl(j3) + IntOffset.m6362getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m6394IntRectar5cAso(long j2, int i2) {
        return new IntRect(IntOffset.m6361getXimpl(j2) - i2, IntOffset.m6362getYimpl(j2) - i2, IntOffset.m6361getXimpl(j2) + i2, IntOffset.m6362getYimpl(j2) + i2);
    }
