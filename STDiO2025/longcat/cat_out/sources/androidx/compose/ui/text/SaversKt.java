...
public final class SaversKt {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope saverScope, ParagraphStyle paragraphStyle) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextAlign.m6115boximpl(paragraphStyle.getTextAlign())), SaversKt.save(TextDirection.m6129boximpl(paragraphStyle.getTextDirection())), SaversKt.save(TextUnit.m6416boximpl(paragraphStyle.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope), SaversKt.save(paragraphStyle.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), saverScope));
        }
    ...
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final Object invoke(SaverScope saverScope, SpanStyle spanStyle) {
            Color colorM3782boximpl = Color.m3782boximpl(spanStyle.m5671getColor0d7_KjU());
            Color.Companion companion = Color.INSTANCE;
            Object objSave = SaversKt.save(colorM3782boximpl, SaversKt.getSaver(companion), saverScope);
            TextUnit textUnitM6416boximpl = TextUnit.m6416boximpl(spanStyle.getFontSize());
            TextUnit.Companion companion2 = TextUnit.INSTANCE;
            return CollectionsKt.arrayListOf(objSave, SaversKt.save(textUnitM6416boximpl, SaversKt.getSaver(companion2), saverScope), SaversKt.save(spanStyle.getFontWeight(), SaversKt.getSaver(FontWeight.INSTANCE), saverScope), SaversKt.save(spanStyle.getFontStyle()), SaversKt.save(spanStyle.getFontSynthesis()), SaversKt.save(-1), SaversKt.save(spanStyle.getFontFeatureSettings()), SaversKt.save(TextUnit.m6416boximpl(spanStyle.getLetterSpacing()), SaversKt.getSaver(companion2), saverScope), SaversKt.save(spanStyle.getBaselineShift(), SaversKt.getSaver(BaselineShift.INSTANCE), saverScope), SaversKt.save(spanStyle.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.INSTANCE), saverScope), SaversKt.save(spanStyle.getLocaleList(), SaversKt.getSaver(LocaleList.INSTANCE), saverScope), SaversKt.save(Color.m3782boximpl(spanStyle.getBackground()), SaversKt.getSaver(companion), saverScope), SaversKt.save(spanStyle.getBackground(), SaversKt.getSaver(TextDecoration.INSTANCE), saverScope), SaversKt.save(spanStyle.getShadow(), SaversKt.getSaver(Shadow.INSTANCE), saverScope));
        }
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope saverScope, TextIndent textIndent) {
            TextUnit textUnitM6416boximpl = TextUnit.m6416boximpl(textIndent.getFirstLine());
            TextUnit.Companion companion = TextUnit.INSTANCE;
            return CollectionsKt.arrayListOf(SaversKt.save(textUnitM6416boximpl, SaversKt.getSaver(companion), saverScope), SaversKt.save(TextUnit.m6416boximpl(textIndent.getRestLine()), SaversKt.getSaver(companion), saverScope));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m5651invoke8a2Sb4w(saverScope, baselineShift.m6012unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m5651invoke8a2Sb4w(SaverScope saverScope, float f2) {
        ...
        public final BaselineShift invoke(Object obj) {
            ...
            return BaselineShift.m6006boximpl(BaselineShift.m6007constructorimpl(((Float) obj).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m5657invokeFDrldGo(saverScope, textRange.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m5657invokeFDrldGo(SaverScope saverScope, long j2) {
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m5721getStartimpl(j2))), SaversKt.save(Integer.valueOf(TextRange.m5716getEndimpl(j2))));
        }
        ...
        public final TextRange invoke(Object obj) {
            ...
            Intrinsics.checkNotNull(num2);
            return TextRange.m5709boximpl(TextRangeKt.TextRange(iIntValue, num2.intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope saverScope, Shadow shadow) {
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m3782boximpl(shadow.getColor()), SaversKt.getSaver(Color.INSTANCE), saverScope), SaversKt.save(Offset.m3540boximpl(shadow.getOffset()), SaversKt.getSaver(Offset.INSTANCE), saverScope), SaversKt.save(Float.valueOf(shadow.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object obj) {
            ...
            long jM3802unboximpl = colorRestore.m3802unboximpl();
            Object obj3 = list.get(1);
            ...
            return new Shadow(jM3802unboximpl, packedValue, f2.floatValue(), null);
        }
    });
    private static final NonNullValueClassSaver<Color, Object> ColorSaver = NonNullValueClassSaver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m5653invoke4WTKRHQ(saverScope, color.m3802unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m5653invoke4WTKRHQ(SaverScope saverScope, long j2) {
            return j2 == 16 ? Boolean.FALSE : Integer.valueOf(ColorKt.m3846toArgb8_81llA(j2));
        }
        ...
        public final Color invoke(Object obj) {
            ...
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                jColor = Color.INSTANCE.m3828getUnspecified0d7_KjU();
            } else {
                Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
                jColor = ColorKt.Color(((Integer) obj).intValue());
            }
            return Color.m3782boximpl(jColor);
        }
    });
    private static final NonNullValueClassSaver<TextUnit, Object> TextUnitSaver = NonNullValueClassSaver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m5659invokempE4wyQ(saverScope, textUnit.getPackedValue());
        }

        /* renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m5659invokempE4wyQ(SaverScope saverScope, long j2) {
            return TextUnit.m6423equalsimpl0(j2, TextUnit.INSTANCE.m6437getUnspecifiedXSAIIZE()) ? Boolean.FALSE : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m6426getValueimpl(j2))), SaversKt.save(TextUnitType.m6451boximpl(TextUnit.m6425getTypeUIouoOA(j2))));
        }
        ...
        public final TextUnit invoke(Object obj) {
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                return TextUnit.m6416boximpl(TextUnit.INSTANCE.m6437getUnspecifiedXSAIIZE());
            }
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any>");
            List list = (List) obj;
            Object obj2 = list.get(0);
            ...
            return TextUnit.m6416boximpl(TextUnitKt.m6438TextUnitanM5pPY(fFloatValue, textUnitType.getType()));
        }
    });
    private static final NonNullValueClassSaver<Offset, Object> OffsetSaver = NonNullValueClassSaver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m5655invokeUv8p0NA(saverScope, offset.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m5655invokeUv8p0NA(SaverScope saverScope, long j2) {
            return Offset.m3548equalsimpl0(j2, Offset.INSTANCE.m3566getUnspecifiedF1C5BW0()) ? Boolean.FALSE : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m3551getXimpl(j2))), SaversKt.save(Float.valueOf(Offset.m3552getYimpl(j2))));
        }
        ...
        public final Offset invoke(Object obj) {
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                return Offset.m3540boximpl(Offset.INSTANCE.m3566getUnspecifiedF1C5BW0());
            }
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
            List list = (List) obj;
            Object obj2 = list.get(0);
            ...
            return Offset.m3540boximpl(OffsetKt.Offset(fFloatValue, f3.floatValue()));
        }
    });
