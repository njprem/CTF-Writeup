...
public final class PlatformParagraphStyle {
    ...
    public boolean equals(Object other) {
        ...
        return this.includeFontPadding == platformParagraphStyle.includeFontPadding && EmojiSupportMatch.m5576equalsimpl0(this.emojiSupportMatch, platformParagraphStyle.emojiSupportMatch);
    }
    ...
    public int hashCode() {
        return EmojiSupportMatch.m5577hashCodeimpl(this.emojiSupportMatch) + (Boolean.hashCode(this.includeFontPadding) * 31);
    }
    ...
    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m5578toStringimpl(this.emojiSupportMatch)) + ')';
    }
    ...
    public PlatformParagraphStyle(boolean z) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.INSTANCE.m5581getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i2, boolean z, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m5581getDefault_3YsG6Y() : i2, (i3 & 2) != 0 ? false : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m5581getDefault_3YsG6Y() : i2, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.INSTANCE.m5581getDefault_3YsG6Y(), false, (DefaultConstructorMarker) null);
    }
}
