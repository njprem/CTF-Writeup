...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final Paint.Cap m6002toAndroidCapBeK7IIE(int i2) {
        StrokeCap.Companion companion = StrokeCap.INSTANCE;
        return StrokeCap.m4140equalsimpl0(i2, companion.m4144getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m4140equalsimpl0(i2, companion.m4145getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m4140equalsimpl0(i2, companion.m4146getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }

    /* renamed from: toAndroidJoin-Ww9F2mQ, reason: not valid java name */
    private final Paint.Join m6003toAndroidJoinWw9F2mQ(int i2) {
        StrokeJoin.Companion companion = StrokeJoin.INSTANCE;
        return StrokeJoin.m4150equalsimpl0(i2, companion.m4155getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m4150equalsimpl0(i2, companion.m4156getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m4150equalsimpl0(i2, companion.m4154getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m6003toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m6002toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
