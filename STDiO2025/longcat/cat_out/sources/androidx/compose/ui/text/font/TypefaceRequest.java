...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m5871copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i2, int i3, Object obj, int i4, Object obj2) {
        if ((i4 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i5 = i2;
        return typefaceRequest.m5874copye1PVR60(fontFamily, fontWeight, i5, i3, obj3);
    }
    ...
    public final TypefaceRequest m5874copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public final int m5875getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5876getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
    ...
    public int hashCode() {
        ...
        int iM5842hashCodeimpl = (FontSynthesis.m5842hashCodeimpl(this.fontSynthesis) + ((FontStyle.m5831hashCodeimpl(this.fontStyle) + ((this.fontWeight.hashCode() + ((fontFamily == null ? 0 : fontFamily.hashCode()) * 31)) * 31)) * 31)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return iM5842hashCodeimpl + (obj != null ? obj.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m5832toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m5845toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
