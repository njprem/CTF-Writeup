    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (FontLoadingStrategy.m5817equalsimpl0(loadingStrategy, companion.m5822getBlockingPKNRLFQ())) {
            ...
            if (!FontLoadingStrategy.m5817equalsimpl0(loadingStrategy, companion.m5823getOptionalLocalPKNRLFQ())) {
                ...
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m5819toStringimpl(font.getLoadingStrategy())));
            }
            try {
                Result.Companion companion2 = Result.INSTANCE;
                objM6498constructorimpl = Result.m6498constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, this.context));
            } catch (Throwable th) {
                Result.Companion companion3 = Result.INSTANCE;
                objM6498constructorimpl = Result.m6498constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6504isFailureimpl(objM6498constructorimpl) ? null : objM6498constructorimpl);
        }
