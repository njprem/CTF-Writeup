...
public final class FontFamilyResolver_androidKt {
    ...
    public static final State<android.graphics.Typeface> m5806resolveAsTypefaceWqqsr6A(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i2, int i3) {
        State stateMo5805resolveDPcqOEQ = resolver.mo5805resolveDPcqOEQ(fontFamily, fontWeight, i2, i3);
        Intrinsics.checkNotNull(stateMo5805resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo5805resolveDPcqOEQ;
    }

    /* renamed from: resolveAsTypeface-Wqqsr6A$default, reason: not valid java name */
    public static /* synthetic */ State m5807resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            fontFamily = null;
        }
        if ((i4 & 2) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontSynthesis.INSTANCE.m5847getAllGVVA2EU();
        }
        return m5806resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i2, i3);
    }
