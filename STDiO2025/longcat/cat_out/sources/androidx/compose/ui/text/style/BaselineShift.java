...
public final class BaselineShift {
    ...
    private static final float Superscript = m6007constructorimpl(0.5f);
    private static final float Subscript = m6007constructorimpl(-0.5f);
    private static final float None = m6007constructorimpl(0.0f);
    ...
    public static final /* synthetic */ BaselineShift m6006boximpl(float f2) {
        return new BaselineShift(f2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static float m6007constructorimpl(float f2) {
        return f2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6008equalsimpl(float f2, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f2, ((BaselineShift) obj).m6012unboximpl()) == 0;
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6009equalsimpl0(float f2, float f3) {
        return Float.compare(f2, f3) == 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6010hashCodeimpl(float f2) {
        return Float.hashCode(f2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6011toStringimpl(float f2) {
        return "BaselineShift(multiplier=" + f2 + ')';
    }

    public boolean equals(Object obj) {
        return m6008equalsimpl(this.multiplier, obj);
    }
    ...
    public int hashCode() {
        return m6010hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m6011toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ float m6012unboximpl() {
        return this.multiplier;
    }
}
