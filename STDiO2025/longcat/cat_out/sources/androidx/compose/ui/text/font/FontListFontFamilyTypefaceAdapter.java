...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    arrayList2.add(BuildersKt__Builders_commonKt.async$default(coroutineScope, null, null, new FontListFontFamilyTypefaceAdapter$preload$3$2$1(fontListFontFamilyTypefaceAdapter, (Font) arrayList.get(i4), platformFontLoader, null), 3, null));
                }
                this.label = 1;
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (FontLoadingStrategy.m5817equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m5821getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ArrayList arrayList2 = new ArrayList(arrayList.size());
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            arrayList2.add(TuplesKt.to(font2.getWeight(), FontStyle.m5827boximpl(font2.getStyle())));
        }
        ...
        while (i5 < size4) {
            ...
            int iM5833unboximpl = ((FontStyle) pair.component2()).m5833unboximpl();
            List list = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5826matchFontRetOiIg(fonts, fontWeight, iM5833unboximpl), new TypefaceRequest(fontFamily2, fontWeight, iM5833unboximpl, FontSynthesis.INSTANCE.m5847getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        Pair pairFirstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5826matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5875getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
