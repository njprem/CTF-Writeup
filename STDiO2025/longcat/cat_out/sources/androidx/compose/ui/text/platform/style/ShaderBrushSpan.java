...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3608boximpl(Size.INSTANCE.m3628getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m6004getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m3622isEmptyimpl(this.this$0.m6004getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo3761createShaderuvyYCjk(this.this$0.m6004getSizeNHjbRc());
        }
    });
    ...
    public final long m6004getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m6005setSizeuvyYCjk(long j2) {
