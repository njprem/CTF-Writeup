...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo5970getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return Build.VERSION.SDK_INT < 28 ? Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5784getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle)) : TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m5830equalsimpl0(fontStyle, FontStyle.INSTANCE.m5836getItalic_LCdwA()));
    }
}
