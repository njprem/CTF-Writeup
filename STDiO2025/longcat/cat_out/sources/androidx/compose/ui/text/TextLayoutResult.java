...
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m5691copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textLayoutResult.m5692copyO0kMr_c(textLayoutInput, j2);
    }
    ...
    public final TextLayoutResult m5692copyO0kMr_c(TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m6401equalsimpl0(this.size, textLayoutResult.size) && this.firstBaseline == textLayoutResult.firstBaseline && this.lastBaseline == textLayoutResult.lastBaseline && Intrinsics.areEqual(this.placeholderRects, textLayoutResult.placeholderRects);
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m6402getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m6403getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5693getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m5587getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m5695getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m5589getWordBoundaryjx7JFs(offset);
    }

    public int hashCode() {
        return this.placeholderRects.hashCode() + d.b(d.b((IntSize.m6404hashCodeimpl(this.size) + ((this.multiParagraph.hashCode() + (this.layoutInput.hashCode() * 31)) * 31)) * 31, 31, this.firstBaseline), 31, this.lastBaseline);
    }
    ...
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m6406toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
