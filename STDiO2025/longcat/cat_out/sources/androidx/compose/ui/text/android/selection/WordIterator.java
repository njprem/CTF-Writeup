...
public final class WordIterator {
    ...
    public WordIterator(CharSequence charSequence, int i2, int i3, Locale locale) {
        ...
        this.end = Math.min(charSequence.length(), i3 + WINDOW_WIDTH);
    ...
    private final void checkOffsetIsValid(int offset) {
        ...
        if (offset > this.end || i2 > offset) {
            StringBuilder sbP = a.p(offset, "Invalid offset: ", ". Valid range is [");
            sbP.append(this.start);
            sbP.append(" , ");
            throw new IllegalArgumentException(a.o(sbP, this.end, ']').toString());
        }
    }
