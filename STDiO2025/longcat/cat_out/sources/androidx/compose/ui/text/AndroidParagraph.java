...
public final class AndroidParagraph implements Paragraph {
    ...
    public void mo5552fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5719getMinimpl(range), TextRange.m5718getMaximpl(range), array, arrayStart);
    }
    ...
    public Rect getBoundingBox(int offset) {
        ...
        sbP.append(this.charSequence.length());
        sbP.append(')');
    ...
    public int mo5554getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3552getYimpl(position)), Offset.m3551getXimpl(position));
    }
    ...
    public Path getPathForRange(int start, int end) {
        ...
        sbQ.append(this.charSequence.length());
    ...
    public long mo5555getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m5571toLayoutTextGranularityduNsdkg(granularity), new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
        ...
        return rangeForRect == null ? TextRange.INSTANCE.m5726getZerod9O1mEE() : TextRangeKt.TextRange(rangeForRect[0], rangeForRect[1]);
    }
    ...
    public float getWidth() {
        return Constraints.m6186getMaxWidthimpl(this.constraints);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getWordBoundary--jx7JFs, reason: not valid java name */
    public long mo5556getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5557paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text_release.m5987setColor8_81llA(color);
        ...
        textPaint$ui_text_release.m5984setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5984setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-RPmYEkk, reason: not valid java name */
    public void mo5558paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5987setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
    ...
    public void mo5559painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5985setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5984setBlendModes9anfk8(blendMode);
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i2, boolean z, long j2) {
        ...
        this.ellipsis = z;
        this.constraints = j2;
        if (Constraints.m6187getMinHeightimpl(j2) != 0 || Constraints.m6188getMinWidthimpl(j2) != 0) {
        ...
        if (i2 >= 1) {
            ...
            int iM5566toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m5566toLayoutAlignaXe7zB0(style.m5762getTextAligne0LSkKk());
            boolean zM6118equalsimpl0 = TextAlign.m6118equalsimpl0(style.m5762getTextAligne0LSkKk(), TextAlign.INSTANCE.m6124getJustifye0LSkKk());
            int iM5568toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m5568toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
            int iM5567toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m5567toLayoutBreakStrategyxImikfE(LineBreak.m6042getStrategyfcGXIks(style.m5759getLineBreakrAG3T2k()));
            int iM5569toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m5569toLayoutLineBreakStylehpcqdu8(LineBreak.m6043getStrictnessusljTpc(style.m5759getLineBreakrAG3T2k()));
            int iM5570toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m5570toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m6044getWordBreakjp8hJ3c(style.m5759getLineBreakrAG3T2k()));
            TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
            TextLayout textLayoutConstructTextLayout = constructTextLayout(iM5566toLayoutAlignaXe7zB0, zM6118equalsimpl0 ? 1 : 0, truncateAt, i2, iM5568toLayoutHyphenationFrequency3fSNIE, iM5567toLayoutBreakStrategyxImikfE, iM5569toLayoutLineBreakStylehpcqdu8, iM5570toLayoutLineBreakWordStylewPN0Rpw);
            if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m6185getMaxHeightimpl(j2) && i2 > 1) {
                int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m6185getMaxHeightimpl(j2));
                if (iNumberOfLinesThatFitMaxHeight < 0 || iNumberOfLinesThatFitMaxHeight == i2) {
                    ...
                    androidParagraph = this;
                    textLayoutConstructTextLayout = androidParagraph.constructTextLayout(iM5566toLayoutAlignaXe7zB0, zM6118equalsimpl0 ? 1 : 0, truncateAt, iCoerceAtLeast, iM5568toLayoutHyphenationFrequency3fSNIE, iM5567toLayoutBreakStrategyxImikfE, iM5569toLayoutLineBreakStylehpcqdu8, iM5570toLayoutLineBreakWordStylewPN0Rpw);
                }
            ...
            androidParagraph.getTextPaint$ui_text_release().m5985setBrush12SF9DM(style.getBrush(), SizeKt.Size(androidParagraph.getWidth(), androidParagraph.getHeight()), style.getAlpha());
            ...
            if (shaderBrushSpans != null) {
                ...
                while (it.hasNext()) {
                    ((ShaderBrushSpan) it.next()).m6005setSizeuvyYCjk(SizeKt.Size(androidParagraph.getWidth(), androidParagraph.getHeight()));
                }
            }
            ...
            if (charSequence2 instanceof Spanned) {
                ...
                while (i3 < length) {
                    ...
                    if (z4 || z5 || z3) {
                        ...
                        int i4 = WhenMappings.$EnumSwitchMapping$0[androidParagraph.getBidiRunDirection(spanStart).ordinal()];
                        if (i4 == 1) {
    ...
    private AndroidParagraph(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i2, boolean z, long j2, FontFamily.Resolver resolver, Density density) {
