...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m6144copyNB67dxo$default(TextIndent textIndent, long j2, long j3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textIndent.m6145copyNB67dxo(j2, j3);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m6145copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6423equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m6423equalsimpl0(this.restLine, textIndent.restLine);
    }
    ...
    public int hashCode() {
        return TextUnit.m6427hashCodeimpl(this.restLine) + (TextUnit.m6427hashCodeimpl(this.firstLine) * 31);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m6433toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m6433toStringimpl(this.restLine)) + ')';
    }
