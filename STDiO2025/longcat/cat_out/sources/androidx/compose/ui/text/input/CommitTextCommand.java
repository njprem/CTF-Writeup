...
public final class CommitTextCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer buffer) {
        ...
        buffer.setCursor$ui_text_release(RangesKt.coerceIn(i2 > 0 ? (cursor$ui_text_release + i2) - 1 : (cursor$ui_text_release + i2) - getText().length(), 0, buffer.getLength$ui_text_release()));
    }
    ...
    public String toString() {
        ...
        return androidx.compose.runtime.changelist.a.o(sb, this.newCursorPosition, ')');
    }
