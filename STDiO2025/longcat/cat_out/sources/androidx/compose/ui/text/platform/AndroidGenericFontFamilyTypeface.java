...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    private final Typeface m5971buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return Build.VERSION.SDK_INT < 28 ? Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m5784getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle)) : TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m5830equalsimpl0(fontStyle, FontStyle.INSTANCE.m5836getItalic_LCdwA()));
    }
    ...
    public Typeface mo5970getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return m5971buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    }
}
