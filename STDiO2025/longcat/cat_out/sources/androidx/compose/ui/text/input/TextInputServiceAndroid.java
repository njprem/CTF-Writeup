...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, PositionCalculator positionCalculator, InputMethodManager inputMethodManager, Executor executor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m5968invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m5968invokeKlQnJC8(int i2) {
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m5726getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    private final void sendInputCommand(TextInputCommand command) {
        ...
        if (this.frameCallback == null) {
            x xVar = new x(this, 3);
            this.inputCommandProcessorExecutor.execute(xVar);
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            ...
            public void onConnectionClosed(RecordingInputConnection inputConnection) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    if (Intrinsics.areEqual(((WeakReference) TextInputServiceAndroid.this.ics.get(i2)).get(), inputConnection)) {
            ...
            public void mo5917onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m5882boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.stopInput.2
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m5969invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m5969invokeKlQnJC8(int i2) {
            }
        };
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        boolean z = (TextRange.m5714equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z) {
                ...
                int iM5719getMinimpl = TextRange.m5719getMinimpl(newValue.getSelection());
                int iM5718getMaximpl = TextRange.m5718getMaximpl(newValue.getSelection());
                TextRange textRangeM5966getCompositionMzsxiRA = this.state.getComposition();
                int iM5719getMinimpl2 = textRangeM5966getCompositionMzsxiRA != null ? TextRange.m5719getMinimpl(textRangeM5966getCompositionMzsxiRA.getPackedValue()) : -1;
                TextRange textRangeM5966getCompositionMzsxiRA2 = this.state.getComposition();
                inputMethodManager.updateSelection(iM5719getMinimpl, iM5718getMaximpl, iM5719getMinimpl2, textRangeM5966getCompositionMzsxiRA2 != null ? TextRange.m5718getMaximpl(textRangeM5966getCompositionMzsxiRA2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m5714equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInputImmediately();
            return;
        }
