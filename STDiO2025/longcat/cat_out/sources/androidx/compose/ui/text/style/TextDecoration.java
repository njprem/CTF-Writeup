...
public final class TextDecoration {
    ...
    public static final class Companion {
        ...
        public final TextDecoration combine(List<TextDecoration> decorations) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                numValueOf = Integer.valueOf(numValueOf.intValue() | decorations.get(i2).getMask());
            }
    ...
    public String toString() {
        ...
        if (arrayList.size() != 1) {
            return d.p(new StringBuilder("TextDecoration["), ListUtilsKt.fastJoinToString$default(arrayList, ", ", null, null, 0, null, null, 62, null), ']');
        }
