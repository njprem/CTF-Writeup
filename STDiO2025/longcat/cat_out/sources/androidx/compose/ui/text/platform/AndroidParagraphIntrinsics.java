...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [java.util.Collection, java.util.List, java.util.List<androidx.compose.ui.text.AnnotatedString$Range<androidx.compose.ui.text.SpanStyle>>] */
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m5976resolveTextDirectionHeuristicsHklW4sA(textStyle.m5764getTextDirections_7Xco(), textStyle.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m5975invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m5833unboximpl(), fontSynthesis.getValue());
            }

            /* renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m5975invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i2, int i3) {
                State<Object> stateMo5805resolveDPcqOEQ = this.this$0.getFontFamilyResolver().mo5805resolveDPcqOEQ(fontFamily, fontWeight, i2, i3);
                if (stateMo5805resolveDPcqOEQ instanceof TypefaceResult.Immutable) {
                    Object value = stateMo5805resolveDPcqOEQ.getValue();
                    Intrinsics.checkNotNull(value, "null cannot be cast to non-null type android.graphics.Typeface");
                    return (Typeface) value;
                }
                TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(stateMo5805resolveDPcqOEQ, this.this$0.resolvedTypefaces);
