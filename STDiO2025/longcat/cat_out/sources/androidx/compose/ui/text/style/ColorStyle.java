...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6021copy8_81llA$default(ColorStyle colorStyle, long j2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j2 = colorStyle.value;
        }
        return colorStyle.m6023copy8_81llA(j2);
    }
    ...
    public final ColorStyle m6023copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m3793equalsimpl0(this.value, ((ColorStyle) other).value);
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m3794getAlphaimpl(mo6020getColor0d7_KjU());
    }
    ...
    public final long m6024getValue0d7_KjU() {
        return this.value;
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m3800toStringimpl(this.value)) + ')';
    }
