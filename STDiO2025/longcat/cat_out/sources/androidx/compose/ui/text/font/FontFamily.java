...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        static /* synthetic */ State m5804resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
            if (obj != null) {
            ...
            return resolver.mo5805resolveDPcqOEQ(fontFamily, fontWeight, i2, i3);
        }

        Object preload(FontFamily fontFamily, Continuation<? super Unit> continuation);

        /* renamed from: resolve-DPcqOEQ, reason: not valid java name */
        State<Object> mo5805resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);
    }
