...
final class CanvasCompatQ {
    ...
    public final void drawTextRun(Canvas canvas, MeasuredText text, int start, int end, int contextStart, int contextEnd, float x2, float y2, boolean isRtl, Paint paint) {
