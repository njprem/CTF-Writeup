...
public final class AndroidFontKt {
    ...
    public static final Font m5779FontEj4NQ78(File file, FontWeight fontWeight, int i2, FontVariation.Settings settings) {
        return new AndroidFileFont(file, fontWeight, i2, settings, null);
    }

    /* renamed from: Font-Ej4NQ78$default, reason: not valid java name */
    public static /* synthetic */ Font m5781FontEj4NQ78$default(File file, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, Object obj) {
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            settings = FontVariation.INSTANCE.m5852Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m5779FontEj4NQ78(file, fontWeight, i2, settings);
    }

    /* renamed from: Font-MuC2MFs, reason: not valid java name */
    public static final Font m5782FontMuC2MFs(String str, AssetManager assetManager, FontWeight fontWeight, int i2, FontVariation.Settings settings) {
    ...
    public static /* synthetic */ Font m5783FontMuC2MFs$default(String str, AssetManager assetManager, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 8) != 0) {
        ...
        return m5782FontMuC2MFs(str, assetManager, fontWeight, i2, settings);
    }
    ...
    /* renamed from: Font-Ej4NQ78, reason: not valid java name */
    public static final Font m5778FontEj4NQ78(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i2, FontVariation.Settings settings) {
        return new AndroidFileDescriptorFont(parcelFileDescriptor, fontWeight, i2, settings, null);
    }

    /* renamed from: Font-Ej4NQ78$default, reason: not valid java name */
    public static /* synthetic */ Font m5780FontEj4NQ78$default(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
        ...
        return m5778FontEj4NQ78(parcelFileDescriptor, fontWeight, i2, settings);
    }
}
