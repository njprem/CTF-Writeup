...
public final class LineHeightStyle {
    ...
    public static final class Alignment {
        ...
        private static final float Top = m6092constructorimpl(0.0f);
        private static final float Center = m6092constructorimpl(0.5f);
        private static final float Proportional = m6092constructorimpl(-1.0f);
        private static final float Bottom = m6092constructorimpl(1.0f);
        ...
        public static final class Companion {
            ...
            public final float m6098getBottomPIaL0Z0() {
                return Alignment.Bottom;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m6099getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m6100getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getTop-PIaL0Z0, reason: not valid java name */
            public final float m6101getTopPIaL0Z0() {
        ...
        public static final /* synthetic */ Alignment m6091boximpl(float f2) {
            return new Alignment(f2);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m6092constructorimpl(float f2) {
        ...
        public static boolean m6093equalsimpl(float f2, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f2, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6094equalsimpl0(float f2, float f3) {
            return Float.compare(f2, f3) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m6095hashCodeimpl(float f2) {
            return Float.hashCode(f2);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m6096toStringimpl(float f2) {
            if (f2 == Top) {
        ...
        public boolean equals(Object obj) {
            return m6093equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m6095hashCodeimpl(this.topRatio);
        }

        public String toString() {
            return m6096toStringimpl(this.topRatio);
        }
    ...
    public static final class Trim {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final int FirstLineTop = m6103constructorimpl(1);
        private static final int LastLineBottom = m6103constructorimpl(16);
        private static final int Both = m6103constructorimpl(17);
        private static final int None = m6103constructorimpl(0);
        ...
        public static final class Companion {
            ...
            public final int m6111getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getFirstLineTop-EVpEnUU, reason: not valid java name */
            public final int m6112getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m6113getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m6114getNoneEVpEnUU() {
                return Trim.None;
            }
        ...
        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m6102boximpl(int i2) {
            return new Trim(i2);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m6103constructorimpl(int i2) {
            return i2;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m6104equalsimpl(int i2, Object obj) {
            return (obj instanceof Trim) && i2 == ((Trim) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6105equalsimpl0(int i2, int i3) {
            return i2 == i3;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m6106hashCodeimpl(int i2) {
            return Integer.hashCode(i2);
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release, reason: not valid java name */
        public static final boolean m6107isTrimFirstLineTopimpl$ui_text_release(int i2) {
            return (i2 & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m6108isTrimLastLineBottomimpl$ui_text_release(int i2) {
            return (i2 & 16) > 0;
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m6109toStringimpl(int i2) {
        ...
        public String toString() {
            return m6109toStringimpl(this.value);
        }
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m6100getProportionalPIaL0Z0(), Trim.INSTANCE.m6111getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m6094equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m6105equalsimpl0(this.trim, lineHeightStyle.trim);
    }
    ...
    public int hashCode() {
        return Trim.m6106hashCodeimpl(this.trim) + (Alignment.m6095hashCodeimpl(this.alignment) * 31);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m6096toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m6109toStringimpl(this.trim)) + ')';
    }
