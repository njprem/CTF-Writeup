...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    public FontWeight(int i2) {
        this.weight = i2;
        if (1 > i2 || i2 >= 1001) {
            throw new IllegalArgumentException(a.n("Font weight can be in range [1, 1000]. Current value: ", i2).toString());
        }
    }
    ...
    public String toString() {
        return a.o(new StringBuilder("FontWeight(weight="), this.weight, ')');
    }
