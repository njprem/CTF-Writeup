...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5784getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i2) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5830equalsimpl0(i2, FontStyle.INSTANCE.m5836getItalic_LCdwA()));
    }
}
