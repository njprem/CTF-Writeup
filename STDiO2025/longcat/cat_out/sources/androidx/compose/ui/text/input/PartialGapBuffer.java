...
public final class PartialGapBuffer {
    ...
    public final void replace(int start, int end, String text) {
        if (start > end) {
            throw new IllegalArgumentException(d.n("start index must be less than or equal to end index: ", start, end, " > ").toString());
        }
        if (start < 0) {
        ...
        this.buffer = new GapBuffer(cArr, text.length() + iMin, i6);
        this.bufStart = i5;
        this.bufEnd = i7;
    }
