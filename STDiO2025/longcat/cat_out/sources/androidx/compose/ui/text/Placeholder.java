...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m5631copyK8Q__8$default(Placeholder placeholder, long j2, long j3, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return placeholder.m5632copyK8Q__8(j4, j5, i2);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m5632copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6423equalsimpl0(this.width, placeholder.width) && TextUnit.m6423equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m5639equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }
    ...
    public int hashCode() {
        return PlaceholderVerticalAlign.m5640hashCodeimpl(this.placeholderVerticalAlign) + ((TextUnit.m6427hashCodeimpl(this.height) + (TextUnit.m6427hashCodeimpl(this.width) * 31)) * 31);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6433toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6433toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5641toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
    ...
    private Placeholder(long j2, long j3, int i2) {
        ...
        if (TextUnitKt.m6444isUnspecifiedR2X_6o(j3)) {
