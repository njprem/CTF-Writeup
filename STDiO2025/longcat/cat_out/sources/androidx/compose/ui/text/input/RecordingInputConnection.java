...
public final class RecordingInputConnection implements InputConnection {
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5719getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5715getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo5917onImeActionKlQnJC8(iM5898getDefaulteUduSuo);
        return true;
    }
