...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m3576getSizeNHjbRc$annotations() {
    }
    ...
    public final boolean m3577containsk4lQ0M(long offset) {
        return Offset.m3551getXimpl(offset) >= this.left && Offset.m3551getXimpl(offset) < this.right && Offset.m3552getYimpl(offset) >= this.top && Offset.m3552getYimpl(offset) < this.bottom;
    }
    ...
    public int hashCode() {
        return Float.hashCode(this.bottom) + d.b(d.b(Float.hashCode(this.left) * 31, 31, this.top), 31, this.right);
    }
    ...
    public final Rect m3588translatek4lQ0M(long offset) {
        return new Rect(Offset.m3551getXimpl(offset) + this.left, Offset.m3552getYimpl(offset) + this.top, Offset.m3551getXimpl(offset) + this.right, Offset.m3552getYimpl(offset) + this.bottom);
    }
