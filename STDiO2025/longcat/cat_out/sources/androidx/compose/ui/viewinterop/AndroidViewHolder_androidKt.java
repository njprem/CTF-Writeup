...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int iRound = Math.round(Offset.m3551getXimpl(jPositionInRoot));
        int iRound2 = Math.round(Offset.m3552getYimpl(jPositionInRoot));
    ...
    public static final int toNestedScrollSource(int i2) {
        return i2 == 0 ? NestedScrollSource.INSTANCE.m4886getUserInputWNlRxjI() : NestedScrollSource.INSTANCE.m4885getSideEffectWNlRxjI();
    }
}
