...
public final class ColorPainter extends Painter {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m3793equalsimpl0(this.color, ((ColorPainter) other).color);
    }
    ...
    public int hashCode() {
        return Color.m3799hashCodeimpl(this.color);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    public void onDraw(DrawScope drawScope) {
        DrawScope.m4336drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m3800toStringimpl(this.color)) + ')';
    }
