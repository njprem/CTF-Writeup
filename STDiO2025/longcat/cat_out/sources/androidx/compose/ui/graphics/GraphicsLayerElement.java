...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m3939copyJVvOYNQ$default(GraphicsLayerElement graphicsLayerElement, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, long j2, Shape shape, boolean z, RenderEffect renderEffect, long j3, long j4, int i2, int i3, Object obj) {
        int i4;
        long j5;
        ...
        float f20 = (i3 & Fields.RotationX) != 0 ? graphicsLayerElement.rotationZ : f10;
        float f21 = (i3 & 512) != 0 ? graphicsLayerElement.cameraDistance : f11;
        long j6 = (i3 & 1024) != 0 ? graphicsLayerElement.transformOrigin : j2;
        Shape shape2 = (i3 & Fields.CameraDistance) != 0 ? graphicsLayerElement.shape : shape;
        ...
        long j7 = (i3 & Fields.Clip) != 0 ? graphicsLayerElement.ambientShadowColor : j3;
        long j8 = (i3 & Fields.CompositingStrategy) != 0 ? graphicsLayerElement.spotShadowColor : j4;
        if ((i3 & 65536) != 0) {
            j5 = j8;
        ...
        return graphicsLayerElement.m3944copyJVvOYNQ(f22, f13, f14, f15, f16, f17, f18, f19, f20, f21, j6, shape2, z2, renderEffect2, j7, j5, i4);
    }
    ...
    public final long m3945getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }
    ...
    public final int m3946getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public final long m3947getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getTransformOrigin-SzJe1aQ, reason: not valid java name */
    public final long m3948getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int i2 = J.d.i(this.clip, (this.shape.hashCode() + ((TransformOrigin.m4179hashCodeimpl(this.transformOrigin) + J.d.b(J.d.b(J.d.b(J.d.b(J.d.b(J.d.b(J.d.b(J.d.b(J.d.b(Float.hashCode(this.scaleX) * 31, 31, this.scaleY), 31, this.alpha), 31, this.translationX), 31, this.translationY), 31, this.shadowElevation), 31, this.rotationX), 31, this.rotationY), 31, this.rotationZ), 31, this.cameraDistance)) * 31)) * 31, 31);
        RenderEffect renderEffect = this.renderEffect;
        return CompositingStrategy.m3877hashCodeimpl(this.compositingStrategy) + J.d.d(this.spotShadowColor, J.d.d(this.ambientShadowColor, (i2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31, 31), 31);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m4169boximpl(this.transformOrigin));
        inspectorInfo.getProperties().set("shape", this.shape);
        J.d.k(this.clip, inspectorInfo.getProperties(), "clip", inspectorInfo).set("renderEffect", this.renderEffect);
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m3782boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m3782boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m3873boximpl(this.compositingStrategy));
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m4125setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m4122setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m4124setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m4123setCompositingStrategyaDBOjCE(this.compositingStrategy);
