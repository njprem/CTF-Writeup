...
public final class RenderEffectKt {
    ...
    public static final BlurEffect m4099BlurEffect3YTHUZs(float f2, float f3, int i2) {
        return new BlurEffect(null, f2, f3, i2, null);
    }

    /* renamed from: BlurEffect-3YTHUZs$default, reason: not valid java name */
    public static /* synthetic */ BlurEffect m4100BlurEffect3YTHUZs$default(float f2, float f3, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i2 = TileMode.INSTANCE.m4164getClamp3opZhB0();
        }
        return m4099BlurEffect3YTHUZs(f2, f3, i2);
    }
