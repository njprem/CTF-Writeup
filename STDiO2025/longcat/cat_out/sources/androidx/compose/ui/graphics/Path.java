...
public interface Path {
    ...
    public static final class Companion {
        ...
        public final Path m4062combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo3684opN5in7k0(path1, path2, operation)) {
                return Path;
            }
    ...
    public static final class DefaultImpls {
        ...
        public static void m4064transform58bKbWc(Path path, float[] fArr) {
            Path.super.mo3686transform58bKbWc(fArr);
        }
    ...
    static /* synthetic */ void m4061addPathUv8p0NA$default(Path path, Path path2, long j2, int i2, Object obj) {
        if (obj != null) {
        ...
        path.mo3682addPathUv8p0NA(path2, j2);
    }
    ...
    void mo3682addPathUv8p0NA(Path path, long offset);
    ...
    default Path and(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3684opN5in7k0(this, path, PathOperation.INSTANCE.m4084getIntersectb3I0S0c());
        return Path;
    }
    ...
    default Path minus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3684opN5in7k0(this, path, PathOperation.INSTANCE.m4083getDifferenceb3I0S0c());
        return Path;
    }
    ...
    boolean mo3684opN5in7k0(Path path1, Path path2, int operation);
    ...
    default Path plus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3684opN5in7k0(this, path, PathOperation.INSTANCE.m4086getUnionb3I0S0c());
        return Path;
    }
    ...
    void mo3685setFillTypeoQ8Xj4U(int i2);

    /* renamed from: transform-58bKbWc */
    default void mo3686transform58bKbWc(float[] matrix) {
    }

    /* renamed from: translate-k-4lQ0M */
    void mo3687translatek4lQ0M(long offset);

    default Path xor(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3684opN5in7k0(this, path, PathOperation.INSTANCE.m4087getXorb3I0S0c());
        return Path;
    }
