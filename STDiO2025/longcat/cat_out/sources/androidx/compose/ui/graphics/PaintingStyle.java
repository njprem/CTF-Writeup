...
public final class PaintingStyle {
    ...
    private static final int Fill = m4052constructorimpl(0);
    private static final int Stroke = m4052constructorimpl(1);
    ...
    public static final class Companion {
        ...
        public final int m4058getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m4059getStrokeTiuSbCo() {
    ...
    public static final /* synthetic */ PaintingStyle m4051boximpl(int i2) {
        return new PaintingStyle(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4052constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4053equalsimpl(int i2, Object obj) {
        return (obj instanceof PaintingStyle) && i2 == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4054equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4055hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4056toStringimpl(int i2) {
        return m4054equalsimpl0(i2, Fill) ? "Fill" : m4054equalsimpl0(i2, Stroke) ? "Stroke" : "Unknown";
    }
