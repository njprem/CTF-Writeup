...
public final class ImageBitmapKt {
    ...
    public static final ImageBitmap m4016ImageBitmapx__hDU(int i2, int i3, int i4, boolean z, ColorSpace colorSpace) {
        return AndroidImageBitmap_androidKt.m3660ActualImageBitmapx__hDU(i2, i3, i4, z, colorSpace);
    }

    /* renamed from: ImageBitmap-x__-hDU$default, reason: not valid java name */
    public static /* synthetic */ ImageBitmap m4017ImageBitmapx__hDU$default(int i2, int i3, int i4, boolean z, ColorSpace colorSpace, int i5, Object obj) {
        if ((i5 & 4) != 0) {
            i4 = ImageBitmapConfig.INSTANCE.m4012getArgb8888_sVssgQ();
        }
        if ((i5 & 8) != 0) {
            z = true;
        }
        ...
        return m4016ImageBitmapx__hDU(i2, i3, i4, z, colorSpace);
    }
