...
public final class VectorGroup extends VectorNode implements Iterable<VectorNode>, KMappedMarker {
    ...
    public int hashCode() {
        return this.children.hashCode() + ((this.clipPathData.hashCode() + d.b(d.b(d.b(d.b(d.b(d.b(d.b(this.name.hashCode() * 31, 31, this.rotation), 31, this.pivotX), 31, this.pivotY), 31, this.scaleX), 31, this.scaleY), 31, this.translationX), 31, this.translationY)) * 31);
    }
    ...
    public /* synthetic */ VectorGroup(String str, float f2, float f3, float f4, float f5, float f6, float f7, float f8, List list, List list2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? "" : str, (i2 & 2) != 0 ? 0.0f : f2, (i2 & 4) != 0 ? 0.0f : f3, (i2 & 8) != 0 ? 0.0f : f4, (i2 & 16) != 0 ? 1.0f : f5, (i2 & 32) != 0 ? 1.0f : f6, (i2 & 64) != 0 ? 0.0f : f7, (i2 & 128) != 0 ? 0.0f : f8, (i2 & Fields.RotationX) != 0 ? VectorKt.getEmptyPath() : list, (i2 & 512) != 0 ? CollectionsKt.emptyList() : list2);
    }
