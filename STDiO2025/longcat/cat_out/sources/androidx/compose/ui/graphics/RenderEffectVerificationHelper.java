...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m4101createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        return inputRenderEffect == null ? android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m3697toAndroidTileMode0vamqd0(edgeTreatment)) : android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m3697toAndroidTileMode0vamqd0(edgeTreatment));
    }

    /* renamed from: createOffsetEffect-Uv8p0NA, reason: not valid java name */
    public final android.graphics.RenderEffect m4102createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        return inputRenderEffect == null ? android.graphics.RenderEffect.createOffsetEffect(Offset.m3551getXimpl(offset), Offset.m3552getYimpl(offset)) : android.graphics.RenderEffect.createOffsetEffect(Offset.m3551getXimpl(offset), Offset.m3552getYimpl(offset), inputRenderEffect.asAndroidRenderEffect());
    }
}
