...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m3833tintxETnrds$default(Companion companion, long j2, int i2, int i3, Object obj) {
            if ((i3 & 2) != 0) {
                i2 = BlendMode.INSTANCE.m3732getSrcIn0nO6VwU();
            }
            return companion.m3836tintxETnrds(j2, i2);
        }

        /* renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m3834colorMatrixjHGOpc(float[] colorMatrix) {
            return new ColorMatrixColorFilter(colorMatrix, (DefaultConstructorMarker) null);
        }

        /* renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m3835lightingOWjLjI(long multiply, long add) {
            return new LightingColorFilter(multiply, add, (DefaultConstructorMarker) null);
        }

        /* renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m3836tintxETnrds(long color, int blendMode) {
