...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m3688actualStampedPathEffect7aD1DOk(Path path, float f2, float f3, int i2) {
        if (path instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) path).getInternalPath(), f2, f3, m3689toAndroidPathDashPathEffectStyleoQv6xUo(i2)));
        }
    ...
    public static final PathDashPathEffect.Style m3689toAndroidPathDashPathEffectStyleoQv6xUo(int i2) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.INSTANCE;
        return StampedPathEffectStyle.m4130equalsimpl0(i2, companion.m4134getMorphYpspkwk()) ? PathDashPathEffect.Style.MORPH : StampedPathEffectStyle.m4130equalsimpl0(i2, companion.m4135getRotateYpspkwk()) ? PathDashPathEffect.Style.ROTATE : StampedPathEffectStyle.m4130equalsimpl0(i2, companion.m4136getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
