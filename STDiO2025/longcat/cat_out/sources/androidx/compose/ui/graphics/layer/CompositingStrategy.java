...
public final class CompositingStrategy {
    ...
    private static final int Auto = m4416constructorimpl(0);
    private static final int Offscreen = m4416constructorimpl(1);
    private static final int ModulateAlpha = m4416constructorimpl(2);
    ...
    public static final /* synthetic */ CompositingStrategy m4415boximpl(int i2) {
        return new CompositingStrategy(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4416constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4417equalsimpl(int i2, Object obj) {
        return (obj instanceof CompositingStrategy) && i2 == ((CompositingStrategy) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4418equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4419hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4420toStringimpl(int i2) {
        return d.m("CompositingStrategy(value=", i2, ')');
    }
    ...
    public int hashCode() {
        return m4419hashCodeimpl(this.value);
    }

    public String toString() {
        return m4420toStringimpl(this.value);
    }
