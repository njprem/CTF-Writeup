...
public final class PathBuilder {
    ...
    public final PathBuilder horizontalLineTo(float x2) {
    ...
    public final PathBuilder lineTo(float x2, float y2) {
    ...
    public final PathBuilder moveTo(float x2, float y2) {
    ...
    public final PathBuilder verticalLineTo(float y2) {
