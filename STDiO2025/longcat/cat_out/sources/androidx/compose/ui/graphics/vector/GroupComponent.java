...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3828getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4469markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4469markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j2 = this.tintColor;
            if (j2 == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m4492rgbEqualOWjLjI(j2, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m4469markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM4022constructorimpl$default = this.groupMatrix;
        if (fArrM4022constructorimpl$default == null) {
            fArrM4022constructorimpl$default = Matrix.m4022constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM4022constructorimpl$default;
        } else {
            Matrix.m4031resetimpl(fArrM4022constructorimpl$default);
        }
        float[] fArr = fArrM4022constructorimpl$default;
        Matrix.m4042translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m4034rotateZimpl(fArr, this.rotation);
        Matrix.m4035scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m4042translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.mo4271transform58bKbWc(Matrix.m4020boximpl(fArr).m4043unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.m4398clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
