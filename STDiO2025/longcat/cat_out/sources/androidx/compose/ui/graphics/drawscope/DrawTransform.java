...
public interface DrawTransform {
    ...
    public static final class DefaultImpls {
        ...
        public static long m4404getCenterF1C5BW0(DrawTransform drawTransform) {
            return DrawTransform.super.mo4267getCenterF1C5BW0();
        }
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m4398clipPathmtrdDE$default(DrawTransform drawTransform, Path path, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        drawTransform.mo4265clipPathmtrdDE(path, i2);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m4399clipRectN_I0leg$default(DrawTransform drawTransform, float f2, float f3, float f4, float f5, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        if ((i3 & 4) != 0) {
            f4 = Size.m3620getWidthimpl(drawTransform.mo4268getSizeNHjbRc());
        }
        if ((i3 & 8) != 0) {
            f5 = Size.m3617getHeightimpl(drawTransform.mo4268getSizeNHjbRc());
        }
        if ((i3 & 16) != 0) {
            i2 = ClipOp.INSTANCE.m3781getIntersectrtfAjoo();
        }
        drawTransform.mo4266clipRectN_I0leg(f2, f3, f4, f5, i2);
    }

    /* renamed from: rotate-Uv8p0NA$default, reason: not valid java name */
    static /* synthetic */ void m4400rotateUv8p0NA$default(DrawTransform drawTransform, float f2, long j2, int i2, Object obj) {
        if (obj != null) {
        ...
        drawTransform.mo4269rotateUv8p0NA(f2, j2);
    }

    /* renamed from: scale-0AR0LA0$default, reason: not valid java name */
    static /* synthetic */ void m4401scale0AR0LA0$default(DrawTransform drawTransform, float f2, float f3, long j2, int i2, Object obj) {
        if (obj != null) {
        ...
        drawTransform.mo4270scale0AR0LA0(f2, f3, j2);
    }
    ...
    void mo4265clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo4266clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: getCenter-F1C5BW0 */
    default long mo4267getCenterF1C5BW0() {
        float f2 = 2;
        return OffsetKt.Offset(Size.m3620getWidthimpl(mo4268getSizeNHjbRc()) / f2, Size.m3617getHeightimpl(mo4268getSizeNHjbRc()) / f2);
    }

    /* renamed from: getSize-NH-jbRc */
    long mo4268getSizeNHjbRc();

    void inset(float left, float top, float right, float bottom);

    /* renamed from: rotate-Uv8p0NA */
    void mo4269rotateUv8p0NA(float degrees, long pivot);

    /* renamed from: scale-0AR0LA0 */
    void mo4270scale0AR0LA0(float scaleX, float scaleY, long pivot);

    /* renamed from: transform-58bKbWc */
    void mo4271transform58bKbWc(float[] matrix);
