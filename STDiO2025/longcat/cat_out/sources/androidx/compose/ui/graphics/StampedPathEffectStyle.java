...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4128constructorimpl(0);
    private static final int Rotate = m4128constructorimpl(1);
    private static final int Morph = m4128constructorimpl(2);
    ...
    public static final /* synthetic */ StampedPathEffectStyle m4127boximpl(int i2) {
        return new StampedPathEffectStyle(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4128constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4129equalsimpl(int i2, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i2 == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4130equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4131hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4132toStringimpl(int i2) {
        return m4130equalsimpl0(i2, Translate) ? "Translate" : m4130equalsimpl0(i2, Rotate) ? "Rotate" : m4130equalsimpl0(i2, Morph) ? "Morph" : "Unknown";
    }

    public boolean equals(Object obj) {
        return m4129equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4131hashCodeimpl(this.value);
    }

    public String toString() {
        return m4132toStringimpl(this.value);
    }
