...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    public static /* synthetic */ float[] m3869copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            fArr = ColorMatrix.m3849constructorimpl$default(null, 1, null);
        }
        return colorMatrixColorFilter.m3871copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: obtainColorMatrix-p10-uLo, reason: not valid java name */
    private final float[] m3870obtainColorMatrixp10uLo() {
    ...
    public final float[] m3871copyColorMatrixgBh15pI(float[] targetColorMatrix) {
        ArraysKt___ArraysJvmKt.copyInto$default(m3870obtainColorMatrixp10uLo(), targetColorMatrix, 0, 0, 0, 14, (Object) null);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorMatrixColorFilter) && Arrays.equals(m3870obtainColorMatrixp10uLo(), ((ColorMatrixColorFilter) other).m3870obtainColorMatrixp10uLo());
    }

    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m3856hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        sb.append((Object) (fArr == null ? "null" : ColorMatrix.m3867toStringimpl(fArr)));
        sb.append(')');
        return sb.toString();
    }
    ...
    private ColorMatrixColorFilter(float[] fArr) {
        this(fArr, AndroidColorFilter_androidKt.m3656actualColorMatrixColorFilterjHGOpc(fArr), null);
    }
}
