...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo3761createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3572isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m3630getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m3551getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3620getWidthimpl(size) : Offset.m3551getXimpl(this.center), Offset.m3552getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3617getHeightimpl(size) : Offset.m3552getYimpl(this.center));
        }
        return ShaderKt.m4110SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m3548equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iHashCode = (this.colors.hashCode() + (Offset.m3553hashCodeimpl(this.center) * 31)) * 31;
