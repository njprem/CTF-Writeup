...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3734getSrcOver0nO6VwU();
    }
    ...
    public long mo3665getColor0d7_KjU() {
    ...
    public int mo3666getFilterQualityfv9h1I() {
    ...
    public int mo3669getStyleTiuSbCo() {
    ...
    public void mo3670setBlendModes9anfk8(int i2) {
        if (BlendMode.m3703equalsimpl0(this._blendMode, i2)) {
            return;
        }
        this._blendMode = i2;
        AndroidPaint_androidKt.m3676setNativeBlendModeGB0RdKg(this.internalPaint, i2);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3671setColor8_81llA(long j2) {
        AndroidPaint_androidKt.m3677setNativeColor4WTKRHQ(this.internalPaint, j2);
    }
    ...
    public void mo3672setFilterQualityvDHp3xo(int i2) {
        AndroidPaint_androidKt.m3678setNativeFilterQuality50PEsBU(this.internalPaint, i2);
    }
    ...
    public void mo3673setStrokeCapBeK7IIE(int i2) {
        AndroidPaint_androidKt.m3679setNativeStrokeCapCSYIeUk(this.internalPaint, i2);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3674setStrokeJoinWw9F2mQ(int i2) {
        AndroidPaint_androidKt.m3680setNativeStrokeJoinkLtJ_vA(this.internalPaint, i2);
    }
    ...
    public void mo3675setStylek9PVt8s(int i2) {
        AndroidPaint_androidKt.m3681setNativeStyle5YerkU(this.internalPaint, i2);
    }
