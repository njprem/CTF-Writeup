...
public final class BlurEffect extends RenderEffect {
    ...
    public android.graphics.RenderEffect getAndroidRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m4101createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.radiusX == blurEffect.radiusX && this.radiusY == blurEffect.radiusY && TileMode.m4160equalsimpl0(this.edgeTreatment, blurEffect.edgeTreatment) && Intrinsics.areEqual(this.renderEffect, blurEffect.renderEffect);
    }

    public int hashCode() {
        RenderEffect renderEffect = this.renderEffect;
        return TileMode.m4161hashCodeimpl(this.edgeTreatment) + J.d.b(J.d.b((renderEffect != null ? renderEffect.hashCode() : 0) * 31, 31, this.radiusX), 31, this.radiusY);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + ((Object) TileMode.m4162toStringimpl(this.edgeTreatment)) + ')';
    }
    ...
    public /* synthetic */ BlurEffect(RenderEffect renderEffect, float f2, float f3, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(renderEffect, f2, (i3 & 4) != 0 ? f2 : f3, (i3 & 8) != 0 ? TileMode.INSTANCE.m4164getClamp3opZhB0() : i2, null);
    }
}
