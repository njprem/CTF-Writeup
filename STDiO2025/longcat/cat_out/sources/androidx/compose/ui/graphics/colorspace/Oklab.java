...
public final class Oklab extends ColorSpace {
    ...
    public float[] fromXyz(float[] v2) {
        ...
        v2[0] = MathHelpersKt.fastCbrt(v2[0]);
        v2[1] = MathHelpersKt.fastCbrt(v2[1]);
        v2[2] = MathHelpersKt.fastCbrt(v2[2]);
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        float f3 = (fArr[6] * f2) + (fArr[3] * v1) + (fArr[0] * v0);
        float f4 = (fArr[7] * f2) + (fArr[4] * v1) + (fArr[1] * v0);
        float f5 = (fArr[8] * f2) + (fArr[5] * v1) + (fArr[2] * v0);
        float f6 = f4 * f4 * f4;
        float f7 = f5 * f5 * f5;
    ...
    public long mo4208xyzaToColorJlNiLsg$ui_graphics_release(float x2, float y2, float z, float a2, ColorSpace colorSpace) {
        float[] fArr = M1;
        float f2 = (fArr[6] * z) + (fArr[3] * y2) + (fArr[0] * x2);
        float f3 = (fArr[7] * z) + (fArr[4] * y2) + (fArr[1] * x2);
        float f4 = (fArr[8] * z) + (fArr[5] * y2) + (fArr[2] * x2);
        ...
        float[] fArr2 = M2;
        return ColorKt.Color((fArr2[6] * fFastCbrt3) + (fArr2[3] * fFastCbrt2) + (fArr2[0] * fFastCbrt), (fArr2[7] * fFastCbrt3) + (fArr2[4] * fFastCbrt2) + (fArr2[1] * fFastCbrt), (fArr2[8] * fFastCbrt3) + (fArr2[5] * fFastCbrt2) + (fArr2[2] * fFastCbrt), a2, colorSpace);
    }
}
