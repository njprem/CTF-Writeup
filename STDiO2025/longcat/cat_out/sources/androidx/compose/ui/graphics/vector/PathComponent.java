...
public final class PathComponent extends VNode {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo3683getFillTypeRgk1Os = this.renderPath.mo3683getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo3685setFillTypeoQ8Xj4U(iMo3683getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m4331drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m4331drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
    ...
    public final void m4482setPathFillTypeoQ8Xj4U(int i2) {
        this.pathFillType = i2;
        this.renderPath.mo3685setFillTypeoQ8Xj4U(i2);
        invalidate();
    }
    ...
    public final void m4483setStrokeLineCapBeK7IIE(int i2) {
    ...
    public final void m4484setStrokeLineJoinWw9F2mQ(int i2) {
