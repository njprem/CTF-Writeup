...
public abstract class ColorSpace {
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m4198equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public final float[] fromXyz(float x2, float y2, float z) {
        float[] fArr = new float[ColorModel.m4199getComponentCountimpl(this.model)];
        fArr[0] = x2;
        fArr[1] = y2;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public final int getComponentCount() {
        return ColorModel.m4199getComponentCountimpl(this.model);
    }
    ...
    public int hashCode() {
        return ((ColorModel.m4200hashCodeimpl(this.model) + (this.name.hashCode() * 31)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m4201toStringimpl(this.model)) + ')';
    }
    ...
    public final float[] toXyz(float r2, float g2, float b2) {
        return toXyz(new float[]{r2, g2, b2});
    }
    ...
    public long mo4208xyzaToColorJlNiLsg$ui_graphics_release(float x2, float y2, float z, float a2, ColorSpace colorSpace) {
        float[] fArrFromXyz = fromXyz(x2, y2, z);
