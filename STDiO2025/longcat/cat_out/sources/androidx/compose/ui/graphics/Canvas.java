...
public interface Canvas {
    ...
    public static final class DefaultImpls {
        ...
        public static void m3770clipRectmtrdDE(Canvas canvas, Rect rect, int i2) {
            Canvas.super.m3767clipRectmtrdDE(rect, i2);
        }
    ...
    static /* synthetic */ void m3763clipPathmtrdDE$default(Canvas canvas, Path path, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        canvas.mo3645clipPathmtrdDE(path, i2);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m3764clipRectN_I0leg$default(Canvas canvas, float f2, float f3, float f4, float f5, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        canvas.mo3646clipRectN_I0leg(f2, f3, f4, f5, i2);
    }

    /* renamed from: clipRect-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m3765clipRectmtrdDE$default(Canvas canvas, Rect rect, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        canvas.m3767clipRectmtrdDE(rect, i2);
    }

    /* renamed from: drawImageRect-HPBpro0$default, reason: not valid java name */
    static /* synthetic */ void m3766drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j2, long j3, long j4, long j5, Paint paint, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM6371getZeronOccac = (i2 & 2) != 0 ? IntOffset.INSTANCE.m6371getZeronOccac() : j2;
        long jIntSize = (i2 & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j3;
        canvas.mo3650drawImageRectHPBpro0(imageBitmap, jM6371getZeronOccac, jIntSize, (i2 & 8) != 0 ? IntOffset.INSTANCE.m6371getZeronOccac() : j4, (i2 & 16) != 0 ? jIntSize : j5, paint);
    }
    ...
    void mo3645clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo3646clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m3767clipRectmtrdDE(Rect rect, int clipOp) {
        mo3646clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: concat-58bKbWc */
    void mo3647concat58bKbWc(float[] matrix);
    ...
    void mo3648drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo3649drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo3650drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo3651drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo3652drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo3653drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo3654drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
