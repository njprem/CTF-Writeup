...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4144getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4155getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3732getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3827getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4074getNonZeroRgk1Os();
    ...
    public static final boolean m4492rgbEqualOWjLjI(long j2, long j3) {
        return Color.m3798getRedimpl(j2) == Color.m3798getRedimpl(j3) && Color.m3797getGreenimpl(j2) == Color.m3797getGreenimpl(j3) && Color.m3795getBlueimpl(j2) == Color.m3795getBlueimpl(j3);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m3703equalsimpl0(blendMode, companion.m3732getSrcIn0nO6VwU()) || BlendMode.m3703equalsimpl0(blendModeColorFilter.getBlendMode(), companion.m3734getSrcOver0nO6VwU());
    }
}
