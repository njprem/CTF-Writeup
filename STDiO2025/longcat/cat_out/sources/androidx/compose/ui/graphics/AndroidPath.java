...
public final class AndroidPath implements Path {
    ...
    public void mo3682addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (!(path instanceof AndroidPath)) {
            throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
        }
        path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3551getXimpl(offset), Offset.m3552getYimpl(offset));
    }
    ...
    public int mo3683getFillTypeRgk1Os() {
        return this.internalPath.getFillType() == Path.FillType.EVEN_ODD ? PathFillType.INSTANCE.m4073getEvenOddRgk1Os() : PathFillType.INSTANCE.m4074getNonZeroRgk1Os();
    }
    ...
    public boolean mo3684opN5in7k0(Path path1, Path path2, int operation) {
        PathOperation.Companion companion = PathOperation.INSTANCE;
        Path.Op op = PathOperation.m4079equalsimpl0(operation, companion.m4083getDifferenceb3I0S0c()) ? Path.Op.DIFFERENCE : PathOperation.m4079equalsimpl0(operation, companion.m4084getIntersectb3I0S0c()) ? Path.Op.INTERSECT : PathOperation.m4079equalsimpl0(operation, companion.m4085getReverseDifferenceb3I0S0c()) ? Path.Op.REVERSE_DIFFERENCE : PathOperation.m4079equalsimpl0(operation, companion.m4086getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3685setFillTypeoQ8Xj4U(int i2) {
        this.internalPath.setFillType(PathFillType.m4069equalsimpl0(i2, PathFillType.INSTANCE.m4073getEvenOddRgk1Os()) ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: transform-58bKbWc, reason: not valid java name */
    public void mo3686transform58bKbWc(float[] matrix) {
    ...
    public void mo3687translatek4lQ0M(long offset) {
        ...
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        matrix2.setTranslate(Offset.m3551getXimpl(offset), Offset.m3552getYimpl(offset));
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m3526getXimpl(roundRect.m3601getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3527getYimpl(roundRect.m3601getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3526getXimpl(roundRect.m3602getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3527getYimpl(roundRect.m3602getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3526getXimpl(roundRect.m3600getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3527getYimpl(roundRect.m3600getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3526getXimpl(roundRect.m3599getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3527getYimpl(roundRect.m3599getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
