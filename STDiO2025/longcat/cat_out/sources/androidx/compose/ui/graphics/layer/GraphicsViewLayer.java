...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j2, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.compositingStrategy = CompositingStrategy.INSTANCE.m4422getAutoke2Ky5w();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3567getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        Color.Companion companion = Color.INSTANCE;
        this.ambientShadowColor = companion.m3818getBlack0d7_KjU();
        this.spotShadowColor = companion.m3818getBlack0d7_KjU();
    }

    /* renamed from: applyCompositingLayer-Wpw9cng, reason: not valid java name */
    private final void m4458applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4418equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4424getOffscreenke2Ky5w()) || requiresLayerPaint();
    }
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4458applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m4424getOffscreenke2Ky5w());
        } else {
            m4458applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            Picture picture = this.picture;
            if (picture != null) {
                Canvas canvasBeginRecording = picture.beginRecording(IntSize.m6403getWidthimpl(this.size), IntSize.m6402getHeightimpl(this.size));
                try {
    ...
    public void mo4450setAmbientShadowColor8_81llA(long j2) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m3846toArgb8_81llA(j2));
        }
    }
    ...
    public void mo4453setPivotOffsetk4lQ0M(long j2) {
        ...
        if (!OffsetKt.m3572isUnspecifiedk4lQ0M(j2)) {
            ...
            this.viewLayer.setPivotX(Offset.m3551getXimpl(j2));
            this.viewLayer.setPivotY(Offset.m3552getYimpl(j2));
        } else {
            if (Build.VERSION.SDK_INT >= 28) {
            ...
            this.viewLayer.setPivotX(IntSize.m6403getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m6402getHeightimpl(this.size) / 2.0f);
        }
    }
    ...
    public void mo4454setPositionH0pRuoY(int x2, int y2, long size) {
        if (IntSize.m6401equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x2, y2, IntSize.m6403getWidthimpl(size) + x2, IntSize.m6402getHeightimpl(size) + y2);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6403getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6402getHeightimpl(size) / 2.0f);
            }
        }
        this.x = x2;
        this.y = y2;
    ...
    public void mo4455setSpotShadowColor8_81llA(long j2) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m3846toArgb8_81llA(j2));
        }
    }
