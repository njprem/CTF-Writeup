...
public final class AndroidUiDispatcher extends CoroutineDispatcher {
    ...
    private static final Lazy<CoroutineContext> Main$delegate = LazyKt.lazy(new Function0<CoroutineContext>() { // from class: androidx.compose.ui.platform.AndroidUiDispatcher$Companion$Main$2
        ...
        public final CoroutineContext invoke() {
            AndroidUiDispatcher androidUiDispatcher = new AndroidUiDispatcher(AndroidUiDispatcher_androidKt.isMainThread() ? Choreographer.getInstance() : (Choreographer) BuildersKt.runBlocking(Dispatchers.getMain(), new AndroidUiDispatcher$Companion$Main$2$dispatcher$1(null)), AbstractC0131b.l(Looper.getMainLooper()), null);
    ...
    private static final ThreadLocal<CoroutineContext> currentThread = new ThreadLocal<CoroutineContext>() { // from class: androidx.compose.ui.platform.AndroidUiDispatcher$Companion$currentThread$1
        ...
        public CoroutineContext initialValue() {
            ...
            AndroidUiDispatcher androidUiDispatcher = new AndroidUiDispatcher(choreographer, AbstractC0131b.l(looperMyLooper), null);
            return androidUiDispatcher.plus(androidUiDispatcher.getFrameClock());
        }
    };
        ...
        synchronized (this.lock) {
            if (this.scheduledFrameDispatch) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    list.get(i2).doFrame(frameTimeNanos);
                }
                list.clear();
            }
        }
    ...
    public void mo8053dispatch(CoroutineContext context, Runnable block) {
        synchronized (this.lock) {
            try {
