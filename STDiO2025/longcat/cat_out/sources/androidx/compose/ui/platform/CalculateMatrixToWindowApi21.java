...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    private final void m5454preConcattUYjHk(float[] fArr, Matrix matrix) {
        AndroidMatrixConversions_androidKt.m3663setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m5451preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m5455preTranslate3XD1CNM(float[] fArr, float f2, float f3) {
        AndroidComposeView_androidKt.m5452preTranslatecG2Xzmc(fArr, f2, f3, this.tmpMatrix);
    }

    /* renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m5456transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m5456transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m5455preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m5455preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpLocation);
            m5455preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m5455preTranslate3XD1CNM(matrix, r0[0], r0[1]);
        }
        Matrix matrix2 = view.getMatrix();
        if (matrix2.isIdentity()) {
            return;
        }
        m5454preConcattUYjHk(matrix, matrix2);
    }

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo5453calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4031resetimpl(matrix);
        m5456transformMatrixToWindowEL8BTi8(view, matrix);
    }
