...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5481calculateInverseMatrixbWbORWo(T target) {
        float[] fArrM4022constructorimpl$default = this.inverseMatrixCache;
        if (fArrM4022constructorimpl$default == null) {
            fArrM4022constructorimpl$default = androidx.compose.ui.graphics.Matrix.m4022constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArrM4022constructorimpl$default;
        }
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m5479invertToJiSxe2E(m5482calculateMatrixGrdbGEg(target), fArrM4022constructorimpl$default);
    ...
    public final float[] m5482calculateMatrixGrdbGEg(T target) {
        float[] fArrM4022constructorimpl$default = this.matrixCache;
        if (fArrM4022constructorimpl$default == null) {
            fArrM4022constructorimpl$default = androidx.compose.ui.graphics.Matrix.m4022constructorimpl$default(null, 1, null);
            this.matrixCache = fArrM4022constructorimpl$default;
        }
        if (!this.isDirty) {
            return fArrM4022constructorimpl$default;
        }
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m3663setFromtUYjHk(fArrM4022constructorimpl$default, matrix);
