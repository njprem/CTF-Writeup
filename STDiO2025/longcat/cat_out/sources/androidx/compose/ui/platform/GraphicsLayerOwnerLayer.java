...
public final class GraphicsLayerOwnerLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    private final float[] matrixCache = Matrix.m4022constructorimpl$default(null, 1, null);
    ...
    private final void clipManually(Canvas canvas) {
        if (this.graphicsLayer.getClip()) {
            ...
            if (outline instanceof Outline.Rectangle) {
                Canvas.m3765clipRectmtrdDE$default(canvas, ((Outline.Rectangle) outline).getRect(), 0, 2, null);
                return;
            }
            if (!(outline instanceof Outline.Rounded)) {
                if (outline instanceof Outline.Generic) {
                    Canvas.m3763clipPathmtrdDE$default(canvas, ((Outline.Generic) outline).getPath(), 0, 2, null);
                    return;
                }
                return;
            }
    ...
    private final float[] m5477getInverseMatrix3i98HWw() {
        float[] fArrM5478getMatrixsQKQjiQ = m5478getMatrixsQKQjiQ();
        float[] fArrM4022constructorimpl$default = this.inverseMatrixCache;
        if (fArrM4022constructorimpl$default == null) {
            fArrM4022constructorimpl$default = Matrix.m4022constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArrM4022constructorimpl$default;
        }
        if (InvertMatrixKt.m5479invertToJiSxe2E(fArrM5478getMatrixsQKQjiQ, fArrM4022constructorimpl$default)) {
            return fArrM4022constructorimpl$default;
        }
        return null;
    }

    /* renamed from: getMatrix-sQKQjiQ, reason: not valid java name */
    private final float[] m5478getMatrixsQKQjiQ() {
        updateMatrix();
    ...
    private final void updateMatrix() {
        ...
        long jM3630getCenteruvyYCjk = OffsetKt.m3572isUnspecifiedk4lQ0M(graphicsLayer.getPivotOffset()) ? SizeKt.m3630getCenteruvyYCjk(IntSizeKt.m6415toSizeozmzZPI(this.size)) : graphicsLayer.getPivotOffset();
        Matrix.m4031resetimpl(this.matrixCache);
        float[] fArr = this.matrixCache;
        float[] fArrM4022constructorimpl$default = Matrix.m4022constructorimpl$default(null, 1, null);
        Matrix.m4042translateimpl$default(fArrM4022constructorimpl$default, -Offset.m3551getXimpl(jM3630getCenteruvyYCjk), -Offset.m3552getYimpl(jM3630getCenteruvyYCjk), 0.0f, 4, null);
        Matrix.m4039timesAssign58bKbWc(fArr, fArrM4022constructorimpl$default);
        float[] fArr2 = this.matrixCache;
        float[] fArrM4022constructorimpl$default2 = Matrix.m4022constructorimpl$default(null, 1, null);
        Matrix.m4042translateimpl$default(fArrM4022constructorimpl$default2, graphicsLayer.getTranslationX(), graphicsLayer.getTranslationY(), 0.0f, 4, null);
        Matrix.m4032rotateXimpl(fArrM4022constructorimpl$default2, graphicsLayer.getRotationX());
        Matrix.m4033rotateYimpl(fArrM4022constructorimpl$default2, graphicsLayer.getRotationY());
        Matrix.m4034rotateZimpl(fArrM4022constructorimpl$default2, graphicsLayer.getRotationZ());
        Matrix.m4036scaleimpl$default(fArrM4022constructorimpl$default2, graphicsLayer.getScaleX(), graphicsLayer.getScaleY(), 0.0f, 4, null);
        Matrix.m4039timesAssign58bKbWc(fArr2, fArrM4022constructorimpl$default2);
        float[] fArr3 = this.matrixCache;
        float[] fArrM4022constructorimpl$default3 = Matrix.m4022constructorimpl$default(null, 1, null);
        Matrix.m4042translateimpl$default(fArrM4022constructorimpl$default3, Offset.m3551getXimpl(jM3630getCenteruvyYCjk), Offset.m3552getYimpl(jM3630getCenteruvyYCjk), 0.0f, 4, null);
        Matrix.m4039timesAssign58bKbWc(fArr3, fArrM4022constructorimpl$default3);
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        float fM6361getXimpl = IntOffset.m6361getXimpl(this.graphicsLayer.getTopLeft());
        float fM6362getYimpl = IntOffset.m6362getYimpl(this.graphicsLayer.getTopLeft());
        float fM6403getWidthimpl = fM6361getXimpl + IntSize.m6403getWidthimpl(this.size);
        float fM6402getHeightimpl = fM6362getYimpl + IntSize.m6402getHeightimpl(this.size);
        if (this.graphicsLayer.getAlpha() < 1.0f) {
            ...
            nativeCanvas.saveLayer(fM6361getXimpl, fM6362getYimpl, fM6403getWidthimpl, fM6402getHeightimpl, Paint.getInternalPaint());
        } else {
            canvas.save();
        }
        canvas.translate(fM6361getXimpl, fM6362getYimpl);
        canvas.mo3647concat58bKbWc(m5478getMatrixsQKQjiQ());
        if (this.graphicsLayer.getClip()) {
            clipManually(canvas);
        }
    ...
    public void mo5402inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM5477getInverseMatrix3i98HWw = m5477getInverseMatrix3i98HWw();
        if (fArrM5477getInverseMatrix3i98HWw != null) {
            Matrix.m4039timesAssign58bKbWc(matrix, fArrM5477getInverseMatrix3i98HWw);
        }
    }
    ...
    public boolean mo5403isInLayerk4lQ0M(long position) {
        ...
        if (this.graphicsLayer.getClip()) {
            return ShapeContainingUtilKt.isInOutline$default(this.graphicsLayer.getOutline(), fM3551getXimpl, fM3552getYimpl, null, null, 24, null);
        }
        return true;
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        if (!inverse) {
            Matrix.m4030mapimpl(m5478getMatrixsQKQjiQ(), rect);
            return;
        }
        float[] fArrM5477getInverseMatrix3i98HWw = m5477getInverseMatrix3i98HWw();
        if (fArrM5477getInverseMatrix3i98HWw == null) {
            ...
            Matrix.m4030mapimpl(fArrM5477getInverseMatrix3i98HWw, rect);
        }
    }
    ...
    public long mo5404mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return Matrix.m4028mapMKHz9U(m5478getMatrixsQKQjiQ(), point);
        }
        float[] fArrM5477getInverseMatrix3i98HWw = m5477getInverseMatrix3i98HWw();
        return fArrM5477getInverseMatrix3i98HWw != null ? Matrix.m4028mapMKHz9U(fArrM5477getInverseMatrix3i98HWw, point) : Offset.INSTANCE.m3565getInfiniteF1C5BW0();
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* renamed from: move--gyyYBs */
    public void mo5405movegyyYBs(long position) {
        this.graphicsLayer.m4444setTopLeftgyyYBs(position);
        triggerRepaint();
    }
    ...
    public void mo5406resizeozmzZPI(long size) {
        if (IntSize.m6401equalsimpl0(size, this.size)) {
            return;
        }
        this.size = size;
        invalidate();
    ...
    public void reuseLayer(Function2<? super Canvas, ? super GraphicsLayer, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m4182getCenterSzJe1aQ();
    ...
    public void mo5407transform58bKbWc(float[] matrix) {
        Matrix.m4039timesAssign58bKbWc(matrix, m5478getMatrixsQKQjiQ());
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    public void updateDisplayList() {
        if (this.isDirty) {
            if (!TransformOrigin.m4176equalsimpl0(this.transformOrigin, TransformOrigin.INSTANCE.m4182getCenterSzJe1aQ()) && !IntSize.m6401equalsimpl0(this.graphicsLayer.getSize(), this.size)) {
                this.graphicsLayer.m4440setPivotOffsetk4lQ0M(OffsetKt.Offset(TransformOrigin.m4177getPivotFractionXimpl(this.transformOrigin) * IntSize.m6403getWidthimpl(this.size), TransformOrigin.m4178getPivotFractionYimpl(this.transformOrigin) * IntSize.m6402getHeightimpl(this.size)));
            }
            this.graphicsLayer.m4436recordmLhObY(this.density, this.layoutDirection, this.size, this.recordLambda);
            setDirty(false);
        }
    }
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        boolean z;
        int iM4423getModulateAlphake2Ky5w;
        Function0<Unit> function0;
        ...
        if ((mutatedFields & 64) != 0) {
            this.graphicsLayer.m4437setAmbientShadowColor8_81llA(scope.getAmbientShadowColor());
        }
        if ((mutatedFields & 128) != 0) {
            this.graphicsLayer.m4443setSpotShadowColor8_81llA(scope.getSpotShadowColor());
        }
        ...
        if (i2 != 0) {
            if (TransformOrigin.m4176equalsimpl0(this.transformOrigin, TransformOrigin.INSTANCE.m4182getCenterSzJe1aQ())) {
                this.graphicsLayer.m4440setPivotOffsetk4lQ0M(Offset.INSTANCE.m3566getUnspecifiedF1C5BW0());
            } else {
                this.graphicsLayer.m4440setPivotOffsetk4lQ0M(OffsetKt.Offset(TransformOrigin.m4177getPivotFractionXimpl(this.transformOrigin) * IntSize.m6403getWidthimpl(this.size), TransformOrigin.m4178getPivotFractionYimpl(this.transformOrigin) * IntSize.m6402getHeightimpl(this.size)));
            }
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            ...
            if (CompositingStrategy.m3876equalsimpl0(compositingStrategy, companion.m3880getAutoNrFUSI())) {
                iM4423getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m4422getAutoke2Ky5w();
            } else if (CompositingStrategy.m3876equalsimpl0(compositingStrategy, companion.m3882getOffscreenNrFUSI())) {
                iM4423getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m4424getOffscreenke2Ky5w();
            } else {
                if (!CompositingStrategy.m3876equalsimpl0(compositingStrategy, companion.m3881getModulateAlphaNrFUSI())) {
                    throw new IllegalStateException("Not supported composition strategy");
                }
                iM4423getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m4423getModulateAlphake2Ky5w();
            }
            graphicsLayer.m4439setCompositingStrategyWpw9cng(iM4423getModulateAlphake2Ky5w);
        }
