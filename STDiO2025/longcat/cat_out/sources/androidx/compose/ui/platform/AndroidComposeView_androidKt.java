...
public final class AndroidComposeView_androidKt {
    ...
    private static final float m5450dotp89u6pk(float[] fArr, int i2, float[] fArr2, int i3) {
        int i4 = i2 * 4;
    ...
    public static final void m5451preTransformJiSxe2E(float[] fArr, float[] fArr2) {
        float fM5450dotp89u6pk = m5450dotp89u6pk(fArr2, 0, fArr, 0);
        float fM5450dotp89u6pk2 = m5450dotp89u6pk(fArr2, 0, fArr, 1);
        float fM5450dotp89u6pk3 = m5450dotp89u6pk(fArr2, 0, fArr, 2);
        float fM5450dotp89u6pk4 = m5450dotp89u6pk(fArr2, 0, fArr, 3);
        float fM5450dotp89u6pk5 = m5450dotp89u6pk(fArr2, 1, fArr, 0);
        float fM5450dotp89u6pk6 = m5450dotp89u6pk(fArr2, 1, fArr, 1);
        float fM5450dotp89u6pk7 = m5450dotp89u6pk(fArr2, 1, fArr, 2);
        float fM5450dotp89u6pk8 = m5450dotp89u6pk(fArr2, 1, fArr, 3);
        float fM5450dotp89u6pk9 = m5450dotp89u6pk(fArr2, 2, fArr, 0);
        float fM5450dotp89u6pk10 = m5450dotp89u6pk(fArr2, 2, fArr, 1);
        float fM5450dotp89u6pk11 = m5450dotp89u6pk(fArr2, 2, fArr, 2);
        float fM5450dotp89u6pk12 = m5450dotp89u6pk(fArr2, 2, fArr, 3);
        float fM5450dotp89u6pk13 = m5450dotp89u6pk(fArr2, 3, fArr, 0);
        float fM5450dotp89u6pk14 = m5450dotp89u6pk(fArr2, 3, fArr, 1);
        float fM5450dotp89u6pk15 = m5450dotp89u6pk(fArr2, 3, fArr, 2);
        float fM5450dotp89u6pk16 = m5450dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[0] = fM5450dotp89u6pk;
        fArr[1] = fM5450dotp89u6pk2;
        fArr[2] = fM5450dotp89u6pk3;
        fArr[3] = fM5450dotp89u6pk4;
        fArr[4] = fM5450dotp89u6pk5;
        fArr[5] = fM5450dotp89u6pk6;
        fArr[6] = fM5450dotp89u6pk7;
        fArr[7] = fM5450dotp89u6pk8;
        fArr[8] = fM5450dotp89u6pk9;
        fArr[9] = fM5450dotp89u6pk10;
        fArr[10] = fM5450dotp89u6pk11;
        fArr[11] = fM5450dotp89u6pk12;
        fArr[12] = fM5450dotp89u6pk13;
        fArr[13] = fM5450dotp89u6pk14;
        fArr[14] = fM5450dotp89u6pk15;
        fArr[15] = fM5450dotp89u6pk16;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: preTranslate-cG2Xzmc, reason: not valid java name */
    public static final void m5452preTranslatecG2Xzmc(float[] fArr, float f2, float f3, float[] fArr2) {
        Matrix.m4031resetimpl(fArr2);
        Matrix.m4042translateimpl$default(fArr2, f2, f3, 0.0f, 4, null);
        m5451preTransformJiSxe2E(fArr, fArr2);
    }
