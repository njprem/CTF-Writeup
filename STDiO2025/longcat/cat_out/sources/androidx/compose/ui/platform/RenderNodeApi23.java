...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3880getAutoNrFUSI();
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3876equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3882getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super androidx.compose.ui.graphics.Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            androidx.compose.ui.graphics.Canvas.m3763clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
    ...
    public void mo5465setCompositingStrategyaDBOjCE(int i2) {
        CompositingStrategy.Companion companion = CompositingStrategy.INSTANCE;
        if (CompositingStrategy.m3876equalsimpl0(i2, companion.m3882getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3876equalsimpl0(i2, companion.m3881getModulateAlphaNrFUSI())) {
