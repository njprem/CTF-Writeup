...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo3647concat58bKbWc(this.matrixCache.m5482calculateMatrixGrdbGEg(this.renderNode));
    ...
    public void mo5402inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM5481calculateInverseMatrixbWbORWo = this.matrixCache.m5481calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public boolean mo5403isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM3551getXimpl && fM3551getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM3552getYimpl && fM3552getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        if (!inverse) {
            androidx.compose.ui.graphics.Matrix.m4030mapimpl(this.matrixCache.m5482calculateMatrixGrdbGEg(this.renderNode), rect);
            return;
        }
        float[] fArrM5481calculateInverseMatrixbWbORWo = this.matrixCache.m5481calculateInverseMatrixbWbORWo(this.renderNode);
        if (fArrM5481calculateInverseMatrixbWbORWo == null) {
    ...
    public long mo5404mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return androidx.compose.ui.graphics.Matrix.m4028mapMKHz9U(this.matrixCache.m5482calculateMatrixGrdbGEg(this.renderNode), point);
        }
        float[] fArrM5481calculateInverseMatrixbWbORWo = this.matrixCache.m5481calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public void mo5405movegyyYBs(long position) {
        ...
        if (left == iM6361getXimpl && top == iM6362getYimpl) {
            return;
        }
        if (left != iM6361getXimpl) {
            this.renderNode.offsetLeftAndRight(iM6361getXimpl - left);
        }
        if (top != iM6362getYimpl) {
            this.renderNode.offsetTopAndBottom(iM6362getYimpl - top);
        }
        triggerRepaint();
    ...
    public void mo5406resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m4177getPivotFractionXimpl(this.transformOrigin) * iM6403getWidthimpl);
        this.renderNode.setPivotY(TransformOrigin.m4178getPivotFractionYimpl(this.transformOrigin) * iM6402getHeightimpl);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM6403getWidthimpl, this.renderNode.getTop() + iM6402getHeightimpl)) {
    ...
    public void mo5407transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4039timesAssign58bKbWc(matrix, this.matrixCache.m5482calculateMatrixGrdbGEg(this.renderNode));
    }
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m3846toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m3846toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i2 != 0) {
            this.renderNode.setPivotX(TransformOrigin.m4177getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m4178getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo5465setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
