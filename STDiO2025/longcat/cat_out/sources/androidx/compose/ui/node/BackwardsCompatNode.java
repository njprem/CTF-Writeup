...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m5355constructorimpl(32) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m5355constructorimpl(4) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m5355constructorimpl(2) & getKindSet()) != 0) {
        ...
        if ((NodeKind.m5355constructorimpl(128) & getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode.onPlaced(DelegatableNodeKt.m5242requireCoordinator64DMado(backwardsCompatNode, NodeKind.m5355constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m5355constructorimpl(Fields.RotationX) & getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if ((NodeKind.m5355constructorimpl(16) & getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m5355constructorimpl(8) & getKindSet()) != 0) {
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        int iM5355constructorimpl = NodeKind.m5355constructorimpl(32);
    ...
    public long mo3439getSizeNHjbRc() {
        return IntSizeKt.m6415toSizeozmzZPI(DelegatableNodeKt.m5242requireCoordinator64DMado(this, NodeKind.m5355constructorimpl(128)).mo5128getSizeYbymL2g());
    }
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        Modifier.Element element = this.element;
        Intrinsics.checkNotNull(element, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
        return ((LayoutModifier) element).mo28measure3p2s80s(measureScope, measurable, j2);
    }
    ...
    public void mo170onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        Modifier.Element element = this.element;
        Intrinsics.checkNotNull(element, "null cannot be cast to non-null type androidx.compose.ui.input.pointer.PointerInputModifier");
        ((PointerInputModifier) element).getPointerInputFilter().mo5015onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo324onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m5174onRemeasuredozmzZPI(size);
        }
    }
