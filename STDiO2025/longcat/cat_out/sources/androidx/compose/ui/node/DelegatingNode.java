...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        int kindSet = getKindSet();
        if ((delegateKindSet & NodeKind.m5355constructorimpl(2)) == 0 || (NodeKind.m5355constructorimpl(2) & kindSet) == 0 || (this instanceof LayoutModifierNode)) {
            return;
        }
    ...
    public final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (getIsAttached()) {
            if ((iCalculateNodeKindSetFromIncludingDelegates & NodeKind.m5355constructorimpl(2)) == 0 || (kindSet & NodeKind.m5355constructorimpl(2)) != 0) {
    ...
    public final void undelegate(DelegatableNode instance) {
        ...
        for (Modifier.Node child = this.delegate; child != null; child = child.getChild()) {
            if (child == instance) {
                ...
                if (getIsAttached() && (kindSet & NodeKind.m5355constructorimpl(2)) != 0 && (NodeKind.m5355constructorimpl(2) & iCalculateNodeKindSetFromIncludingDelegates) == 0) {
                    NodeChain nodes = DelegatableNodeKt.requireLayoutNode(this).getNodes();
                    getNode().updateCoordinator$ui_release(null);
                    nodes.syncCoordinators();
                    return;
