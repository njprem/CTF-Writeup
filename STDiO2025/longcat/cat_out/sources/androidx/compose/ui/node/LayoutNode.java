...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List list, long j2) {
            return (MeasureResult) m5277measure3p2s80s(measureScope, (List<? extends Measurable>) list, j2);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m5277measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo5276getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m6341getZeroMYxV2XQ();
        }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i2) {
            return ((Number) m5278maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i2)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i2) {
            return ((Number) m5279maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i2)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i2) {
            return ((Number) m5280minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i2)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i2) {
            return ((Number) m5281minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i2)).intValue();
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m5278maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m5279maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m5280minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m5281minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i2) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m5316hasH91voCI$ui_release(NodeKind.m5355constructorimpl(512))) {
    ...
    private final NodeCoordinator getInnerLayerCoordinator() {
        ...
        throw androidx.compose.runtime.changelist.a.v("layer was not set");
    }
    ...
    public static /* synthetic */ void m5268hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j2, HitTestResult hitTestResult, boolean z, boolean z2, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            z = false;
        }
        boolean z3 = z;
        ...
        layoutNode.m5272hitTestM_7yMNQ$ui_release(j2, hitTestResult, z3, z2);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release$default, reason: not valid java name */
    public static /* synthetic */ void m5269hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j2, HitTestResult hitTestResult, boolean z, boolean z2, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            z = true;
        }
        if ((i2 & 8) != 0) {
        ...
        layoutNode.m5273hitTestSemanticsM_7yMNQ$ui_release(j2, hitTestResult, z, z2);
    }

    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m5355constructorimpl(1024) | NodeKind.m5355constructorimpl(Fields.CameraDistance) | NodeKind.m5355constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m5355constructorimpl(1024) & head.getKindSet()) != 0) | ((NodeKind.m5355constructorimpl(Fields.CameraDistance) & head.getKindSet()) != 0) | ((NodeKind.m5355constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    public static /* synthetic */ boolean m5270lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5289getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m5274lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ boolean m5271remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5288getLastConstraintsDWUhwKw();
        }
        return layoutNode.m5275remeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ void requestLookaheadRemeasure$ui_release$default(LayoutNode layoutNode, boolean z, boolean z2, boolean z3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            z = false;
        }
        if ((i2 & 2) != 0) {
    ...
    public static /* synthetic */ void requestRemeasure$ui_release$default(LayoutNode layoutNode, boolean z, boolean z2, boolean z3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            z = false;
        }
        if ((i2 & 2) != 0) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m5316hasH91voCI$ui_release(NodeKind.m5355constructorimpl(4)) && !this.nodes.m5316hasH91voCI$ui_release(NodeKind.m5355constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m5355constructorimpl(2) & head.getKindSet()) != 0 && DelegatableNodeKt.m5242requireCoordinator64DMado(head, NodeKind.m5355constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m5355constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m5316hasH91voCI$ui_release(NodeKind.m5355constructorimpl(8))) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        int iM5355constructorimpl = NodeKind.m5355constructorimpl(Fields.RotationX);
        if ((nodeChain.getAggregateChildKindSet() & iM5355constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM5355constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m5242requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m5355constructorimpl(Fields.RotationX)));
                ...
                if ((head.getAggregateChildKindSet() & iM5355constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM5288getLastConstraintsDWUhwKw = layoutNode.layoutDelegate.m5288getLastConstraintsDWUhwKw();
        if (constraintsM5288getLastConstraintsDWUhwKw != null) {
            Owner owner = layoutNode.owner;
            if (owner != null) {
                owner.mo5411measureAndLayout0kLqBqw(this, constraintsM5288getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        ...
        try {
            if (this.nodes.m5316hasH91voCI$ui_release(NodeKind.m5355constructorimpl(8)) && this._collapsedSemantics == null) {
                final Ref.ObjectRef objectRef = new Ref.ObjectRef();
                objectRef.element = new SemanticsConfiguration();
                LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1$1
                    ...
                    public final void invoke2() {
                        ...
                        int iM5355constructorimpl = NodeKind.m5355constructorimpl(8);
                        Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                        if ((nodes.getAggregateChildKindSet() & iM5355constructorimpl) != 0) {
                            for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                                if ((tail.getKindSet() & iM5355constructorimpl) != 0) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM5339getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m5339getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m6184getHasFixedWidthimpl(jM5339getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m6183getHasFixedHeightimpl(jM5339getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public final void m5272hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5342hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), NodeCoordinator.m5326fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m5273hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5342hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), NodeCoordinator.m5326fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitSemanticsEntities, true, isInLayer);
    }
                ...
                if ((head.getKindSet() & iM5355constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m5242requireCoordinator64DMado((LayoutModifierNode) delegatingNodePop, NodeKind.m5355constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNodePop.getKindSet() & iM5355constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
    ...
    public final boolean m5274lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m5293remeasureBRTryo0(constraints.getValue());
    }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM5364getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM5355constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    public final void place$ui_release(int x2, int y2) {
        ...
        Placeable.PlacementScope.placeRelative$default(placementScope, getMeasurePassDelegate$ui_release(), x2, y2, 0.0f, 4, null);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m5275remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m5297remeasureBRTryo0(constraints.getValue());
    }
    ...
    public final void removeAt$ui_release(int index, int count) {
        ...
        while (true) {
            onChildRemoved(this._foldedChildren.get(i2));
            this._foldedChildren.removeAt(i2);
            if (i2 == index) {
                return;
            } else {
                i2--;
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM5355constructorimpl = NodeKind.m5355constructorimpl(Fields.CompositingStrategy);
        if ((nodeChain.getAggregateChildKindSet() & iM5355constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM5355constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
    ...
    public void setDensity(Density density) {
        ...
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m5355constructorimpl(16) & head.getKindSet()) != 0) {
    ...
    public /* synthetic */ LayoutNode(boolean z, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? false : z, (i3 & 2) != 0 ? SemanticsModifierKt.generateSemanticsId() : i2);
    }
}
