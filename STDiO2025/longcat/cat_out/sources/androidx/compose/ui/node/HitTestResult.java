...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        public int indexOf(Modifier.Node element) {
            ...
            while (!Intrinsics.areEqual(HitTestResult.this.values[i2], element)) {
                if (i2 == i3) {
                    return -1;
                }
                i2++;
    ...
    private final long m5263findBestHitDistanceptXAw2c() {
        ...
        if (i2 <= lastIndex) {
            while (true) {
                long jM5255constructorimpl = DistanceAndInLayer.m5255constructorimpl(this.distanceFromEdgeAndInLayer[i2]);
                if (DistanceAndInLayer.m5254compareToS_HNhKs(jM5255constructorimpl, jDistanceAndInLayer) < 0) {
                    jDistanceAndInLayer = jM5255constructorimpl;
                }
                if ((DistanceAndInLayer.m5258getDistanceimpl(jDistanceAndInLayer) < 0.0f && DistanceAndInLayer.m5260isInLayerimpl(jDistanceAndInLayer)) || i2 == lastIndex) {
                    break;
                }
                i2++;
            }
    ...
    public final boolean hasHit() {
        long jM5263findBestHitDistanceptXAw2c = m5263findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m5258getDistanceimpl(jM5263findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m5260isInLayerimpl(jM5263findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndInLayer.m5254compareToS_HNhKs(m5263findBestHitDistanceptXAw2c(), HitTestResultKt.DistanceAndInLayer(distanceFromEdge, isInLayer)) > 0;
    }
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, distanceFromEdge, isInLayer, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(this) && DistanceAndInLayer.m5254compareToS_HNhKs(jM5263findBestHitDistanceptXAw2c, m5263findBestHitDistanceptXAw2c()) > 0) {
    ...
    public int indexOf(Modifier.Node element) {
        ...
        int i2 = 0;
        while (!Intrinsics.areEqual(this.values[i2], element)) {
            if (i2 == lastIndex) {
                return -1;
            }
            i2++;
