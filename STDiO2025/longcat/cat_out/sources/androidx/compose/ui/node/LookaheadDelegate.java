...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    private final void m5300placeSelfgyyYBs(long position) {
        if (!IntOffset.m6360equalsimpl0(getPosition(), position)) {
            m5306setPositiongyyYBs(position);
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5182setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m5182setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6408getZeroYbymL2g());
        }
    ...
    public final long m5301getConstraintsmsEJaDk$ui_release() {
    ...
    public final long m5302getSizeYbymL2g$ui_release() {
    ...
    public final Placeable m5303performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final void mo5121placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5300placeSelfgyyYBs(position);
    ...
    public final void m5304placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m5300placeSelfgyyYBs(IntOffset.m6365plusqkQi6aY(position, getApparentToRealOffset()));
    }

    /* renamed from: positionIn-iSbpLlY$ui_release, reason: not valid java name */
    public final long m5305positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long jM6371getZeronOccac = IntOffset.INSTANCE.m6371getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM6371getZeronOccac = IntOffset.m6365plusqkQi6aY(jM6371getZeronOccac, lookaheadDelegate.getPosition());
            }
    ...
    public void replace$ui_release() {
        mo5121placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* renamed from: setPosition--gyyYBs, reason: not valid java name */
    public void m5306setPositiongyyYBs(long j2) {
        this.position = j2;
    }
}
