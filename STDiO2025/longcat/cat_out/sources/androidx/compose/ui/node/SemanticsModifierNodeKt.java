...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        return !node.getNode().getIsAttached() ? Rect.INSTANCE.getZero() : !z ? LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5242requireCoordinator64DMado(node, NodeKind.m5355constructorimpl(8))) : DelegatableNodeKt.m5242requireCoordinator64DMado(node, NodeKind.m5355constructorimpl(8)).touchBoundsInRoot();
    }
}
