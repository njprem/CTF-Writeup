...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo5120measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m6371getZeronOccac();
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints constraintsM5289getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m5289getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(constraintsM5289getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m5293remeasureBRTryo0(constraintsM5289getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        private final void m5290placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            ...
            if (!IntOffset.m6360equalsimpl0(position, this.lastPosition)) {
            ...
            if (LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() || !getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m5184place70tqf50$default(placementScope, lookaheadDelegate2, j2, 0.0f, 2, null);
                    }
                }, 2, null);
            } else {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m5304placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
        ...
        public void forEachChildAlignmentLinesOwner(Function1<? super AlignmentLinesOwner, Unit> block) {
            ...
            if (size > 0) {
                ...
                int i2 = 0;
                do {
                    AlignmentLinesOwner lookaheadAlignmentLinesOwner$ui_release = content[i2].getLayoutDelegate().getLookaheadAlignmentLinesOwner$ui_release();
        ...
        */
        public androidx.compose.ui.layout.Placeable mo5120measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m5293remeasureBRTryo0(r4)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo5120measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        public void mo5121placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5290placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5293remeasureBRTryo0(long constraints) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m6179equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m6174boximpl(constraints);
            ...
            LayoutNodeLayoutDelegate.this.m5286performLookaheadMeasureBRTryo0(constraints);
            m5182setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m6403getWidthimpl(measuredSize) == lookaheadDelegate.getWidth() && IntSize.m6402getHeightimpl(measuredSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        public final void replace() {
            ...
            try {
                ...
                try {
                    lookaheadPassDelegate.m5290placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        public void mo5181placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5290placeSelfMLgxB_4(position, zIndex, null, layer);
        }
    }
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        public MeasurePassDelegate() {
            ...
            this.lastPosition = companion.m6371getZeronOccac();
            this.parentDataDirty = true;
            ...
            this.placeOuterCoordinatorPosition = companion.m6371getZeronOccac();
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        placementScope2.m5199placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (function1 == null) {
                        placementScope2.m5190place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        placementScope2.m5198placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                    }
                }
            };
        }
        ...
        private final void forEachChildDelegate(Function1<? super MeasurePassDelegate, Unit> block) {
            ...
            if (size > 0) {
                ...
                int i2 = 0;
                do {
                    block.invoke(content[i2].getMeasurePassDelegate$ui_release());
                    i2++;
                } while (i2 < size);
            }
        }
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i2];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m5271remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        private final void m5294placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            ...
            if (LayoutNodeLayoutDelegate.this.getLayoutPending() || !getIsPlaced()) {
                ...
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m5345placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
                onNodePlaced$ui_release();
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.Idle;
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m5295placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            if (!IntOffset.m6360equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m6361getXimpl(position), IntOffset.m6362getYimpl(position), 0.0f, 4, null);
            }
            ...
            m5294placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }
        ...
        public void forEachChildAlignmentLinesOwner(Function1<? super AlignmentLinesOwner, Unit> block) {
            ...
            if (size > 0) {
                ...
                int i2 = 0;
                do {
                    block.invoke(content[i2].getLayoutDelegate().getAlignmentLinesOwner$ui_release());
                    i2++;
                } while (i2 < size);
            }
        }
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (mutableVector.getSize() <= i2) {
                        ...
                        mutableVector.set(i2, layoutNode2.getLayoutDelegate().getMeasurePassDelegate());
                    }
                    i2++;
                } while (i2 < size);
            }
        ...
        public final Constraints m5296getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m6174boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo5120measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo5120measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m5297remeasureBRTryo0(constraints);
            return this;
        }
        ...
        public final void measureBasedOnLookahead() {
            ...
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            if (parent$ui_release == null) {
                throw androidx.compose.runtime.changelist.a.v("layoutNode parent is not set");
            }
            if (lookaheadPassDelegate == null) {
                throw androidx.compose.runtime.changelist.a.v("invalid lookaheadDelegate");
            }
            if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                ...
                mo5120measureBRTryo0(lookaheadConstraints.getValue());
                ...
                mo5120measureBRTryo0(lookaheadConstraints2.getValue());
            }
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5121placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5295placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            m5295placeSelfMLgxB_4(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release(), lookaheadPassDelegate.getLastExplicitLayer());
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5297remeasureBRTryo0(long constraints) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("measure is called on a deactivated node");
            }
            Owner ownerRequireOwner = LayoutNodeKt.requireOwner(LayoutNodeLayoutDelegate.this.layoutNode);
            ...
            boolean z = true;
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure() || (parent$ui_release != null && parent$ui_release.getCanMultiMeasure()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m6179equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            this.measuredOnce = true;
            long jMo5128getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5128getSizeYbymL2g();
            m5183setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m5287performMeasureBRTryo0(constraints);
            if (IntSize.m6401equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5128getSizeYbymL2g(), jMo5128getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m5182setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public final void replace() {
            ...
            try {
                ...
                try {
                    measurePassDelegate.m5294placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5181placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5295placeSelfMLgxB_4(position, zIndex, null, layer);
        }
    }
    ...
    public final void m5286performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo5120measureBRTryo0(constraints);
            }
        }, 2, null);
    ...
    public final void m5287performMeasureBRTryo0(long constraints) {
    ...
    /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m5288getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m5296getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m5289getLastLookaheadConstraintsDWUhwKw() {
