...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public final void m5282draweZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode, GraphicsLayer layer) {
        ...
        while (delegatingNodePop != 0) {
            if (delegatingNodePop instanceof DrawModifierNode) {
                m5283drawDirecteZhPAX0$ui_release(canvas, size, coordinator, delegatingNodePop, layer);
    ...
    public void mo4239drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4239drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4240drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4240drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4241drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4241drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4242drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4242drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void drawContent() {
        ...
        if (delegatingNodeNextDrawNode == 0) {
            NodeCoordinator nodeCoordinatorM5242requireCoordinator64DMado = DelegatableNodeKt.m5242requireCoordinator64DMado(drawModifierNode, NodeKind.m5355constructorimpl(4));
            if (nodeCoordinatorM5242requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                nodeCoordinatorM5242requireCoordinator64DMado = nodeCoordinatorM5242requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(nodeCoordinatorM5242requireCoordinator64DMado);
            }
            nodeCoordinatorM5242requireCoordinator64DMado.performDraw(canvas, getDrawContext().getGraphicsLayer());
            return;
        }
        int iM5355constructorimpl = NodeKind.m5355constructorimpl(4);
        MutableVector mutableVector = null;
        while (delegatingNodeNextDrawNode != 0) {
            ...
            } else if ((delegatingNodeNextDrawNode.getKindSet() & iM5355constructorimpl) != 0 && (delegatingNodeNextDrawNode instanceof DelegatingNode)) {
    ...
    public final void m5283drawDirecteZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode, GraphicsLayer layer) {
        DrawModifierNode drawModifierNode = this.drawNode;
        ...
        drawContext.mo4264setSizeuvyYCjk(size);
    ...
    public /* synthetic */ void mo4243drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4243drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4244drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo4244drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo4245drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4245drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4246drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4246drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4247drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4247drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4248drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4248drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4249drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4249drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4250drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4250drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4251drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4251drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4252drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4252drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4253drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4253drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4254drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4254drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4255drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4255drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4256drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4256drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4257drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4257drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }
    ...
    public long mo4341getCenterF1C5BW0() {
        return this.canvasDrawScope.mo4341getCenterF1C5BW0();
    }
    ...
    public long mo4342getSizeNHjbRc() {
        return this.canvasDrawScope.mo4342getSizeNHjbRc();
    }

    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator nodeCoordinatorM5242requireCoordinator64DMado = DelegatableNodeKt.m5242requireCoordinator64DMado(drawModifierNode, NodeKind.m5355constructorimpl(4));
        nodeCoordinatorM5242requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m5283drawDirecteZhPAX0$ui_release(canvas, IntSizeKt.m6415toSizeozmzZPI(nodeCoordinatorM5242requireCoordinator64DMado.mo5128getSizeYbymL2g()), nodeCoordinatorM5242requireCoordinator64DMado, drawModifierNode, graphicsLayer);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: record-JVtK1S4 */
    public void mo4343recordJVtK1S4(GraphicsLayer graphicsLayer, long j2, Function1<? super DrawScope, Unit> function1) {
        this.canvasDrawScope.mo4343recordJVtK1S4(graphicsLayer, j2, function1);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo327roundToPxR2X_6o(long j2) {
        return this.canvasDrawScope.mo327roundToPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo328roundToPx0680j_4(float f2) {
        return this.canvasDrawScope.mo328roundToPx0680j_4(f2);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo329toDpGaN1DYA(long j2) {
        return this.canvasDrawScope.mo329toDpGaN1DYA(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo330toDpu2uoSUM(float f2) {
        return this.canvasDrawScope.mo330toDpu2uoSUM(f2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo332toDpSizekrfVVM(long j2) {
        return this.canvasDrawScope.mo332toDpSizekrfVVM(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo333toPxR2X_6o(long j2) {
        return this.canvasDrawScope.mo333toPxR2X_6o(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo334toPx0680j_4(float f2) {
        return this.canvasDrawScope.mo334toPx0680j_4(f2);
    }
    ...
    public long mo335toSizeXkaWNTQ(long j2) {
        return this.canvasDrawScope.mo335toSizeXkaWNTQ(j2);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo336toSp0xMU5do(float f2) {
        return this.canvasDrawScope.mo336toSp0xMU5do(f2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo337toSpkPz2Gy4(float f2) {
        return this.canvasDrawScope.mo337toSpkPz2Gy4(f2);
    }
    ...
    public float mo331toDpu2uoSUM(int i2) {
        return this.canvasDrawScope.mo331toDpu2uoSUM(i2);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo338toSpkPz2Gy4(int i2) {
        return this.canvasDrawScope.mo338toSpkPz2Gy4(i2);
    }
