...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int iM5355constructorimpl2 = NodeKind.m5355constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM5355constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & iM5355constructorimpl2) == 0) {
