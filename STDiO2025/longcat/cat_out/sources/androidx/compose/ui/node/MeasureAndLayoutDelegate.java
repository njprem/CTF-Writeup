...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m5307doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        boolean zM5274lookaheadRemeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m5274lookaheadRemeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m5270lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM5274lookaheadRemeasure_Sx5XlM$ui_release && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot() == null) {
                ...
                return zM5274lookaheadRemeasure_Sx5XlM$ui_release;
            }
    ...
    private final boolean m5308doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM5275remeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m5275remeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m5271remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM5275remeasure_Sx5XlM$ui_release && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return zM5275remeasure_Sx5XlM$ui_release;
            }
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        boolean zM5307doLookaheadRemeasuresdFAvZA;
        ...
        if (affectsLookahead) {
            zM5307doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m5307doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            if (relayoutNeeded && ((zM5307doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE))) {
                layoutNode.lookaheadReplace$ui_release();
            }
        } else {
            boolean zM5308doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m5308doRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            zM5307doLookaheadRemeasuresdFAvZA = zM5308doRemeasuresdFAvZA;
        }
        drainPostponedMeasureRequests();
        return zM5307doLookaheadRemeasuresdFAvZA;
    }

    public static /* synthetic */ boolean remeasureAndRelayoutIfNeeded$default(MeasureAndLayoutDelegate measureAndLayoutDelegate, LayoutNode layoutNode, boolean z, boolean z2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        if ((i2 & 4) != 0) {
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5307doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5308doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    public final void m5309measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if (m5307doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6174boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) {
                    if (Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE)) {
                        layoutNode.lookaheadReplace$ui_release();
                    }
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m5308doRemeasuresdFAvZA(layoutNode, Constraints.m6174boximpl(constraints));
    ...
    public final void m5310updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m6174boximpl(constraints);
        if (this.root.getLookaheadRoot() != null) {
