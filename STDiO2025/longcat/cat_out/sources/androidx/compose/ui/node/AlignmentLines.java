...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo5227calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        int iRound = Math.round(alignmentLine instanceof HorizontalAlignmentLine ? Offset.m3552getYimpl(jOffset) : Offset.m3551getXimpl(jOffset));
        Map<AlignmentLine, Integer> map = this.alignmentLineMap;
        if (map.containsKey(alignmentLine)) {
            iRound = AlignmentLineKt.merge(alignmentLine, ((Number) MapsKt__MapsKt.getValue(this.alignmentLineMap, alignmentLine)).intValue(), iRound);
        }
        map.put(alignmentLine, Integer.valueOf(iRound));
    }

    /* renamed from: calculatePositionInParent-R5De75A, reason: not valid java name */
    public abstract long mo5227calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j2);
