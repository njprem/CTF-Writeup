...
public abstract class Operation {
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0)));
        }

        /* renamed from: getDistance-jn0FJLE, reason: not valid java name */
        public final int m3299getDistancejn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "distance" : super.mo3297intParamNamew8GmfQM(parameter);
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
            Object objMo3362getObject31yXWZQ = operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            if (objMo3362getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo3362getObject31yXWZQ).getWrapped());
            }
            slotWriter.appendSlot(anchor, objMo3362getObject31yXWZQ);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3300getAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3301getValueHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "anchor" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "value" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
            if (element > 0) {
        ...
        public final int m3302getChangesHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m3303getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "changes" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "effectiveNodeIndex" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            int size = list.size();
        ...
        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m3304getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m3305getNodesHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "nodes" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            MovableContentState movableContentStateMovableContentStateResolve$runtime_release = (MovableContentState) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
        ...
        public final int m3306getFromHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(2);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3307getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        /* renamed from: getResolvedState-HpuvwBQ, reason: not valid java name */
        public final int m3308getResolvedStateHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m3309getToHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "resolvedState" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(2)) ? "from" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(3)) ? "to" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            intRef.setElement(OperationKt.positionToInsert(slotWriter, anchor, applier));
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3310getAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        /* renamed from: getEffectiveNodeIndexOut-HpuvwBQ, reason: not valid java name */
        public final int m3311getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "anchor" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0))) {
                applier.down(obj);
            }
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m3312getNodesHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "nodes" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0))).invoke((Composition) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1)));
        }

        /* renamed from: getAction-HpuvwBQ, reason: not valid java name */
        public final int m3313getActionHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3314getCompositionHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "anchor" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "composition" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)));
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3315getAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "anchor" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objInvoke = ((Function0) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            int iMo3361getIntw8GmfQM = operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode(anchor, objInvoke);
            applier.insertTopDown(iMo3361getIntw8GmfQM, objInvoke);
            applier.down(objInvoke);
        }

        /* renamed from: getFactory-HpuvwBQ, reason: not valid java name */
        public final int m3316getFactoryHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3317getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3318getInsertIndexjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "insertIndex" : super.mo3297intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "factory" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "groupAnchor" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3319getAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3320getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "anchor" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "from" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(2));
        ...
        public final int m3322getFixupsHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(2);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3323getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "anchor" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "from" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(2)) ? "fixups" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class IntParameter {
        ...
        public static final /* synthetic */ IntParameter m3324boximpl(int i2) {
            return new IntParameter(i2);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m3325constructorimpl(int i2) {
            return i2;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3326equalsimpl(int i2, Object obj) {
            return (obj instanceof IntParameter) && i2 == ((IntParameter) obj).m3330unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3327equalsimpl0(int i2, int i3) {
            return i2 == i3;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3328hashCodeimpl(int i2) {
            return Integer.hashCode(i2);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3329toStringimpl(int i2) {
            return d.m("IntParameter(offset=", i2, ')');
        }

        public boolean equals(Object obj) {
            return m3326equalsimpl(this.offset, obj);
        }
        ...
        public int hashCode() {
            return m3328hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3329toStringimpl(this.offset);
        }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0)));
        }

        /* renamed from: getOffset-jn0FJLE, reason: not valid java name */
        public final int m3331getOffsetjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "offset" : super.mo3297intParamNamew8GmfQM(parameter);
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0)), operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(1)), operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(2)));
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3332getCountjn0FJLE() {
            return IntParameter.m3325constructorimpl(2);
        }

        /* renamed from: getFrom-jn0FJLE, reason: not valid java name */
        public final int m3333getFromjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m3334getTojn0FJLE() {
            return IntParameter.m3325constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "from" : IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(1)) ? "to" : IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(2)) ? "count" : super.mo3297intParamNamew8GmfQM(parameter);
        }
    }
    ...
    public static final class ObjectParameter<T> {
        ...
        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m3335boximpl(int i2) {
            return new ObjectParameter(i2);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m3336constructorimpl(int i2) {
            return i2;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3337equalsimpl(int i2, Object obj) {
            return (obj instanceof ObjectParameter) && i2 == ((ObjectParameter) obj).m3341unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3338equalsimpl0(int i2, int i3) {
            return i2 == i3;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3339hashCodeimpl(int i2) {
            return Integer.hashCode(i2);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3340toStringimpl(int i2) {
            return d.m("ObjectParameter(offset=", i2, ')');
        }

        public boolean equals(Object obj) {
            return m3337equalsimpl(this.offset, obj);
        }
        ...
        public int hashCode() {
            return m3339hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3340toStringimpl(this.offset);
        }
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(iMo3361getIntw8GmfQM, slotWriter.node(anchor));
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3342getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3343getInsertIndexjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "groupAnchor" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)), (CompositionContext) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1)), (MovableContentStateReference) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(2)), slotWriter);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3344getCompositionHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3345getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m3346getReferenceHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "composition" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(2)) ? "reference" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)));
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3347getValueHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "value" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0)), operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(1)));
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3348getCountjn0FJLE() {
            return IntParameter.m3325constructorimpl(1);
        }

        /* renamed from: getRemoveIndex-jn0FJLE, reason: not valid java name */
        public final int m3349getRemoveIndexjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "removeIndex" : IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(1)) ? "count" : super.mo3297intParamNamew8GmfQM(parameter);
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)));
        }

        /* renamed from: getEffect-HpuvwBQ, reason: not valid java name */
        public final int m3350getEffectHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "effect" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class TestOperation extends Operation {
        ...
        public /* synthetic */ TestOperation(int i2, int i3, Function3 function3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
            this((i4 & 1) != 0 ? 0 : i2, (i4 & 2) != 0 ? 0 : i3, (i4 & 4) != 0 ? new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.changelist.Operation.TestOperation.1
        ...
        public TestOperation(int i2, int i3, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList.add(IntParameter.m3324boximpl(IntParameter.m3325constructorimpl(i4)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i3);
            for (int i5 = 0; i5 < i3; i5++) {
                arrayList2.add(ObjectParameter.m3335boximpl(ObjectParameter.m3336constructorimpl(i5)));
            }
    ...
    public static final class TrimParentValues extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            for (int iMax = Math.max(iSlotsStartIndex$runtime_release, iSlotsEndIndex$runtime_release - iMo3361getIntw8GmfQM); iMax < iSlotsEndIndex$runtime_release; iMax++) {
            ...
            slotWriter.trimTailSlots(iMo3361getIntw8GmfQM);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3351getCountjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "count" : super.mo3297intParamNamew8GmfQM(parameter);
        }
    }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int iAnchorIndex;
            int slotsSize;
            Object objMo3362getObject31yXWZQ = operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1));
            int iMo3361getIntw8GmfQM = operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0));
            if (objMo3362getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo3362getObject31yXWZQ).getWrapped());
            ...
            Object obj = slotWriter.set(iAnchorIndex2, iMo3361getIntw8GmfQM, objMo3362getObject31yXWZQ);
            if (!(obj instanceof RememberObserverHolder)) {
            ...
            int slotsSize2 = slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(iAnchorIndex2, iMo3361getIntw8GmfQM);
        ...
        public final int m3353getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3354getValueHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3297intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3327equalsimpl0(parameter, IntParameter.m3325constructorimpl(0)) ? "groupSlotIndex" : super.mo3297intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "value" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "anchor" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)));
        }

        /* renamed from: getData-HpuvwBQ, reason: not valid java name */
        public final int m3355getDataHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "data" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.mo3362getObject31yXWZQ(ObjectParameter.m3336constructorimpl(0)));
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m3356getBlockHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(1);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3357getValueHpuvwBQ() {
            return ObjectParameter.m3336constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3298objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(0)) ? "value" : ObjectParameter.m3338equalsimpl0(parameter, ObjectParameter.m3336constructorimpl(1)) ? "block" : super.mo3298objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            Object obj = slotWriter.set(iMo3361getIntw8GmfQM, objMo3362getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting(((RememberObserverHolder) obj).getWrapped(), slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(slotWriter.getCurrentGroup(), iMo3361getIntw8GmfQM), -1, -1);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
            }
        }
        ...
        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3358getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
    ...
    public static final class Ups extends Operation {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int iMo3361getIntw8GmfQM = operationArgContainer.mo3361getIntw8GmfQM(IntParameter.m3325constructorimpl(0));
            for (int i2 = 0; i2 < iMo3361getIntw8GmfQM; i2++) {
                applier.up();
            }
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3360getCountjn0FJLE() {
            return IntParameter.m3325constructorimpl(0);
        }
    ...
    public String mo3297intParamNamew8GmfQM(int parameter) {
        return d.m("IntParameter(", parameter, ')');
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo3298objectParamName31yXWZQ(int parameter) {
        return d.m("ObjectParameter(", parameter, ')');
    }
