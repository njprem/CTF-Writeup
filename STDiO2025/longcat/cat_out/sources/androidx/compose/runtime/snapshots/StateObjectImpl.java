...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final boolean m3395isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m3383constructorimpl(this.readerKind.get())) != 0;
    }

    /* renamed from: recordReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final void m3396recordReadInh_f27i8$runtime_release(int reader) {
        int iM3383constructorimpl;
        do {
            iM3383constructorimpl = ReaderKind.m3383constructorimpl(this.readerKind.get());
            if ((iM3383constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM3383constructorimpl, ReaderKind.m3383constructorimpl(iM3383constructorimpl | reader)));
    }
}
