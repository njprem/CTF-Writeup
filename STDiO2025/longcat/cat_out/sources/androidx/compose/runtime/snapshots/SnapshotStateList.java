...
public final class SnapshotStateList<T> implements StateObject, List<T>, RandomAccess, KMutableList {
    ...
    public static /* synthetic */ boolean conditionalUpdate$default(SnapshotStateList snapshotStateList, boolean z, Function1 function1, int i2, Object obj) {
        int modification;
        PersistentList<T> list$runtime_release;
        boolean z2;
        Snapshot current;
    ...
    public static /* synthetic */ void update$default(SnapshotStateList snapshotStateList, boolean z, Function1 function1, int i2, Object obj) {
        int modification;
        PersistentList<T> list$runtime_release;
        Snapshot current;
        boolean z2;
