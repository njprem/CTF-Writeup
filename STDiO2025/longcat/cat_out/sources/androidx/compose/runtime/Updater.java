...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3284boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3285constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3286equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3287equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3288hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: init-impl, reason: not valid java name */
    public static final void m3289initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3290reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3291setimpl(Composer composer, int i2, Function2<? super T, ? super Integer, Unit> function2) {
        if (composer.getInserting() || !Intrinsics.areEqual(composer.rememberedValue(), Integer.valueOf(i2))) {
            d.v(i2, composer, i2, function2);
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3293toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    /* renamed from: update-impl, reason: not valid java name */
    public static final void m3294updateimpl(Composer composer, int i2, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    public boolean equals(Object obj) {
        return m3286equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3288hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3293toStringimpl(this.composer);
    }
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3295updateimpl(Composer composer, V v2, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3292setimpl(Composer composer, V v2, Function2<? super T, ? super V, Unit> function2) {
