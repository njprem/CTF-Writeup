    ...
    public Function1<Long, Unit> component2() {
        return new Function1<Long, Unit>() { // from class: androidx.compose.runtime.SnapshotMutableLongStateImpl.component2.1
            ...
            public final void invoke(long j2) {
                SnapshotMutableLongStateImpl.this.setLongValue(j2);
            }
        };
    }
    ...
    public void setLongValue(long j2) {
        ...
        if (longStateStateRecord.getValue() != j2) {
            ...
            synchronized (SnapshotKt.getLock()) {
                ...
                ((LongStateStateRecord) SnapshotKt.overwritableRecord(longStateStateRecord2, this, current, longStateStateRecord)).setValue(j2);
