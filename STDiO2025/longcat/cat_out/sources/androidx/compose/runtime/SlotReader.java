...
public final class SlotReader {
    ...
    public final List<KeyInfo> extractKeys() {
        ...
        if (this.emptyCount <= 0) {
            ...
            while (true) {
                ...
                i2 = i3 + 1;
                arrayList.add(new KeyInfo(SlotTableKt.key(this.groups, iGroupSize), objectKey(this.groups, iGroupSize), iGroupSize, SlotTableKt.isNode(this.groups, iGroupSize) ? 1 : SlotTableKt.nodeCount(this.groups, iGroupSize), i3));
    ...
    public final void startGroup() {
        ...
        if (this.emptyCount <= 0) {
            ...
            this.currentSlotEnd = i3 >= this.groupsSize - 1 ? this.slotsSize : SlotTableKt.dataAnchor(this.groups, i6);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(", end=");
        return androidx.compose.runtime.changelist.a.o(sb, this.currentEnd, ')');
    }
