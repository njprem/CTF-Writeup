...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(Object[] objArr, Object[] objArr2, int i2, int i3) {
        ...
        CommonFunctionsKt.m3377assert(size() - UtilsKt.rootSize(size()) <= RangesKt.coerceAtMost(objArr2.length, 32));
    }
    ...
    private final Object[] insertIntoRoot(Object[] root, int shift, int index, Object element, ObjectRef elementCarry) {
        ...
        while (true) {
            ...
            objArrCopyOf2[iIndexSegment] = insertIntoRoot((Object[]) obj2, i2, 0, elementCarry.getValue(), elementCarry);
        }
