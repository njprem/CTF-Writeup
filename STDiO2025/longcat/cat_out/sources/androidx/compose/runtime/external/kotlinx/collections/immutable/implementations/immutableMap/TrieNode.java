...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m3377assert(this.nodeMap == 0);
        CommonFunctionsKt.m3377assert(this.dataMap == 0);
        CommonFunctionsKt.m3377assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m3377assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        TrieNode<K, V> trieNode = (Intrinsics.areEqual(this.ownedBy, mutator.getOwnership()) && this.dataMap == i6 && this.nodeMap == i3) ? this : new TrieNode<>(i6, i3, new Object[Integer.bitCount(i3) + (Integer.bitCount(i6) * 2)]);
        int i9 = i3;
        int i10 = 0;
        while (i9 != 0) {
            int iLowestOneBit2 = Integer.lowestOneBit(i9);
            Object[] objArr = trieNode.buffer;
            objArr[(objArr.length - 1) - i10] = mutablePutAllFromOtherNodeCell(otherNode, iLowestOneBit2, i2, intersectionCounter, mutator);
            i10++;
            i9 ^= iLowestOneBit2;
            i2 = shift;
        }
