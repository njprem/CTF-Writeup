...
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public PersistentSet<E> remove(E element) {
        ...
        if (links.getHasPrevious()) {
            ...
            persistentHashMapRemove = persistentHashMapRemove.put((PersistentHashMap) links.getPrevious(), (Object) ((Links) v2).withNext(links.getNext()));
        }
        if (links.getHasNext()) {
            V v3 = persistentHashMapRemove.get(links.getNext());
            Intrinsics.checkNotNull(v3);
            persistentHashMapRemove = persistentHashMapRemove.put((PersistentHashMap) links.getNext(), (Object) ((Links) v3).withPrevious(links.getPrevious()));
        }
