...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM6498constructorimpl = Result.m6498constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
        ...
        synchronized (this.lock) {
            try {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuation.resumeWith(Result.m6498constructorimpl(ResultKt.createFailure(cause)));
                }
                this.awaiters.clear();
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m6498constructorimpl(ResultKt.createFailure(th)));
            } else {
