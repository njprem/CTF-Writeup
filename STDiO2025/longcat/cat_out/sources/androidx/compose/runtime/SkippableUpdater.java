...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3276boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3277constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3278equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3279equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3280hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3281toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    /* renamed from: update-impl, reason: not valid java name */
    public static final void m3282updateimpl(Composer composer, Function1<? super Updater<T>, Unit> function1) {
    ...
    public boolean equals(Object obj) {
        return m3278equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3280hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3281toStringimpl(this.composer);
    }
