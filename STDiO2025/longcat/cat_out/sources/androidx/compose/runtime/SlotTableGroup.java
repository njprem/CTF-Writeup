...
final class SlotTableGroup implements CompositionGroup, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public Iterator<CompositionGroup> iterator() {
        ...
        if (groupSourceInformationSourceInformationOf != null) {
            ...
            int i2 = this.group;
            return new SourceInformationGroupIterator(slotTable, i2, groupSourceInformationSourceInformationOf, new AnchoredGroupPath(i2));
        }
        SlotTable slotTable2 = this.table;
        int i3 = this.group;
        return new GroupIterator(slotTable2, i3 + 1, SlotTableKt.groupSize(slotTable2.getGroups(), this.group) + i3);
    }
