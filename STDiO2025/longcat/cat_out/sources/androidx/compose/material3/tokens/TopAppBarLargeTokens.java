...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2805getLevel0D9Ej5fM();
    private static final float ContainerHeight = Dp.m6233constructorimpl((float) 152.0d);
    ...
    public final float m3184getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3185getContainerHeightD9Ej5fM() {
    ...
    public final float m3186getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3187getTrailingIconSizeD9Ej5fM() {
