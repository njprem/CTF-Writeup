...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m6233constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m6233constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;

    static {
        ElevationTokens elevationTokens = ElevationTokens.INSTANCE;
        DockedModalContainerElevation = elevationTokens.m2806getLevel1D9Ej5fM();
        DockedStandardContainerElevation = elevationTokens.m2806getLevel1D9Ej5fM();
    ...
    public final float m3114getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3115getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m3116getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m3117getDockedStandardContainerElevationD9Ej5fM() {
