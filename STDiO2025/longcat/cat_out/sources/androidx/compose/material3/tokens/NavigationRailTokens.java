...
public final class NavigationRailTokens {
    ...
    static {
        ...
        ActiveIndicatorHeight = Dp.m6233constructorimpl((float) 32.0d);
        ShapeKeyTokens shapeKeyTokens = ShapeKeyTokens.CornerFull;
        ActiveIndicatorShape = shapeKeyTokens;
        float f2 = (float) 56.0d;
        ActiveIndicatorWidth = Dp.m6233constructorimpl(f2);
        ...
        ContainerElevation = ElevationTokens.INSTANCE.m2805getLevel0D9Ej5fM();
        ContainerShape = ShapeKeyTokens.CornerNone;
        ContainerWidth = Dp.m6233constructorimpl((float) 80.0d);
        float f3 = (float) 24.0d;
        IconSize = Dp.m6233constructorimpl(f3);
        ...
        MenuIconSize = Dp.m6233constructorimpl(f3);
        MenuPressedIconColor = colorSchemeKeyTokens2;
        NoLabelActiveIndicatorHeight = Dp.m6233constructorimpl(f2);
    ...
    public final float m2961getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2962getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2964getContainerWidthD9Ej5fM() {
    ...
    public final float m2966getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m2967getNoLabelActiveIndicatorHeightD9Ej5fM() {
