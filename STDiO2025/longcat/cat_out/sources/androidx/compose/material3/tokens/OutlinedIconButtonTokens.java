...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6233constructorimpl((float) 40.0d);
    ...
    static {
        ...
        Size = Dp.m6233constructorimpl((float) 24.0d);
    ...
    public final float m2986getContainerSizeD9Ej5fM() {
    ...
    public final float m2987getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2988getUnselectedOutlineWidthD9Ej5fM() {
