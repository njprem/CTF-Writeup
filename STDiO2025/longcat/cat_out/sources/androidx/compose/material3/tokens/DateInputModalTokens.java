...
public final class DateInputModalTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2808getLevel3D9Ej5fM();
    private static final float ContainerHeight = Dp.m6233constructorimpl((float) 512.0d);
    ...
    private static final float HeaderContainerHeight = Dp.m6233constructorimpl((float) 120.0d);

    static {
        float f2 = (float) 328.0d;
        ContainerWidth = Dp.m6233constructorimpl(f2);
        HeaderContainerWidth = Dp.m6233constructorimpl(f2);
    ...
    public final float m2766getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2767getContainerHeightD9Ej5fM() {
