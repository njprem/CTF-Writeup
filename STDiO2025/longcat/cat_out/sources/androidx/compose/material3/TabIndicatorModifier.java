...
public final /* data */ class TabIndicatorModifier extends ModifierNodeElement<TabIndicatorOffsetNode> {
    ...
    public TabIndicatorModifier(State<? extends List<TabPosition>> state, int i2, boolean z) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ TabIndicatorModifier copy$default(TabIndicatorModifier tabIndicatorModifier, State state, int i2, boolean z, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return tabIndicatorModifier.copy(state, i2, z);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Boolean.hashCode(this.followContentSize) + d.c(this.selectedTabIndex, this.tabPositionsState.hashCode() * 31, 31);
    }
