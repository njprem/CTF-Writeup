...
public final class SliderState implements DraggableState {
    ...
    public void dispatchRawDelta(float delta) {
        float f2 = 2;
        float fMax = Math.max(getTotalWidth() - (getThumbWidth$material3_release() / f2), 0.0f);
        float fMin = Math.min(getThumbWidth$material3_release() / f2, fMax);
    ...
    public final void m2158onPressk4lQ0M$material3_release(long pos) {
        setPressOffset((this.isRtl ? getTotalWidth() - Offset.m3551getXimpl(pos) : Offset.m3551getXimpl(pos)) - getRawOffset());
    }
    ...
    public final void setThumbWidth$material3_release(float f2) {
        this.thumbWidth.setFloatValue(f2);
    }
    ...
    public /* synthetic */ SliderState(float f2, int i2, Function0 function0, ClosedFloatingPointRange closedFloatingPointRange, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f2, (i3 & 2) != 0 ? 0 : i2, (i3 & 4) != 0 ? null : function0, (i3 & 8) != 0 ? RangesKt.rangeTo(0.0f, 1.0f) : closedFloatingPointRange);
    }
}
