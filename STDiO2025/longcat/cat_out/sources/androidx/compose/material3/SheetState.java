...
public final class SheetState {
    ...
    public SheetState(boolean z, final Density density, SheetValue sheetValue, Function1<? super SheetValue, Boolean> function1, boolean z2) {
        ...
        this.anchoredDraggableState = new AnchoredDraggableState<>(sheetValue, new Function1<Float, Float>() { // from class: androidx.compose.material3.SheetState$anchoredDraggableState$1
            ...
            public final Float invoke() {
                return Float.valueOf(density.mo334toPx0680j_4(Dp.m6233constructorimpl(125)));
            }
    ...
    public /* synthetic */ SheetState(boolean z, Density density, SheetValue sheetValue, Function1 function1, boolean z2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, density, (i2 & 4) != 0 ? SheetValue.Hidden : sheetValue, (i2 & 8) != 0 ? new Function1<SheetValue, Boolean>() { // from class: androidx.compose.material3.SheetState.1
            @Override // kotlin.jvm.functions.Function1
