...
public final class NavigationBarItemColors {
    ...
    public final NavigationBarItemColors m1893copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3793equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m3793equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m3793equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m3793equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m3793equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m3793equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m3793equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
    ...
    public final long m1898getSelectedIndicatorColor0d7_KjU() {
        return this.selectedIndicatorColor;
    }
    ...
    public int hashCode() {
        return Color.m3799hashCodeimpl(this.disabledTextColor) + d.d(this.disabledIconColor, d.d(this.selectedIndicatorColor, d.d(this.unselectedTextColor, d.d(this.selectedTextColor, d.d(this.unselectedIconColor, Color.m3799hashCodeimpl(this.selectedIconColor) * 31, 31), 31), 31), 31), 31);
    }

    /* renamed from: iconColor-WaAFU9c$material3_release, reason: not valid java name */
    public final long m1902iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public final long m1903textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
