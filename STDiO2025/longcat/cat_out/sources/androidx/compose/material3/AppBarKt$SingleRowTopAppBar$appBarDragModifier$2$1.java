...
public final class AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (AppBarKt.settleAppBar(state, f2, flingAnimationSpec, snapAnimationSpec, this) == coroutine_suspended) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, float f2, Continuation<? super Unit> continuation) {
        ...
        appBarKt$SingleRowTopAppBar$appBarDragModifier$2$1.F$0 = f2;
