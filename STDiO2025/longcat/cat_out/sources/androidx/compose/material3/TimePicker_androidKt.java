...
public final class TimePicker_androidKt {
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i2) {
        ...
        int iM2375getHorizontalQJTpgSE = configuration.screenHeightDp < configuration.screenWidthDp ? TimePickerLayoutType.INSTANCE.m2375getHorizontalQJTpgSE() : TimePickerLayoutType.INSTANCE.m2376getVerticalQJTpgSE();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return iM2375getHorizontalQJTpgSE;
    }
