...
public final /* data */ class Keyline {
    ...
    public int hashCode() {
        return Float.hashCode(this.cutoff) + d.i(this.isPivot, d.i(this.isAnchor, d.i(this.isFocal, d.b(d.b(Float.hashCode(this.size) * 31, 31, this.offset), 31, this.unadjustedOffset), 31), 31), 31);
    }
