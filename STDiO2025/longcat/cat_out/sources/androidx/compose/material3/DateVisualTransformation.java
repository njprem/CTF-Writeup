...
final class DateVisualTransformation implements VisualTransformation {
    ...
    public DateVisualTransformation(DateInputFormat dateInputFormat) {
        ...
        this.firstDelimiterOffset = StringsKt__StringsKt.indexOf$default(dateInputFormat.getPatternWithDelimiters(), dateInputFormat.getDelimiter(), 0, false, 6, (Object) null);
    ...
    public TransformedText filter(AnnotatedString text) {
        ...
        while (i2 < strSubstring.length()) {
            int i4 = i3 + 1;
            String str2 = str + strSubstring.charAt(i2);
