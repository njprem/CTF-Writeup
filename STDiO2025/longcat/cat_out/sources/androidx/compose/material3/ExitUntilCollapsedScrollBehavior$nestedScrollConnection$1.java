    ...
    */
    public java.lang.Object mo443onPostFlingRZ2iAVY(long r9, long r11, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r13) {
        ...
        L38:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 r9 = (androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1) r9
            kotlin.ResultKt.throwOnFailure(r13)
            goto L57
        L42:
            kotlin.ResultKt.throwOnFailure(r13)
        ...
        L57:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r10 = r9.this$0
            androidx.compose.material3.TopAppBarState r10 = r10.getState()
            float r11 = androidx.compose.ui.unit.Velocity.m6471getYimpl(r11)
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r12 = r9.this$0
            androidx.compose.animation.core.DecayAnimationSpec r12 = r12.getFlingAnimationSpec()
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r9 = r9.this$0
        ...
        L82:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo443onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public long mo444onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Offset.m3552getYimpl(available) < 0.0f || Offset.m3552getYimpl(consumed) < 0.0f) {
        ...
        if (Offset.m3552getYimpl(consumed) == 0.0f && Offset.m3552getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m3552getYimpl(available) <= 0.0f) {
            return Offset.INSTANCE.m3567getZeroF1C5BW0();
        }
        float heightOffset2 = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(Offset.m3552getYimpl(available) + this.this$0.getState().getHeightOffset());
    ...
    public long mo718onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m3552getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m3567getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(Offset.m3552getYimpl(available) + this.this$0.getState().getHeightOffset());
        return heightOffset == this.this$0.getState().getHeightOffset() ? Offset.INSTANCE.m3567getZeroF1C5BW0() : Offset.m3545copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
    }
}
