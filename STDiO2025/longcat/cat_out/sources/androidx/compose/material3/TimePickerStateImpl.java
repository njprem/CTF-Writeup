...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i2, int i3, boolean z) {
        ...
        this.is24hour = z;
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2377boximpl(TimePickerSelectionMode.INSTANCE.m2384getHouryecRtBI()), null, 2, null);
        this.isAfternoon = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.valueOf(i2 >= 12), null, 2, null);
    ...
    public int mo1392getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m2383unboximpl();
    }
    ...
    public void mo1393setSelection6_8s6DQ(int i2) {
        this.selection.setValue(TimePickerSelectionMode.m2377boximpl(i2));
    }
}
