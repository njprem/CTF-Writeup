...
public final /* data */ class CalendarMonth {
    ...
    public CalendarMonth(int i2, int i3, int i4, int i5, long j2) {
        ...
        this.endUtcTimeMillis = ((i4 * CalendarModelKt.MillisecondsIn24Hours) + j2) - 1;
    }
    ...
    public static /* synthetic */ CalendarMonth copy$default(CalendarMonth calendarMonth, int i2, int i3, int i4, int i5, long j2, int i6, Object obj) {
        ...
        long j3 = j2;
        return calendarMonth.copy(i2, i3, i4, i5, j3);
    }
    ...
    public int hashCode() {
        return Long.hashCode(this.startUtcTimeMillis) + d.c(this.daysFromStartOfWeekToFirstOfMonth, d.c(this.numberOfDays, d.c(this.month, Integer.hashCode(this.year) * 31, 31), 31), 31);
    }
