...
public final class TextFieldImplKt$TextFieldTransitionScope$labelTextStyleColor$1 extends Lambda implements Function3<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Color>> {
    ...
    public final FiniteAnimationSpec<Color> invoke(Transition.Segment<InputPhase> segment, Composer composer, int i2) {
        composer.startReplaceGroup(1528582156);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1528582156, i2, -1, "androidx.compose.material3.internal.TextFieldTransitionScope.<anonymous> (TextFieldImpl.kt:407)");
        }
