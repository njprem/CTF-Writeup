...
public final /* data */ class PullToRefreshElement extends ModifierNodeElement<PullToRefreshModifierNode> {
    ...
    public static /* synthetic */ PullToRefreshElement m2619copyM2VBTUQ$default(PullToRefreshElement pullToRefreshElement, boolean z, Function0 function0, boolean z2, PullToRefreshState pullToRefreshState, float f2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        float f3 = f2;
        boolean z3 = z2;
        return pullToRefreshElement.m2621copyM2VBTUQ(z, function0, z3, pullToRefreshState, f3);
    }
    ...
    public final PullToRefreshElement m2621copyM2VBTUQ(boolean isRefreshing, Function0<Unit> onRefresh, boolean enabled, PullToRefreshState state, float threshold) {
    ...
    public boolean equals(Object other) {
        ...
        return this.isRefreshing == pullToRefreshElement.isRefreshing && Intrinsics.areEqual(this.onRefresh, pullToRefreshElement.onRefresh) && this.enabled == pullToRefreshElement.enabled && Intrinsics.areEqual(this.state, pullToRefreshElement.state) && Dp.m6238equalsimpl0(this.threshold, pullToRefreshElement.threshold);
    }
    ...
    public final float m2622getThresholdD9Ej5fM() {
        return this.threshold;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return Dp.m6239hashCodeimpl(this.threshold) + ((this.state.hashCode() + d.i(this.enabled, (this.onRefresh.hashCode() + (Boolean.hashCode(this.isRefreshing) * 31)) * 31, 31)) * 31);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("PullToRefreshModifierNode");
        d.k(this.isRefreshing, inspectorInfo.getProperties(), "isRefreshing", inspectorInfo).set("onRefresh", this.onRefresh);
        d.k(this.enabled, inspectorInfo.getProperties(), "enabled", inspectorInfo).set("state", this.state);
        inspectorInfo.getProperties().set("threshold", Dp.m6231boximpl(this.threshold));
    }
    ...
    public String toString() {
        return "PullToRefreshElement(isRefreshing=" + this.isRefreshing + ", onRefresh=" + this.onRefresh + ", enabled=" + this.enabled + ", state=" + this.state + ", threshold=" + ((Object) Dp.m6244toStringimpl(this.threshold)) + ')';
    }
    ...
    public void update(PullToRefreshModifierNode node) {
        ...
        node.m2635setThreshold0680j_4(this.threshold);
