...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = Dp.m6233constructorimpl(0);
    private static final PaddingValues ContentPadding = PaddingKt.m639PaddingValuesa9UjIt4$default(AppBarKt.BottomAppBarHorizontalPadding, AppBarKt.getBottomAppBarVerticalPadding(), AppBarKt.BottomAppBarHorizontalPadding, 0.0f, 8, null);
    ...
    public final float m1422getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i2) {
        ...
        WindowInsets windowInsetsM713onlybOOhFvg = WindowInsetsKt.m713onlybOOhFvg(systemBarsForVisualComponents, WindowInsetsSides.m725plusgK_yJZ4(companion.m735getHorizontalJoeWqyM(), companion.m733getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
