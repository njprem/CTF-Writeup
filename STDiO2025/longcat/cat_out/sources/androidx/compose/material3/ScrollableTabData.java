...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i2, List<TabPosition> list) {
        int iMo328roundToPx0680j_4 = density.mo328roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m2217getRightD9Ej5fM()) + i2;
        int maxValue = iMo328roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo328roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo328roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(iMo328roundToPx0680j_4 - maxValue, 0));
    }
