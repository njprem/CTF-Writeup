...
public final class DatePickerColors {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i2) {
        State<Color> stateRememberUpdatedState;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1240482658, i2, -1, "androidx.compose.material3.DatePickerColors.dayContainerColor (DatePicker.kt:929)");
        }
        long jM3827getTransparent0d7_KjU = z ? z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor : Color.INSTANCE.m3827getTransparent0d7_KjU();
        if (z3) {
            composer.startReplaceGroup(-217548653);
            stateRememberUpdatedState = SingleValueAnimationKt.m76animateColorAsStateeuL9pac(jM3827getTransparent0d7_KjU, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-217433457);
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3782boximpl(jM3827getTransparent0d7_KjU), composer, 0);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i2) {
        State<Color> stateM76animateColorAsStateeuL9pac;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1233694918, i2, -1, "androidx.compose.material3.DatePickerColors.dayContentColor (DatePicker.kt:897)");
        }
        long j2 = (z2 && z4) ? this.selectedDayContentColor : (!z2 || z4) ? (z3 && z4) ? this.dayInSelectionRangeContentColor : (!z3 || z4) ? z ? this.todayContentColor : z4 ? this.dayContentColor : this.disabledDayContentColor : this.disabledDayContentColor : this.disabledSelectedDayContentColor;
        if (z3) {
            composer.startReplaceGroup(-828488761);
            stateM76animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m3782boximpl(j2), composer, 0);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-828426947);
            stateM76animateColorAsStateeuL9pac = SingleValueAnimationKt.m76animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3793equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m3793equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m3793equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m3793equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m3793equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m3793equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m3793equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m3793equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m3793equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m3793equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m3793equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m3793equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m3793equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m3793equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m3793equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m3793equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m3793equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m3793equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m3793equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m3793equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m3793equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m3793equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }
    ...
    public int hashCode() {
        return Color.m3799hashCodeimpl(this.dayInSelectionRangeContentColor) + d.d(this.dayInSelectionRangeContainerColor, d.d(this.todayDateBorderColor, d.d(this.todayContentColor, d.d(this.disabledSelectedDayContainerColor, d.d(this.selectedDayContainerColor, d.d(this.disabledSelectedDayContentColor, d.d(this.selectedDayContentColor, d.d(this.disabledDayContentColor, d.d(this.dayContentColor, d.d(this.disabledSelectedYearContainerColor, d.d(this.selectedYearContainerColor, d.d(this.disabledSelectedYearContentColor, d.d(this.selectedYearContentColor, d.d(this.currentYearContentColor, d.d(this.disabledYearContentColor, d.d(this.yearContentColor, d.d(this.subheadContentColor, d.d(this.weekdayContentColor, d.d(this.headlineContentColor, d.d(this.titleContentColor, Color.m3799hashCodeimpl(this.containerColor) * 31, 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31);
    }
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, boolean z2, Composer composer, int i2) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1306331107, i2, -1, "androidx.compose.material3.DatePickerColors.yearContainerColor (DatePicker.kt:978)");
        }
        State<Color> stateM76animateColorAsStateeuL9pac = SingleValueAnimationKt.m76animateColorAsStateeuL9pac(z ? z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor : Color.INSTANCE.m3827getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return stateM76animateColorAsStateeuL9pac;
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i2) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(874111097, i2, -1, "androidx.compose.material3.DatePickerColors.yearContentColor (DatePicker.kt:955)");
        }
        State<Color> stateM76animateColorAsStateeuL9pac = SingleValueAnimationKt.m76animateColorAsStateeuL9pac((z2 && z3) ? this.selectedYearContentColor : (!z2 || z3) ? z ? this.currentYearContentColor : z3 ? this.yearContentColor : this.disabledYearContentColor : this.disabledSelectedYearContentColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return stateM76animateColorAsStateeuL9pac;
