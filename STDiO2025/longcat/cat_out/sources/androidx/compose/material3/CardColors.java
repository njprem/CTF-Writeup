...
public final class CardColors {
    ...
    public static /* synthetic */ CardColors m1453copyjRlVdoo$default(CardColors cardColors, long j2, long j3, long j4, long j5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j2 = cardColors.containerColor;
        }
        long j6 = j2;
        if ((i2 & 2) != 0) {
            j3 = cardColors.contentColor;
        }
        long j7 = j3;
        if ((i2 & 4) != 0) {
            j4 = cardColors.disabledContainerColor;
        }
        return cardColors.m1456copyjRlVdoo(j6, j7, j4, (i2 & 8) != 0 ? cardColors.disabledContentColor : j5);
    }

    /* renamed from: containerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m1454containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1455contentColorvNxB06k$material3_release(boolean enabled) {
        return enabled ? this.contentColor : this.disabledContentColor;
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final CardColors m1456copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3793equalsimpl0(this.containerColor, cardColors.containerColor) && Color.m3793equalsimpl0(this.contentColor, cardColors.contentColor) && Color.m3793equalsimpl0(this.disabledContainerColor, cardColors.disabledContainerColor) && Color.m3793equalsimpl0(this.disabledContentColor, cardColors.disabledContentColor);
    }
