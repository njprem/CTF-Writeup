...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (z3 || objRememberedValue3 == companion.getEmpty()) {
            objRememberedValue3 = new SelectableChipElevation$animateElevation$1$1(interactionSource, snapshotStateList, null);
        ...
        if (zChangedInstance2 || objRememberedValue5 == companion.getEmpty()) {
            ...
            Object selectableChipElevation$animateElevation$2$1 = new SelectableChipElevation$animateElevation$2$1(animatable, f2, z, interaction, mutableState, null);
            composer.updateRememberedValue(selectableChipElevation$animateElevation$2$1);
            objRememberedValue5 = selectableChipElevation$animateElevation$2$1;
        } else {
            animatable = animatable3;
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6238equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m6238equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m6238equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m6238equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m6238equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }
