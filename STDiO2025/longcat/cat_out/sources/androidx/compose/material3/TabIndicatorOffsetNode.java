...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public TabIndicatorOffsetNode(State<? extends List<TabPosition>> state, int i2, boolean z) {
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        if (dp != null) {
            ...
            if (!Dp.m6238equalsimpl0(contentWidth, animatable.getTargetValue().m6247unboximpl())) {
            ...
            this.initialWidth = Dp.m6231boximpl(contentWidth);
        }
        ...
        if (dp2 != null) {
            ...
            if (animatable2 == null) {
                ...
                Animatable<Dp, AnimationVector1D> animatable3 = new Animatable<>(dp2, VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
                this.offsetAnimatable = animatable3;
                animatable2 = animatable3;
            }
            if (!Dp.m6238equalsimpl0(left, animatable2.getTargetValue().m6247unboximpl())) {
            ...
            this.initialOffset = Dp.m6231boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable4 = this.offsetAnimatable;
        if (animatable4 != null) {
            left = animatable4.getValue().m6247unboximpl();
        }
        Animatable<Dp, AnimationVector1D> animatable5 = this.widthAnimatable;
        if (animatable5 != null) {
            contentWidth = animatable5.getValue().m6247unboximpl();
        }
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(Constraints.m6177copyZbe2FdA$default(j2, measureScope.mo328roundToPx0680j_4(contentWidth), measureScope.mo328roundToPx0680j_4(contentWidth), 0, 0, 12, null));
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5120measureBRTryo0, measureScope.mo328roundToPx0680j_4(left), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
