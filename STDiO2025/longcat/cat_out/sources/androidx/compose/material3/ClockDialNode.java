...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    public /* synthetic */ ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(analogTimePickerState, z, i2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final float getMaxDist() {
        return DelegatableNodeKt.requireDensity(this).mo334toPx0680j_4(TimePickerKt.MaxDistance);
    }
    ...
    public void mo170onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo170onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo170onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo324onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m6409getCenterozmzZPI(size);
    }

    /* renamed from: updateNode-e8ubxrI, reason: not valid java name */
    public final void m1515updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (TimePickerSelectionMode.m2380equalsimpl0(this.selection, selection)) {
            return;
        }
    ...
    private ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i2) {
        this.state = analogTimePickerState;
        this.autoSwitchToMinute = z;
        this.selection = i2;
        this.center = IntOffset.INSTANCE.m6371getZeronOccac();
