...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public SharedElementInternalState(SharedElement sharedElement, BoundsAnimation boundsAnimation, SharedTransitionScope.PlaceHolderSize placeHolderSize, boolean z, SharedTransitionScope.OverlayClip overlayClip, boolean z2, SharedTransitionScope.SharedContentState sharedContentState, float f2) {
    ...
    public final long m69calculateLookaheadOffsetF1C5BW0() {
        ...
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5129localPositionOfR5De75A(layoutCoordinatesInvoke, Offset.INSTANCE.m3567getZeroF1C5BW0());
    }
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM3540boximpl = currentBounds != null ? Offset.m3540boximpl(currentBounds.m3586getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM3540boximpl);
            long packedValue = offsetM3540boximpl.getPackedValue();
            float fM3551getXimpl = Offset.m3551getXimpl(packedValue);
            float fM3552getYimpl = Offset.m3552getYimpl(packedValue);
            ...
            if (path != null) {
                ...
                try {
                    drawContext.getTransform().mo4265clipPathmtrdDE(path, iM3781getIntersectrtfAjoo);
                    drawScope.getDrawContext().getTransform().translate(fM3551getXimpl, fM3552getYimpl);
                    try {
    ...
    public final long m70getNonNullLookaheadSizeNHjbRc() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke != null) {
            return IntSizeKt.m6415toSizeozmzZPI(layoutCoordinatesInvoke.mo5128getSizeYbymL2g());
        }
