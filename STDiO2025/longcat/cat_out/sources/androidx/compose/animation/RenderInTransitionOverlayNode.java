...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    public final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long jMo5129localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5129localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode), Offset.INSTANCE.m3567getZeroF1C5BW0());
                float fM3551getXimpl = Offset.m3551getXimpl(jMo5129localPositionOfR5De75A);
                float fM3552getYimpl = Offset.m3552getYimpl(jMo5129localPositionOfR5De75A);
                ...
                try {
                    drawContext.getTransform().mo4265clipPathmtrdDE(pathInvoke, iM3781getIntersectrtfAjoo);
                    drawScope.getDrawContext().getTransform().translate(fM3551getXimpl, fM3552getYimpl);
                    try {
                        GraphicsLayerKt.drawLayer(drawScope, this.layer);
                    } finally {
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4340recordJVtK1S4$default(contentDrawScope, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
