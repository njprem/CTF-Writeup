...
public final class VectorizedFloatAnimationSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            v3.set$animation_core_release(i2, this.anims.get(i2).getValueFromNanos(playTimeNanos, initialValue.get$animation_core_release(i2), targetValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
        }
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            v3.set$animation_core_release(i2, this.anims.get(i2).getVelocityFromNanos(playTimeNanos, initialValue.get$animation_core_release(i2), targetValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
        }
