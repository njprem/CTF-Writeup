...
public final class VectorizedAnimationSpecKt {
    ...
    public static final long clampPlayTime(VectorizedDurationBasedAnimationSpec<?> vectorizedDurationBasedAnimationSpec, long j2) {
        return RangesKt.coerceIn(j2 - vectorizedDurationBasedAnimationSpec.getDelayMillis(), 0L, vectorizedDurationBasedAnimationSpec.getDurationMillis());
    }
    ...
    public static final <V extends AnimationVector> Animations createSpringAnimations(V v2, float f2, float f3) {
        return v2 != null ? new Animations(v2, f2, f3) { // from class: androidx.compose.animation.core.VectorizedAnimationSpecKt.createSpringAnimations.1
            ...
            {
                IntRange intRangeUntil = RangesKt.until(0, v2.getSize());
