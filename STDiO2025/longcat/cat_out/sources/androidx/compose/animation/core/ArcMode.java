...
public final class ArcMode {
    ...
    private static final int ArcAbove = m106constructorimpl(5);
    private static final int ArcBelow = m106constructorimpl(4);
    private static final int ArcLinear = m106constructorimpl(0);
    ...
    public static final /* synthetic */ ArcMode m105boximpl(int i2) {
        return new ArcMode(i2);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m106constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m107equalsimpl(int i2, Object obj) {
        return (obj instanceof ArcMode) && i2 == ((ArcMode) obj).getValue();
    }
