...
public final class EasingFunctionsKt {
    ...
    private static final Easing EaseInElastic = new a(0);
    private static final Easing EaseOutElastic = new a(1);
    private static final Easing EaseInOutElastic = new a(2);
    private static final Easing EaseOutBounce = new a(3);
    private static final Easing EaseInBounce = new a(4);
    private static final Easing EaseInOutBounce = new a(5);
    ...
    public static final float EaseInOutBounce$lambda$5(float f2) {
        if (f2 < 0.5d) {
            return (1 - EaseOutBounce.transform(1.0f - (f2 * 2.0f))) / 2.0f;
        }
        return (EaseOutBounce.transform((f2 * 2.0f) - 1.0f) + 1) / 2.0f;
    }
    ...
    public static final float EaseInOutElastic$lambda$2(float f2) {
        ...
        if (0.0f > f2 || f2 > 0.5f) {
            return ((float) ((Math.sin(((f2 * 20.0f) - 11.125f) * 1.3962634015954636d) * ((float) Math.pow(r8, ((-20.0f) * f2) + 10.0f))) / 2.0f)) + 1.0f;
        }
        float f3 = f2 * 20.0f;
        return (float) ((-(Math.sin((f3 - 11.125f) * 1.3962634015954636d) * ((float) Math.pow(r0, f3 - 10.0f)))) / 2.0f);
    }
