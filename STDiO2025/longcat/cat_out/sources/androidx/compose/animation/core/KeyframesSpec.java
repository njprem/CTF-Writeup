...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual(keyframeEntity.getEasing(), getEasing()) && ArcMode.m108equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }
        ...
        public int hashCode() {
            ...
            return getEasing().hashCode() + ((ArcMode.m109hashCodeimpl(this.arcMode) + ((value$animation_core_release != null ? value$animation_core_release.hashCode() : 0) * 31)) * 31);
        }

        /* renamed from: setArcMode-Rur9ykg$animation_core_release, reason: not valid java name */
        public final void m117setArcModeRur9ykg$animation_core_release(int i2) {
            this.arcMode = i2;
        }

        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i3 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i3 & 4) != 0 ? ArcMode.INSTANCE.m114getArcLinear9TMq4() : i2, null);
        }

        private KeyframeEntity(T t, Easing easing, int i2) {
            super(t, easing, null);
            this.arcMode = i2;
        }
    }
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m118usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i2) {
            keyframeEntity.m117setArcModeRur9ykg$animation_core_release(i2);
        ...
        public KeyframeEntity<T> at(T t, int i2) {
            ...
            getKeyframes().h(i2, keyframeEntity);
            return keyframeEntity;
        }

        @Override // androidx.compose.animation.core.KeyframesSpecBaseConfig
        public KeyframeEntity<T> atFraction(T t, float f2) {
            return at((KeyframesSpecConfig<T>) t, Math.round(getDurationMillis() * f2));
        }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((255 & j2) < 128) {
                            ...
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            c0639e.h(i8, new VectorizedKeyframeSpecElementInfo(converter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core_release()), keyframeEntity.getEasing(), keyframeEntity.getArcMode(), null));
                        } else {
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            i2 = i4;
        ...
        return new VectorizedKeyframesSpec<>(c0638d, c0639e, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m114getArcLinear9TMq4(), null);
    }
}
