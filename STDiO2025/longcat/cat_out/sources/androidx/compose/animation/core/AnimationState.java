...
public final class AnimationState<T, V extends AnimationVector> implements State<T> {
    ...
    public AnimationState(TwoWayConverter<T, V> twoWayConverter, T t, V v2, long j2, long j3, boolean z) {
        V v3;
        this.typeConverter = twoWayConverter;
        this.value = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(t, null, 2, null);
        this.velocityVector = (v2 == null || (v3 = (V) AnimationVectorsKt.copy(v2)) == null) ? (V) AnimationStateKt.createZeroVectorFrom(twoWayConverter, t) : v3;
