...
public final class Transition<S> {
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public TransitionAnimationState(T t, V v2, TwoWayConverter<T, V> twoWayConverter, String str) {
            T tInvoke;
            this.typeConverter = twoWayConverter;
            this.label = str;
            ...
            this.animation = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TargetBasedAnimation(getAnimationSpec(), twoWayConverter, t, getTargetValue(), v2), null, 2, null);
        ...
        public final void setDurationNanos$animation_core_release(long j2) {
            this.durationNanos.setLongValue(j2);
        }
        ...
        public final void updateTargetValue$animation_core_release(T targetValue, FiniteAnimationSpec<T> animationSpec) {
            ...
            if (getResetSnapValue$animation_core_release() >= 0.0f) {
                setValue$animation_core_release(getAnimation().getValueFromNanos((long) (getResetSnapValue$animation_core_release() * getAnimation().getDurationNanos())));
    ...
    private final void set_playTimeNanos(long j2) {
        this._playTimeNanos.setLongValue(j2);
    }
    ...
    public final void animateTo$animation_core_release(final S s2, Composer composer, final int i2) {
        ...
        if ((i2 & 6) == 0) {
            i3 = ((i2 & 8) == 0 ? composerStartRestartGroup.changed(s2) : composerStartRestartGroup.changedInstance(s2) ? 4 : 2) | i2;
        } else {
            i3 = i2;
        }
        if ((i2 & 48) == 0) {
        ...
        if ((i3 & 19) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1493585151, i3, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:1209)");
            }
            if (isSeeking()) {
                composerStartRestartGroup.startReplaceGroup(1823861403);
                composerStartRestartGroup.endReplaceGroup();
            } else {
                composerStartRestartGroup.startReplaceGroup(1822376658);
                updateTarget$animation_core_release(s2);
                if (!Intrinsics.areEqual(s2, getCurrentState()) || isRunning() || getUpdateChildrenNeeded()) {
                    composerStartRestartGroup.startReplaceGroup(1822607949);
                    ...
                    int i4 = i3 & 112;
                    boolean zChangedInstance = (i4 == 32) | composerStartRestartGroup.changedInstance(coroutineScope);
                    ...
                    composerStartRestartGroup.startReplaceGroup(1823851483);
                    composerStartRestartGroup.endReplaceGroup();
                }
                composerStartRestartGroup.endReplaceGroup();
            }
    ...
    public final boolean getHasInitialValueAnimations() {
        ...
        int size = snapshotStateList.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (snapshotStateList.get(i2).getInitialValueState() != null) {
                return true;
            }
        }
        SnapshotStateList<Transition<?>> snapshotStateList2 = this._transitions;
    ...
    public final void resetAnimationFraction$animation_core_release(float fraction) {
        ...
        int size = snapshotStateList.size();
        for (int i2 = 0; i2 < size; i2++) {
            snapshotStateList.get(i2).resetAnimationValue$animation_core_release(fraction);
        }
        SnapshotStateList<Transition<?>> snapshotStateList2 = this._transitions;
        int size2 = snapshotStateList2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            snapshotStateList2.get(i3).resetAnimationFraction$animation_core_release(fraction);
        }
    }
    ...
    public final void seek(S initialState, S targetState, long playTimeNanos) {
        ...
        int size2 = snapshotStateList2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            snapshotStateList2.get(i3).seekTo$animation_core_release(playTimeNanos);
        }
    ...
    public final void seekAnimations$animation_core_release(long playTimeNanos) {
        ...
        int size = snapshotStateList.size();
        for (int i2 = 0; i2 < size; i2++) {
            snapshotStateList.get(i2).seekTo$animation_core_release(playTimeNanos);
        }
        SnapshotStateList<Transition<?>> snapshotStateList2 = this._transitions;
        int size2 = snapshotStateList2.size();
        for (int i3 = 0; i3 < size2; i3++) {
    ...
    public final void setInitialAnimations$animation_core_release(SeekableTransitionState.SeekingAnimationState animationState) {
        ...
        int size = snapshotStateList.size();
        for (int i2 = 0; i2 < size; i2++) {
            snapshotStateList.get(i2).setInitialValueAnimation$animation_core_release(animationState);
        }
        SnapshotStateList<Transition<?>> snapshotStateList2 = this._transitions;
        int size2 = snapshotStateList2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            snapshotStateList2.get(i3).setInitialAnimations$animation_core_release(animationState);
        }
    }
    ...
    public final void setStartTimeNanos$animation_core_release(long j2) {
        this.startTimeNanos.setLongValue(j2);
    }
    ...
    public /* synthetic */ Transition(TransitionState transitionState, String str, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(transitionState, (i2 & 2) != 0 ? null : str);
    }
