...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m3591Recttz77jQw(sharedElementInternalState.m69calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m70getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m68onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM3540boximpl = rect != null ? Offset.m3540boximpl(rect.m3586getTopLeftF1C5BW0()) : null;
            if (offsetM3540boximpl == null ? false : Offset.m3548equalsimpl0(offsetM3540boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM3608boximpl = rect2 != null ? Size.m3608boximpl(rect2.m3584getSizeNHjbRc()) : null;
                if (sizeM3608boximpl == null ? false : Size.m3616equalsimpl0(sizeM3608boximpl.getPackedValue(), lookaheadSize)) {
                    return;
                }
            }
            Rect rectM3591Recttz77jQw = RectKt.m3591Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(rectM3591Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i2 = 0; i2 < size; i2++) {
                ...
                boundsAnimation.animate(currentBounds, rectM3591Recttz77jQw);
            }
        }
    }
