...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m62copybnNdC4k$default(Scale scale, float f2, long j2, FiniteAnimationSpec finiteAnimationSpec, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = scale.scale;
        }
        if ((i2 & 2) != 0) {
        ...
        return scale.m64copybnNdC4k(f2, j2, finiteAnimationSpec);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m4176equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }
    ...
    public int hashCode() {
        return this.animationSpec.hashCode() + ((TransformOrigin.m4179hashCodeimpl(this.transformOrigin) + (Float.hashCode(this.scale) * 31)) * 31);
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m4180toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
