        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m34invoke8_81llA(color.m3802unboximpl());
                }

                /* renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m34invoke8_81llA(long j2) {
                    long jM3789convertvNxB06k = Color.m3789convertvNxB06k(j2, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m3794getAlphaimpl(jM3789convertvNxB06k), Color.m3798getRedimpl(jM3789convertvNxB06k), Color.m3797getGreenimpl(jM3789convertvNxB06k), Color.m3795getBlueimpl(jM3789convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m3782boximpl(m35invokevNxB06k(animationVector4D));
                }

                /* renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m35invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m3789convertvNxB06k(ColorKt.Color(v2, v3, f3, f4 <= 1.0f ? f4 : 1.0f, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
