...
public final /* data */ class TransitionData {
    ...
    public static /* synthetic */ TransitionData copy$default(TransitionData transitionData, Fade fade, Slide slide, ChangeSize changeSize, Scale scale, boolean z, Map map, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return this.effectsMap.hashCode() + d.i(this.hold, (iHashCode3 + (scale != null ? scale.hashCode() : 0)) * 31, 31);
    }
    ...
    public /* synthetic */ TransitionData(Fade fade, Slide slide, ChangeSize changeSize, Scale scale, boolean z, Map map, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? null : fade, (i2 & 2) != 0 ? null : slide, (i2 & 4) != 0 ? null : changeSize, (i2 & 8) != 0 ? null : scale, (i2 & 16) != 0 ? false : z, (i2 & 32) != 0 ? MapsKt.emptyMap() : map);
    }
}
