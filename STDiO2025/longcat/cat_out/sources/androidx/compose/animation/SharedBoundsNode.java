...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final MeasureResult place(MeasureScope measureScope, final Placeable placeable) {
        long jMo71calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo71calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5128getSizeYbymL2g(), IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default(measureScope, IntSize.m6403getWidthimpl(jMo71calculateSizeJyjRU_E), IntSize.m6402getHeightimpl(jMo71calculateSizeJyjRU_E), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.place.1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Offset offsetM3540boximpl = coordinates3 != null ? Offset.m3540boximpl(SharedBoundsNode.this.getRootCoords().mo5129localPositionOfR5De75A(coordinates3, Offset.INSTANCE.m3567getZeroF1C5BW0())) : null;
                if (value != null) {
                    if (SharedBoundsNode.this.getBoundsAnimation().getTarget()) {
                        SharedBoundsNode.this.getSharedElement().setCurrentBounds(value);
                    }
                    jM3586getTopLeftF1C5BW0 = value.m3586getTopLeftF1C5BW0();
                } else {
                    ...
                    jM3586getTopLeftF1C5BW0 = currentBounds2.m3586getTopLeftF1C5BW0();
                }
                long jM3555minusMKHz9U = offsetM3540boximpl != null ? Offset.m3555minusMKHz9U(jM3586getTopLeftF1C5BW0, offsetM3540boximpl.getPackedValue()) : Offset.INSTANCE.m3567getZeroF1C5BW0();
                Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Offset.m3551getXimpl(jM3555minusMKHz9U)), Math.round(Offset.m3552getYimpl(jM3555minusMKHz9U)), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        getSharedElement().setCurrentBounds(RectKt.m3591Recttz77jQw(getRootCoords().mo5129localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3567getZeroF1C5BW0()), SizeKt.Size(IntSize.m6403getWidthimpl(layoutCoordinates.mo5128getSizeYbymL2g()), IntSize.m6402getHeightimpl(layoutCoordinates.mo5128getSizeYbymL2g()))));
    }
    ...
    public MeasureResult mo66approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j2) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long jM6411roundToIntSizeuvyYCjk = IntSizeKt.m6411roundToIntSizeuvyYCjk(value.m3584getSizeNHjbRc());
                int iM6403getWidthimpl = IntSize.m6403getWidthimpl(jM6411roundToIntSizeuvyYCjk);
                int iM6402getHeightimpl = IntSize.m6402getHeightimpl(jM6411roundToIntSizeuvyYCjk);
                if (iM6403getWidthimpl == Integer.MAX_VALUE || iM6402getHeightimpl == Integer.MAX_VALUE) {
                ...
                j2 = Constraints.INSTANCE.m6196fixedJhjzzOo(RangesKt.coerceAtLeast(iM6403getWidthimpl, 0), RangesKt.coerceAtLeast(iM6402getHeightimpl, 0));
            }
        }
        return place(approachMeasureScope, measurable.mo5120measureBRTryo0(j2));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        if (layer != null) {
            DrawScope.m4340recordJVtK1S4$default(contentDrawScope, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.draw.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
    ...
    public boolean mo67isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        final long jSize = SizeKt.Size(placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    ...
                    long j3 = jSize;
                    long jMo5129localPositionOfR5De75A = sharedBoundsNode.getRootLookaheadCoords().mo5129localPositionOfR5De75A(coordinates, Offset.INSTANCE.m3567getZeroF1C5BW0());
                    if (sharedBoundsNode.getSharedElement().getCurrentBounds() == null) {
                        sharedBoundsNode.getSharedElement().setCurrentBounds(RectKt.m3591Recttz77jQw(jMo5129localPositionOfR5De75A, j3));
                    }
                    offsetM3540boximpl = Offset.m3540boximpl(jMo5129localPositionOfR5De75A);
                } else {
                ...
                if (offsetM3540boximpl != null) {
                    ...
                    sharedBoundsNode2.getSharedElement().m68onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), jSize, offsetM3540boximpl.getPackedValue());
                }
            }
        }, 4, null);
    }
