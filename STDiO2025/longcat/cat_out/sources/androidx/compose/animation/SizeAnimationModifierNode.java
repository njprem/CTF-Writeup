...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m80copyO0kMr_c$default(AnimData animData, Animatable animatable, long j2, int i2, Object obj) {
            if ((i2 & 1) != 0) {
            ...
            return animData.m82copyO0kMr_c(animatable, j2);
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m6401equalsimpl0(this.startSize, animData.startSize);
        }
        ...
        public int hashCode() {
            return IntSize.m6404hashCodeimpl(this.startSize) + (this.anim.hashCode() * 31);
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m84setStartSizeozmzZPI(long j2) {
            this.startSize = j2;
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m6406toStringimpl(this.startSize)) + ')';
        }
    ...
    private final void m77setLookaheadConstraintsBRTryo0(long j2) {
        this.lookaheadConstraints = j2;
        this.lookaheadConstraintsAvailable = true;
    }

    /* renamed from: targetConstraints-ZezNO4M, reason: not valid java name */
    private final long m78targetConstraintsZezNO4M(long j2) {
    ...
    public final long m79animateTomzRDjE0(long targetSize) {
        ...
        if (animData != null) {
            boolean z = (IntSize.m6401equalsimpl0(targetSize, animData.getAnim().getValue().getPackedValue()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m6401equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue()) || z) {
            ...
            animData = new AnimData(new Animatable(IntSize.m6395boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m6395boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        long jM6200constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m77setLookaheadConstraintsBRTryo0(j2);
            placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(j2);
        } else {
            placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(m78targetConstraintsZezNO4M(j2));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            jM6200constrain4WqzIAM = jIntSize;
        } else {
            jM6200constrain4WqzIAM = ConstraintsKt.m6200constrain4WqzIAM(j2, m79animateTomzRDjE0(AnimationModifierKt.m32isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize));
        }
        final int iM6403getWidthimpl = IntSize.m6403getWidthimpl(jM6200constrain4WqzIAM);
        final int iM6402getHeightimpl = IntSize.m6402getHeightimpl(jM6200constrain4WqzIAM);
        return MeasureScope.layout$default(measureScope, iM6403getWidthimpl, iM6402getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5185placeRelative70tqf50$default(placementScope, placeable, this.this$0.getAlignment().mo3397alignKFBX0sM(jIntSize, IntSizeKt.IntSize(iM6403getWidthimpl, iM6402getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }
