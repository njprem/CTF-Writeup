...
final class SkipToLookaheadNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo54measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        if (measureScope.isLookingAhead()) {
            this.lookaheadConstraints = Constraints.m6174boximpl(j2);
        }
        Constraints constraints = this.lookaheadConstraints;
        Intrinsics.checkNotNull(constraints);
        final Placeable placeableMo5120measureBRTryo0 = measurable.mo5120measureBRTryo0(constraints.getValue());
        final long jIntSize = IntSizeKt.IntSize(placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight());
        final long jM6200constrain4WqzIAM = ConstraintsKt.m6200constrain4WqzIAM(j2, jIntSize);
        return MeasureScope.layout$default(measureScope, IntSize.m6403getWidthimpl(jM6200constrain4WqzIAM), IntSize.m6402getHeightimpl(jM6200constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                final long jScaleFactor = (IntSize.m6403getWidthimpl(jIntSize) == 0 || IntSize.m6402getHeightimpl(jIntSize) == 0) ? ScaleFactorKt.ScaleFactor(1.0f, 1.0f) : scaleToBounds.getContentScale().mo5111computeScaleFactorH7hwNQA(IntSizeKt.m6415toSizeozmzZPI(jIntSize), IntSizeKt.m6415toSizeozmzZPI(jM6200constrain4WqzIAM));
                long jMo3397alignKFBX0sM = scaleToBounds.getAlignment().mo3397alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(ScaleFactor.m5209getScaleXimpl(jScaleFactor) * IntSize.m6403getWidthimpl(jIntSize)), MathKt.roundToInt(ScaleFactor.m5210getScaleYimpl(jScaleFactor) * IntSize.m6402getHeightimpl(jIntSize))), jM6200constrain4WqzIAM, measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5120measureBRTryo0, IntOffset.m6361getXimpl(jMo3397alignKFBX0sM), IntOffset.m6362getYimpl(jMo3397alignKFBX0sM), 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        graphicsLayerScope.setScaleX(ScaleFactor.m5209getScaleXimpl(jScaleFactor));
                        graphicsLayerScope.setScaleY(ScaleFactor.m5210getScaleYimpl(jScaleFactor));
                        graphicsLayerScope.mo3984setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                    }
                }, 4, (Object) null);
            }
        }, 4, null);
    ...
    public final void m87setLookaheadConstraints_Sx5XlM(Constraints constraints) {
