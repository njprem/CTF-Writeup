...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m53setLookaheadConstraintsBRTryo0(long j2) {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jIntSize = IntSizeKt.IntSize(placeableMo5120measureBRTryo0.getWidth(), placeableMo5120measureBRTryo0.getHeight());
            this.lookaheadSize = jIntSize;
            m53setLookaheadConstraintsBRTryo0(j2);
            return MeasureScope.layout$default(measureScope, IntSize.m6403getWidthimpl(jIntSize), IntSize.m6402getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (!this.isEnabled.invoke().booleanValue()) {
            final Placeable placeableMo5120measureBRTryo02 = measurable.mo5120measureBRTryo0(j2);
            return MeasureScope.layout$default(measureScope, placeableMo5120measureBRTryo02.getWidth(), placeableMo5120measureBRTryo02.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
                {
                    super(1);
                }
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo5120measureBRTryo02, 0, 0, 0.0f, 4, null);
                }
            }, 4, null);
        }
        final Function1<GraphicsLayerScope, Unit> function1Init = this.graphicsLayerBlock.init();
        final Placeable placeableMo5120measureBRTryo03 = measurable.mo5120measureBRTryo0(j2);
        long jIntSize2 = IntSizeKt.IntSize(placeableMo5120measureBRTryo03.getWidth(), placeableMo5120measureBRTryo03.getHeight());
        final long j3 = AnimationModifierKt.m32isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
        ...
        State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m6395boximpl(m58invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m58invokeYEO4UFw(EnterExitState enterExitState) {
                return this.this$0.m55sizeByStateUzc_VyU(enterExitState, j3);
            }
        }) : null;
        if (stateAnimate3 != null) {
            jIntSize2 = stateAnimate3.getValue().getPackedValue();
        }
        long jM6200constrain4WqzIAM = ConstraintsKt.m6200constrain4WqzIAM(j2, jIntSize2);
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
        final long jM6371getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
            }
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6352boximpl(m59invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m59invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m57targetOffsetByStateoFUgxo0(enterExitState, j3);
            }
        })) == null) ? IntOffset.INSTANCE.m6371getZeronOccac() : stateAnimate2.getValue().getPackedValue();
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
        long jM6371getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6352boximpl(m60invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m60invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m56slideTargetValueByStateoFUgxo0(enterExitState, j3);
            }
        })) == null) ? IntOffset.INSTANCE.m6371getZeronOccac() : stateAnimate.getValue().getPackedValue();
        Alignment alignment2 = this.currentAlignment;
        final long jM6365plusqkQi6aY = IntOffset.m6365plusqkQi6aY(alignment2 != null ? alignment2.mo3397alignKFBX0sM(j3, jM6200constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m6371getZeronOccac(), jM6371getZeronOccac2);
        return MeasureScope.layout$default(measureScope, IntSize.m6403getWidthimpl(jM6200constrain4WqzIAM), IntSize.m6402getHeightimpl(jM6200constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                placementScope.placeWithLayer(placeableMo5120measureBRTryo03, IntOffset.m6361getXimpl(jM6371getZeronOccac) + IntOffset.m6361getXimpl(jM6365plusqkQi6aY), IntOffset.m6362getYimpl(jM6371getZeronOccac) + IntOffset.m6362getYimpl(jM6365plusqkQi6aY), 0.0f, function1Init);
            }
        }, 4, null);
    }
    ...
    public final long m55sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i2 != 1) {
            if (i2 == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m6395boximpl(fullSize)).getPackedValue();
                }
            } else {
                if (i2 != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m6395boximpl(fullSize)).getPackedValue();
                }
            }
        }
        return fullSize;
    ...
    public final long m56slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM6371getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6371getZeronOccac() : slideOffset2.invoke(IntSize.m6395boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long jM6371getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6371getZeronOccac() : slideOffset.invoke(IntSize.m6395boximpl(fullSize)).getPackedValue();
        int i2 = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i2 == 1) {
            return IntOffset.INSTANCE.m6371getZeronOccac();
        }
        if (i2 == 2) {
            return jM6371getZeronOccac;
        }
        if (i2 == 3) {
            return jM6371getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: targetOffsetByState-oFUgxo0, reason: not valid java name */
    public final long m57targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long packedValue = changeSize.getSize().invoke(IntSize.m6395boximpl(fullSize)).getPackedValue();
        Alignment alignment = getAlignment();
        Intrinsics.checkNotNull(alignment);
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        long jMo3397alignKFBX0sM = alignment.mo3397alignKFBX0sM(fullSize, packedValue, layoutDirection);
        Alignment alignment2 = this.currentAlignment;
        Intrinsics.checkNotNull(alignment2);
        return IntOffset.m6364minusqkQi6aY(jMo3397alignKFBX0sM, alignment2.mo3397alignKFBX0sM(fullSize, packedValue, layoutDirection));
    }
}
