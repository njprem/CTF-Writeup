...
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.KeyboardArrowLeft", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        PathBuilder pathBuilderA = a.A(15.41f, 16.59f, 10.83f, 12.0f);
        pathBuilderA.lineToRelative(4.58f, -4.59f);
