...
public final class MailOutlineKt {
    ...
    public static final ImageVector getMailOutline(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MailOutline", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(6.94f, 4.34f);
        pathBuilderA.curveToRelative(0.65f, 0.41f, 1.47f, 0.41f, 2.12f, 0.0f);
        pathBuilderA.lineTo(20.0f, 8.0f);
