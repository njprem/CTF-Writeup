...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CheckCircle", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(9.29f, 16.29f);
        pathBuilderA.lineTo(5.7f, 12.7f);
