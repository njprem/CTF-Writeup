...
public final class PlayArrowKt {
    ...
    public static final ImageVector getPlayArrow(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PlayArrow", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.A(10.0f, 8.64f, 15.27f, 12.0f);
        pathBuilderA.lineTo(10.0f, 15.36f);
        pathBuilderA.verticalLineTo(8.64f);
        pathBuilderA.moveTo(8.0f, 5.0f);
        pathBuilderA.verticalLineToRelative(14.0f);
        pathBuilderA.lineToRelative(11.0f, -7.0f);
