...
public final class ArrowDropDownKt {
    ...
    public static final ImageVector getArrowDropDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowDropDown", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderG = a.g(8.71f, 11.71f, 2.59f, 2.59f);
        pathBuilderG.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderG.lineToRelative(2.59f, -2.59f);
        pathBuilderG.curveToRelative(0.63f, -0.63f, 0.18f, -1.71f, -0.71f, -1.71f);
        pathBuilderG.horizontalLineTo(9.41f);
        pathBuilderG.curveToRelative(-0.89f, 0.0f, -1.33f, 1.08f, -0.7f, 1.71f);
        pathBuilderG.close();
