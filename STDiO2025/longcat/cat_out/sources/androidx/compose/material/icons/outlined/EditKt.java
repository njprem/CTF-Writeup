...
public final class EditKt {
    ...
    public static final ImageVector getEdit(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Edit", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderG = a.g(14.06f, 9.02f, 0.92f, 0.92f);
        pathBuilderG.lineTo(5.92f, 19.0f);
        pathBuilderG.lineTo(5.0f, 19.0f);
        pathBuilderG.verticalLineToRelative(-0.92f);
        pathBuilderG.lineToRelative(9.06f, -9.06f);
        pathBuilderG.moveTo(17.66f, 3.0f);
        pathBuilderG.curveToRelative(-0.25f, 0.0f, -0.51f, 0.1f, -0.7f, 0.29f);
        pathBuilderG.lineToRelative(-1.83f, 1.83f);
        pathBuilderG.lineToRelative(3.75f, 3.75f);
        pathBuilderG.lineToRelative(1.83f, -1.83f);
        pathBuilderG.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderG.lineToRelative(-2.34f, -2.34f);
        pathBuilderG.curveToRelative(-0.2f, -0.2f, -0.45f, -0.29f, -0.71f, -0.29f);
        pathBuilderG.close();
        pathBuilderG.moveTo(14.06f, 6.19f);
        pathBuilderG.lineTo(3.0f, 17.25f);
        pathBuilderG.lineTo(3.0f, 21.0f);
        pathBuilderG.horizontalLineToRelative(3.75f);
        pathBuilderG.lineTo(17.81f, 9.94f);
        pathBuilderG.lineToRelative(-3.75f, -3.75f);
        pathBuilderG.close();
