...
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowDown", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.A(7.41f, 8.59f, 12.0f, 13.17f);
        pathBuilderA.lineToRelative(4.59f, -4.58f);
        pathBuilderA.lineTo(18.0f, 10.0f);
