...
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DateRange", Dp.m6233constructorimpl(24.0f), Dp.m6233constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder2.verticalLineToRelative(2.0f);
        pathBuilder2.close();
        AbstractC0783a.c(pathBuilder2, 15.0f, 11.0f, 2.0f, 2.0f);
        pathBuilder2.horizontalLineToRelative(-2.0f);
        pathBuilder2.close();
