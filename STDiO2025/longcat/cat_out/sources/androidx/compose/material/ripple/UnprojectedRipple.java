...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    private final long m1386calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m3791copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void m1387setColorDxMtmZc(long color, float alpha) {
        long jM1386calculateRippleColor5vOe2sY = m1386calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m3793equalsimpl0(color2.m3802unboximpl(), jM1386calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3782boximpl(jM1386calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3846toArgb8_81llA(jM1386calculateRippleColor5vOe2sY)));
    }
