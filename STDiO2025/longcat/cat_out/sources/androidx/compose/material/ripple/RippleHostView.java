...
public final class RippleHostView extends View {
    ...
    private final void setRippleState(boolean pressed) {
        ...
        if (pressed || jLongValue >= MinimumRippleStateChangeTime) {
            ...
            x xVar = new x(this, 1);
            this.resetRippleRunnable = xVar;
            postDelayed(xVar, ResetRippleDelayDuration);
        }
    ...
    public final void m1375addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m1376setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            unprojectedRipple.setHotspot(Offset.m3551getXimpl(interaction.getPressPosition()), Offset.m3552getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m1376setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.m1387setColorDxMtmZc(color, alpha);
        Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m3620getWidthimpl(size)), MathKt.roundToInt(Size.m3617getHeightimpl(size)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
