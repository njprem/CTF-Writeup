...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final RippleAlpha m1382defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            return lightTheme ? ((double) ColorKt.m3844luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha : RippleThemeKt.DarkThemeRippleAlpha;
        }
        ...
        public final long m1383defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m3844luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m3829getWhite0d7_KjU();
        }
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "RippleTheme and LocalRippleTheme have been deprecated - they are not compatible with the new ripple implementation using the new Indication APIs that provide notable performance improvements. For a migration guide and background information, please visit developer.android.com")
    /* renamed from: defaultColor-WaAFU9c */
    long mo1371defaultColorWaAFU9c(Composer composer, int i2);
