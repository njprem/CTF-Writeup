...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m1375addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m3802unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
        setRippleHostView(rippleHostView);
    }

    @Override // androidx.compose.foundation.IndicationInstance
    public void drawIndication(ContentDrawScope contentDrawScope) {
        this.rippleSize = contentDrawScope.mo4342getSizeNHjbRc();
        this.rippleRadius = Float.isNaN(this.radius) ? MathKt.roundToInt(RippleAnimationKt.m1373getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo4342getSizeNHjbRc())) : contentDrawScope.mo328roundToPx0680j_4(this.radius);
        ...
        if (rippleHostView != null) {
            rippleHostView.m1376setRippleProperties07v42R4(contentDrawScope.mo4342getSizeNHjbRc(), jM3802unboximpl, pressedAlpha);
