...
public final class RippleAlpha {
    ...
    public int hashCode() {
        return Float.hashCode(this.pressedAlpha) + d.b(d.b(Float.hashCode(this.draggedAlpha) * 31, 31, this.focusedAlpha), 31, this.hoveredAlpha);
    }
    ...
    public String toString() {
        ...
        return d.o(sb, this.pressedAlpha, ')');
    }
}
