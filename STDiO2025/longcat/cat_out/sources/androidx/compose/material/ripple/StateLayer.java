...
final class StateLayer {
    ...
    public final void m1385drawStateLayermxwnekA(DrawScope drawScope, float f2, long j2) {
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM3791copywmQWz5c$default = Color.m3791copywmQWz5c$default(j2, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m4323drawCircleVaOC9Bg$default(drawScope, jM3791copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
    ...
    public final void handleInteraction$material_ripple_release(Interaction interaction, CoroutineScope scope) {
        ...
        if (interaction2 != null) {
            ...
            BuildersKt__Builders_commonKt.launch$default(scope, null, null, new StateLayer$handleInteraction$1(this, z ? rippleAlphaInvoke.getHoveredAlpha() : interaction instanceof FocusInteraction.Focus ? rippleAlphaInvoke.getFocusedAlpha() : interaction instanceof DragInteraction.Start ? rippleAlphaInvoke.getDraggedAlpha() : 0.0f, RippleKt.incomingStateLayerAnimationSpecFor(interaction2), null), 3, null);
        } else {
