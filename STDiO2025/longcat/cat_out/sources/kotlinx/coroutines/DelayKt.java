    ...
    */
    ...
    public static final Object delay(long j2, Continuation<? super Unit> continuation) {
        ...
        if (j2 < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getContext()).mo8054scheduleResumeAfterDelay(j2, cancellableContinuationImpl);
        }
    ...
    public static final Object m7987delayVtjQ1oo(long j2, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m7988toDelayMillisLRDsOJo(j2), continuation);
    ...
    public static final long m7988toDelayMillisLRDsOJo(long j2) {
        if (Duration.m7821compareToLRDsOJo(j2, Duration.INSTANCE.m7925getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7840getInWholeMillisecondsimpl(j2), 1L);
        }
        return 0L;
    }
}
