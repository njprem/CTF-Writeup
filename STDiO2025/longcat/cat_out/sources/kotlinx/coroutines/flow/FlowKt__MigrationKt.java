...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final class C07661<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C07661(long j2, Continuation<? super C07661> continuation) {
            super(2, continuation);
            this.$timeMillis = j2;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C07661(this.$timeMillis, continuation);
        }
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C07661) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j2) {
        return FlowKt.onStart(flow, new C07661(j2, null));
    }
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m8027catch(flow, new AnonymousClass2(function1, t, null));
    }
