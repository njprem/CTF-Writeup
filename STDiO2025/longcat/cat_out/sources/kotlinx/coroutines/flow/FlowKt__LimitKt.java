...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    public static final class C07641<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C07641(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C07641> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07641 c07641 = new C07641(this.$this_transformWhile, this.$transform, continuation);
            c07641.L$0 = obj;
            return c07641;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C07641) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    */
    ...
    public static final <T> Flow<T> drop(final Flow<? extends T> flow, final int i2) {
        ...
        throw new IllegalArgumentException(a.n("Drop count should be non-negative, but had ", i2).toString());
    }
    ...
    */
    ...
    public static final <T> Flow<T> take(Flow<? extends T> flow, int i2) {
        ...
        throw new IllegalArgumentException(d.l(i2, "Requested element count ", " should be positive").toString());
    }
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C07641(flow, function3, null));
    }
}
