...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final class C07613 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        public C07613(long j2, long j3, Continuation<? super C07613> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07613 c07613 = new C07613(this.$initialDelayMillis, this.$delayMillis, continuation);
            c07613.L$0 = obj;
            return c07613;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L5c:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C07613.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C07613) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C07622<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        public C07622(long j2, Flow<? extends T> flow, Continuation<? super C07622> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C07622 c07622 = new C07622(this.$periodMillis, this.$this_sample, continuation);
            c07622.L$0 = coroutineScope;
            c07622.L$1 = flowCollector;
            return c07622.invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> m8031debounceHG0u8IE(Flow<? extends T> flow, long j2) {
        return FlowKt.debounce(flow, DelayKt.m7988toDelayMillisLRDsOJo(j2));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m7988toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j2, long j3) {
        ...
        if (j3 >= 0) {
            return ProduceKt.produce$default(coroutineScope, null, 0, new C07613(j3, j2, null), 1, null);
        }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j2) {
        if (j2 > 0) {
            return FlowCoroutineKt.scopedFlow(new C07622(j2, flow, null));
        }
        throw new IllegalArgumentException("Sample period should be positive");
    }

    /* renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m8032sampleHG0u8IE(Flow<? extends T> flow, long j2) {
        return FlowKt.sample(flow, DelayKt.m7988toDelayMillisLRDsOJo(j2));
    }

    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m8033timeoutHG0u8IE(Flow<? extends T> flow, long j2) {
        return m8034timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j2);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m8034timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j2) {
