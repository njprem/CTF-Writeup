...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final class C07631 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        public C07631(Continuation<? super C07631> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C07631(continuation);
        }
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C07631) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> m8038catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
