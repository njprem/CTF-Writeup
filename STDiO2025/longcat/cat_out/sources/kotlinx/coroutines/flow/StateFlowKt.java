...
public final class StateFlowKt {
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        AbstractC0125b abstractC0125b;
        do {
            abstractC0125b = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(abstractC0125b, function1.invoke(abstractC0125b)));
    }
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            abstractC0125b = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(abstractC0125b);
        } while (!mutableStateFlow.compareAndSet(abstractC0125b, tInvoke));
        return tInvoke;
    }
}
