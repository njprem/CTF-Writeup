...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    public String toString() {
        ...
        return d.p(new StringBuilder("SharingStarted.WhileSubscribed("), CollectionsKt___CollectionsKt.joinToString$default(CollectionsKt.build(listCreateListBuilder), null, null, null, 0, null, null, 63, null), ')');
    }
}
