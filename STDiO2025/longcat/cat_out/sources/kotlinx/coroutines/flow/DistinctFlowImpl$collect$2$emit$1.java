...
public final class DistinctFlowImpl$collect$2$emit$1 extends ContinuationImpl {
    ...
    public DistinctFlowImpl$collect$2$emit$1(DistinctFlowImpl.AnonymousClass2<? super T> anonymousClass2, Continuation<? super DistinctFlowImpl$collect$2$emit$1> continuation) {
        super(continuation);
