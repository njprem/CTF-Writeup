...
public final class CancellableFlowImpl$collect$2$emit$1 extends ContinuationImpl {
    ...
    public CancellableFlowImpl$collect$2$emit$1(CancellableFlowImpl.AnonymousClass2<? super T> anonymousClass2, Continuation<? super CancellableFlowImpl$collect$2$emit$1> continuation) {
        super(continuation);
