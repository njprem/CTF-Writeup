...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM6501exceptionOrNullimpl = Result.m6501exceptionOrNullimpl(result);
        if (thM6501exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM6501exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
