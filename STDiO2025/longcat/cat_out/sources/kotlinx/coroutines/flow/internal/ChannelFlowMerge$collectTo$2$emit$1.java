...
public final class ChannelFlowMerge$collectTo$2$emit$1 extends ContinuationImpl {
    ...
    public ChannelFlowMerge$collectTo$2$emit$1(ChannelFlowMerge.AnonymousClass2<? super T> anonymousClass2, Continuation<? super ChannelFlowMerge$collectTo$2$emit$1> continuation) {
        super(continuation);
