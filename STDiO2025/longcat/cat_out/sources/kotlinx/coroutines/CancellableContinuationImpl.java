...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final void callSegmentOnCancellation(Segment<?> segment, Throwable cause) {
        ...
        try {
            segment.onCancellation(i2, cause, getContext());
        } catch (Throwable th) {
            CoroutineExceptionHandlerKt.handleCoroutineException(getContext(), new CompletionHandlerException("Exception in invokeOnCancellation handler for " + this, th));
        }
    }
        ...
        while (true) {
            ...
            if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    CompletedContinuation completedContinuationCopy$default = CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null);
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3 = _state$FU;
                    while (true) {
                        if (atomicReferenceFieldUpdater3.compareAndSet(this, obj, completedContinuationCopy$default)) {
                            break;
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                Object objResumedState = resumedState((NotCompleted) obj2, obj, i2, function1, null);
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = _state$FU;
                while (!atomicReferenceFieldUpdater2.compareAndSet(this, obj2, objResumedState)) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ void resumeImpl$default(CancellableContinuationImpl cancellableContinuationImpl, Object obj, int i2, Function1 function1, int i3, Object obj2) {
        if (obj2 != null) {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            obj2 = idempotent;
            function1 = onCancellation;
            Object objResumedState = resumedState((NotCompleted) obj3, obj, this.resumeMode, function1, obj2);
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = _state$FU;
