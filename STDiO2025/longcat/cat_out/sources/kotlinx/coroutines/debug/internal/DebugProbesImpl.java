...
public final class DebugProbesImpl {
    ...
    static {
        ...
        ARTIFICIAL_FRAME = AbstractC0130a.b(new Exception(), AbstractC0131b.class.getSimpleName());
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                ...
                objM6498constructorimpl = Result.m6498constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
            ...
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM6498constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM6498constructorimpl = Result.m6498constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6498constructorimpl = Result.m6498constructorimpl(ResultKt.createFailure(th));
        }
        return (Function1) (Result.m6504isFailureimpl(objM6498constructorimpl) ? null : objM6498constructorimpl);
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        return new Object[]{d.p(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null), ']'), arrayList.toArray(new Thread[0]), arrayList2.toArray(new CoroutineStackFrame[0]), listDumpCoroutinesInfo.toArray(new DebugCoroutineInfo[0])};
    }
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        return d.p(new StringBuilder("["), CollectionsKt___CollectionsKt.joinToString$default(arrayList, null, null, null, 0, null, null, 63, null), ']');
    }
