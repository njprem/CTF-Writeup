...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public final class Core {
        ...
        private final void removeCleanedAt(int index) {
            while (true) {
                ...
                while (!atomicReferenceArray.compareAndSet(index, obj, null)) {
                    if (atomicReferenceArray.get(index) != obj) {
                        break;
                    }
                }
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            loop0: while (true) {
                ...
                if (hashedWeakRef == null) {
                    if (value != null) {
                        ...
                        HashedWeakRef<K> hashedWeakRef2 = weakKey0;
                        AtomicReferenceArray atomicReferenceArray = this.keys;
                        while (!atomicReferenceArray.compareAndSet(iIndex, null, hashedWeakRef2)) {
                            if (atomicReferenceArray.get(iIndex) != null) {
                                z = z2;
                                weakKey0 = hashedWeakRef2;
                            }
                        }
                        break loop0;
                    }
            ...
            while (true) {
                Object obj = this.values.get(iIndex);
                if (obj instanceof Marked) {
                    return ConcurrentWeakMapKt.REHASH;
                }
                AtomicReferenceArray atomicReferenceArray2 = this.values;
                while (!atomicReferenceArray2.compareAndSet(iIndex, obj, value)) {
                    if (atomicReferenceArray2.get(iIndex) != obj) {
                        break;
                    }
                }
                return obj;
                ...
                while (i2 < i3) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            ...
                            while (!atomicReferenceArray.compareAndSet(i2, obj, markedMark)) {
    ...
    private final void cleanWeakRef(HashedWeakRef<?> w2) {
        ((Core) core$FU.get(this)).cleanWeakRef(w2);
    }
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        return new KeyValueSet(new Function2<K, V, Map.Entry<K, V>>() { // from class: kotlinx.coroutines.debug.internal.ConcurrentWeakMap$entries$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Map.Entry<K, V> invoke(K k2, V v2) {
