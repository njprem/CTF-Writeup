...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6498constructorimpl = Result.m6498constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6498constructorimpl = Result.m6498constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6504isFailureimpl(objM6498constructorimpl) ? null : objM6498constructorimpl);
