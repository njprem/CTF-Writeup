...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e2) throws Throwable {
            ...
            if (ChannelResult.m8018isSuccessimpl(objMo7998trySendJP2dKIU)) {
                return true;
            }
            Throwable thM8012exceptionOrNullimpl = ChannelResult.m8012exceptionOrNullimpl(objMo7998trySendJP2dKIU);
    ...
    Object mo7998trySendJP2dKIU(E element);
}
