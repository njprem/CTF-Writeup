...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public AnonymousClass2(BroadcastChannelImpl<E> broadcastChannelImpl, Object obj, SelectInstance<?> selectInstance, Continuation<? super AnonymousClass2> continuation) {
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(BroadcastChannelImpl<E> broadcastChannelImpl, Continuation<? super AnonymousClass1> continuation) {
            super(continuation);
            this.this$0 = broadcastChannelImpl;
        }
    ...
    public BroadcastChannelImpl(int i2) {
        ...
        this.capacity = i2;
        if (i2 < 1 && i2 != -1) {
            throw new IllegalArgumentException(d.l(i2, "BroadcastChannel capacity must be positive or Channel.CONFLATED, but ", " was specified").toString());
        }
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                ((BufferedChannel) subscriberConflated).mo7998trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo7998trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo7998trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo7998trySendJP2dKIU(element);
            }
