...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo8002receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object objMo8002receiveCatchingJP2dKIU = this._channel.mo8002receiveCatchingJP2dKIU(continuation);
        IntrinsicsKt.getCOROUTINE_SUSPENDED();
        return objMo8002receiveCatchingJP2dKIU;
    }
    ...
    public Object mo8003tryReceivePtdJZtk() {
        return this._channel.mo8003tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7998trySendJP2dKIU(E element) {
        return this._channel.mo7998trySendJP2dKIU(element);
    }
