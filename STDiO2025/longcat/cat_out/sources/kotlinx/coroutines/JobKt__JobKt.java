...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ Job m7992Job(Job job) {
        return JobKt.Job(job);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m7993Job$default(Job job, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            job = null;
        }
        return m7992Job(job);
    ...
    public static /* synthetic */ void cancelChildren$default(Job job, Throwable th, int i2, Object obj) throws Throwable {
        if ((i2 & 1) != 0) {
            th = null;
        }
    ...
    public static /* synthetic */ void cancelChildren$default(CoroutineContext coroutineContext, Throwable th, int i2, Object obj) throws Throwable {
        if ((i2 & 1) != 0) {
            th = null;
        }
