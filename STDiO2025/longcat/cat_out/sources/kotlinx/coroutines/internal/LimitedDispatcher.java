...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i2 >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo8053dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo8053dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo8053dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
    ...
    public void mo8054scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo8054scheduleResumeAfterDelay(timeMillis, continuation);
    }
}
