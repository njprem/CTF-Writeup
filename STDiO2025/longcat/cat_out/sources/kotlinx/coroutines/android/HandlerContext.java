...
public final class HandlerContext extends HandlerDispatcher implements Delay {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.a
                ...
                public final void dispose() {
                    HandlerContext.invokeOnTimeout$lambda$3(this.f904a, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public void mo8054scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
