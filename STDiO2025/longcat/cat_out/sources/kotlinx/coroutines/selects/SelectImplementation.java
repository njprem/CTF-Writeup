...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    public static final class C07821 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C07821(SelectImplementation<R> selectImplementation, Continuation<? super C07821> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.SelectImplementation.C07821
            if (r0 == 0) goto L13
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C07821) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r3 = r1 & r2
            if (r3 == 0) goto L13
    ...
    public static /* synthetic */ void register$default(SelectImplementation selectImplementation, ClauseData clauseData, boolean z, int i2, Object obj) {
        if (obj != null) {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuation) {
                ...
                if (clauseDataFindClause != null) {
                    ...
                    while (!atomicReferenceFieldUpdater.compareAndSet(this, obj, clauseDataFindClause)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    ...
                    while (true) {
                        if (atomicReferenceFieldUpdater.compareAndSet(this, obj, listListOf)) {
                            z = true;
                            break;
                        }
                        if (atomicReferenceFieldUpdater.get(this) != obj) {
                    ...
                    while (true) {
                        if (atomicReferenceFieldUpdater.compareAndSet(this, obj, listPlus)) {
                            z = true;
                            break;
                        }
                        if (atomicReferenceFieldUpdater.get(this) != obj) {
