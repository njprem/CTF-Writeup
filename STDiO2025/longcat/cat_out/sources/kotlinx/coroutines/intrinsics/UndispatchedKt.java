...
public final class UndispatchedKt {
        ...
        try {
            ...
            try {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m6498constructorimpl(objInvoke));
                }
            } finally {
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m6498constructorimpl(ResultKt.createFailure(th)));
        }
    }
    ...
    public static final <R, T> void startCoroutineUndispatched(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r2, Continuation<? super T> continuation) {
        ...
        try {
            ...
            Object objUpdateThreadContext = ThreadContextKt.updateThreadContext(context, null);
            try {
                Object objInvoke = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(r2, continuationProbeCoroutineCreated);
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m6498constructorimpl(objInvoke));
                }
            } finally {
