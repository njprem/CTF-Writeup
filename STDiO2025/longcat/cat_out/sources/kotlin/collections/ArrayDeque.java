...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public ArrayDeque(int i2) {
        ...
        if (i2 == 0) {
            ...
            if (i2 <= 0) {
                throw new IllegalArgumentException(a.n("Illegal Capacity: ", i2));
            }
    ...
    private final void removeRangeShiftPreceding(int fromIndex, int toIndex) {
        ...
        while (fromIndex > 0) {
            ...
            int iMin = Math.min(fromIndex, Math.min(i2, iPositiveMod2 + 1));
            Object[] objArr = this.elementData;
            int i3 = iPositiveMod2 - iMin;
            int i4 = iPositiveMod - iMin;
            ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i3 + 1, i4 + 1, i2);
            iPositiveMod = negativeMod(i4);
            iPositiveMod2 = negativeMod(i3);
            fromIndex -= iMin;
        }
    }
    ...
    private final void removeRangeShiftSucceeding(int fromIndex, int toIndex) {
        ...
        while (true) {
            ...
            Object[] objArr2 = this.elementData;
            int i2 = iPositiveMod + toIndex;
            ArraysKt___ArraysJvmKt.copyInto(objArr2, objArr2, iPositiveMod2, iPositiveMod, i2);
    ...
    public final void internalStructure$kotlin_stdlib(Function2<? super Integer, ? super Object[], Unit> structure) {
        ...
        structure.invoke(Integer.valueOf((isEmpty() || (i2 = this.head) < positiveMod(size() + this.head)) ? this.head : i2 - this.elementData.length), toArray());
    }
    ...
    public void removeRange(int fromIndex, int toIndex) {
        ...
        if (fromIndex < size() - toIndex) {
            ...
            int iPositiveMod2 = positiveMod(size() + this.head);
            nullifyNonEmpty(negativeMod(iPositiveMod2 - i2), iPositiveMod2);
        }
        this.size = size() - i2;
    }
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i2 = this.head;
        if (i2 < iPositiveMod) {
            ArraysKt___ArraysJvmKt.copyInto$default(this.elementData, tArr, 0, i2, iPositiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
