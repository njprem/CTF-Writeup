...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    ...
    public static final /* synthetic */ Double m6925max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m6933maxOrNull((Iterable<Double>) iterable);
    }
    ...
    public static final /* synthetic */ <T, R extends Comparable<? super R>> T maxBy(Iterable<? extends T> iterable, Function1<? super T, ? extends R> function1) {
        Iterator itR = a.r(iterable, "<this>", function1, "selector");
        if (!itR.hasNext()) {
            return null;
        }
        ?? r0 = (Object) itR.next();
    ...
    public static final /* synthetic */ Double m6927min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m6941minOrNull((Iterable<Double>) iterable);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m6926max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m6934maxOrNull((Iterable<Float>) iterable);
    }

    @Deprecated(message = "Use minOrNull instead.", replaceWith = @ReplaceWith(expression = "this.minOrNull()", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m6928min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m6942minOrNull((Iterable<Float>) iterable);
    }
