...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        throw new IndexOutOfBoundsException(d.n("fromIndex: ", fromIndex, toIndex, ", toIndex: "));
    }
    ...
    public Void get(int index) {
        throw new IndexOutOfBoundsException(d.m("Empty list doesn't contain element at index ", index, '.'));
    }
    ...
    public ListIterator listIterator(int index) {
        ...
        throw new IndexOutOfBoundsException(a.n("Index: ", index));
    }
