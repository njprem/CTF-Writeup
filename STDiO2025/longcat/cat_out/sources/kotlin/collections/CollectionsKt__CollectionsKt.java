...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(List<? extends T> list, T t, int i2, int i3) {
        ...
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
            int iCompareValues = ComparisonsKt.compareValues(list.get(i5), t);
            if (iCompareValues < 0) {
                i2 = i5 + 1;
            } else {
                if (iCompareValues <= 0) {
    ...
    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i2, int i3, Function1 selector, int i4, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return binarySearch(list, i2, i3, new AnonymousClass1(selector, comparable));
    }
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i2, int i3, int i4) {
        ...
        if (i3 < 0) {
            throw new IndexOutOfBoundsException(d.l(i3, "fromIndex (", ") is less than zero."));
        }
        if (i4 <= i2) {
            return;
        }
    ...
    public static <T> int binarySearch(List<? extends T> list, int i2, int i3, Function1<? super T, Integer> comparison) {
        Intrinsics.checkNotNullParameter(list, "<this>");
