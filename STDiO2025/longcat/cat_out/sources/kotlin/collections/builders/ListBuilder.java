...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        public static final class Itr<E> implements ListIterator<E>, KMutableListIterator {
            ...
            public Itr(BuilderSubList<E> list, int i2) {
        ...
        public int indexOf(Object element) {
            ...
            for (int i2 = 0; i2 < this.length; i2++) {
                if (Intrinsics.areEqual(this.backing[this.offset + i2], element)) {
                    return i2;
                }
            }
            return -1;
        ...
        public <T> T[] toArray(T[] array) {
            ...
            if (length >= i2) {
                E[] eArr = this.backing;
                int i3 = this.offset;
                ArraysKt.copyInto(eArr, array, 0, i3, i2 + i3);
    ...
    private final void insertAtInternal(int i2, int n2) {
        ...
        E[] eArr = this.backing;
        ArraysKt.copyInto(eArr, eArr, i2 + n2, i2, this.length);
        this.length += n2;
    }
    ...
    public final E removeAtInternal(int i2) {
        ...
        E[] eArr = this.backing;
        E e2 = eArr[i2];
        ArraysKt.copyInto(eArr, eArr, i2, i2 + 1, this.length);
    ...
    public int indexOf(Object element) {
        for (int i2 = 0; i2 < this.length; i2++) {
            if (Intrinsics.areEqual(this.backing[i2], element)) {
                return i2;
            }
        }
        return -1;
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i2 = this.length;
        if (length >= i2) {
            ArraysKt.copyInto(this.backing, array, 0, 0, i2);
            return (T[]) CollectionsKt.terminateCollectionToArray(this.length, array);
        }
    ...
    public ListBuilder(int i2) {
        this.backing = (E[]) ListBuilderKt.arrayOfUninitializedElements(i2);
    }
