...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    private static final <K, V> Map<K, V> buildMap(int i2, Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map mapCreateMapBuilder = MapsKt__MapsJVMKt.createMapBuilder(i2);
        builderAction.invoke(mapCreateMapBuilder);
        return MapsKt__MapsJVMKt.build(mapCreateMapBuilder);
    }
    ...
    public static <K, V> void putAll(Map<? super K, ? super V> map, Sequence<? extends Pair<? extends K, ? extends V>> pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        for (Pair<? extends K, ? extends V> pair : pairs) {
            map.put(pair.component1(), pair.component2());
