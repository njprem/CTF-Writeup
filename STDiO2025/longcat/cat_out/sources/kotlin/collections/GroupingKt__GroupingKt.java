...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(Grouping<T, ? extends K> grouping, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            ThreadFactoryC0124a threadFactoryC0124a = (Object) linkedHashMap.get(objKeyOf);
            linkedHashMap.put(objKeyOf, operation.invoke(objKeyOf, threadFactoryC0124a, next, Boolean.valueOf(threadFactoryC0124a == null && !linkedHashMap.containsKey(objKeyOf))));
        }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(Grouping<T, ? extends K> grouping, M destination, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            Object objKeyOf = grouping.keyOf(next);
            ThreadFactoryC0124a threadFactoryC0124a = (Object) destination.get(objKeyOf);
            destination.put(objKeyOf, operation.invoke(objKeyOf, threadFactoryC0124a, next, Boolean.valueOf(threadFactoryC0124a == null && !destination.containsKey(objKeyOf))));
        }
        return destination;
    }
    ...
    public static final <S, T extends S, K> Map<K, S> reduce(Grouping<T, ? extends K> grouping, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            ThreadFactoryC0124a threadFactoryC0124a = (Object) linkedHashMap.get(objKeyOf);
            if (!(threadFactoryC0124a == null && !linkedHashMap.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, threadFactoryC0124a, sInvoke);
            }
    ...
    public static final <S, T extends S, K, M extends Map<? super K, S>> M reduceTo(Grouping<T, ? extends K> grouping, M destination, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            Object objKeyOf = grouping.keyOf(sInvoke);
            ThreadFactoryC0124a threadFactoryC0124a = (Object) destination.get(objKeyOf);
            if (!(threadFactoryC0124a == null && !destination.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, threadFactoryC0124a, sInvoke);
            }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(Grouping<T, ? extends K> grouping, M destination, R r2, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            AbstractC0125b abstractC0125b = (Object) destination.get(kKeyOf);
            if (abstractC0125b == null && !destination.containsKey(kKeyOf)) {
                abstractC0125b = (Object) r2;
            }
            destination.put(kKeyOf, operation.invoke(abstractC0125b, next));
        }
        return destination;
    }
    ...
    public static final <T, K, R> Map<K, R> fold(Grouping<T, ? extends K> grouping, R r2, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            K kKeyOf = grouping.keyOf(next);
            AbstractC0125b abstractC0125b = (Object) linkedHashMap.get(kKeyOf);
            if (abstractC0125b == null && !linkedHashMap.containsKey(kKeyOf)) {
                abstractC0125b = (Object) r2;
            }
            linkedHashMap.put(kKeyOf, operation.invoke(abstractC0125b, next));
        }
        return linkedHashMap;
    }
}
