...
public final class SlidingWindowKt {
    ...
    public static final class AnonymousClass1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super List<? extends T>>, Continuation<? super Unit>, Object> {
        ...
        public AnonymousClass1(int i2, int i3, Iterator<? extends T> it, boolean z, boolean z2, Continuation<? super AnonymousClass1> continuation) {
    ...
    public static final void checkWindowSizeStep(int i2, int i3) {
        ...
        if (i2 <= 0 || i3 <= 0) {
            if (i2 != i3) {
                strL = "Both size " + i2 + " and step " + i3 + " must be greater than zero.";
            } else {
                strL = d.l(i2, "size ", " must be greater than zero.");
            }
    ...
    public static final <T> Iterator<List<T>> windowedIterator(Iterator<? extends T> iterator, int i2, int i3, boolean z, boolean z2) {
        ...
        return !iterator.hasNext() ? EmptyIterator.INSTANCE : SequencesKt.iterator(new AnonymousClass1(i2, i3, iterator, z2, z, null));
    }

    public static final <T> Sequence<List<T>> windowedSequence(final Sequence<? extends T> sequence, final int i2, final int i3, final boolean z, final boolean z2) {
        ...
        return new Sequence<List<? extends T>>() { // from class: kotlin.collections.SlidingWindowKt$windowedSequence$$inlined$Sequence$1
            ...
            public Iterator<List<? extends T>> iterator() {
                return SlidingWindowKt.windowedIterator(sequence.iterator(), i2, i3, z, z2);
            }
        };
    }
}
