...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m7731fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    public int hashCode() {
        ...
        long j2 = this.first;
        int iM6672constructorimpl = ((int) ULong.m6672constructorimpl(j2 ^ ULong.m6672constructorimpl(j2 >>> 32))) * 31;
        long j3 = this.last;
        int iM6672constructorimpl2 = (iM6672constructorimpl + ((int) ULong.m6672constructorimpl(j3 ^ ULong.m6672constructorimpl(j3 >>> 32)))) * 31;
        long j4 = this.step;
        return iM6672constructorimpl2 + ((int) ((j4 >>> 32) ^ j4));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m6718toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m6718toStringimpl(this.last));
            sb.append(" step ");
            j2 = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j2, long j3, long j4) {
        ...
        this.first = j2;
        this.last = UProgressionUtilKt.m7705getProgressionLastElement7ftBX0g(j2, j3, j4);
        this.step = j4;
    }
}
