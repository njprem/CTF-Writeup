...
class FilesKt__FilePathComponentsKt {
    ...
    private static final int getRootLength$FilesKt__FilePathComponentsKt(String str) {
        ...
        int iIndexOf$default2 = StringsKt__StringsKt.indexOf$default(str, c2, 0, false, 4, (Object) null);
        if (iIndexOf$default2 == 0) {
            if (str.length() <= 1 || str.charAt(1) != c2 || (iIndexOf$default = StringsKt__StringsKt.indexOf$default(str, c2, 2, false, 4, (Object) null)) < 0) {
                return 1;
            }
            int iIndexOf$default3 = StringsKt__StringsKt.indexOf$default(str, c2, iIndexOf$default + 1, false, 4, (Object) null);
