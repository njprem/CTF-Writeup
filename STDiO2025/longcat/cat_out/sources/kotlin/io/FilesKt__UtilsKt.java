...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final File copyTo(File file, File target, boolean z, int i2) throws IOException {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        if (!file.exists()) {
    ...
    public static final String getInvariantSeparatorsPath(File file) {
        ...
        return c2 != '/' ? StringsKt__StringsJVMKt.replace$default(path, File.separatorChar, '/', false, 4, (Object) null) : path;
    }
    ...
    public static final File resolve(File file, File relative) {
        ...
        if (string.length() != 0) {
            char c2 = File.separatorChar;
            if (!StringsKt__StringsKt.endsWith$default((CharSequence) string, c2, false, 2, (Object) null)) {
