...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path target, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, final boolean z, boolean z2) {
        ...
        return z2 ? copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
            ...
            public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                return invoke2(copyActionContext, d.m(path2), d.m(path3));
            }

            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final CopyActionResult invoke2(CopyActionContext copyToRecursively, Path src, Path dst) throws IOException {
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function32, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                checkFileName(path4);
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, d.m(CollectionsKt.last((List) arrayList)));
            }
    ...
    public static /* synthetic */ Path copyToRecursively$default(Path path, Path path2, Function3 function3, boolean z, boolean z2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                @Override // kotlin.jvm.functions.Function3
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(d.m(obj2), d.m(obj3), (Exception) obj4);
                }
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        FileSystemException fileSystemExceptionH = a.h();
        Iterator<T> it = listDeleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.iterator();
        while (it.hasNext()) {
            ExceptionsKt.addSuppressed(fileSystemExceptionH, (Exception) it.next());
        }
        throw fileSystemExceptionH;
    }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) throws IOException {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                try {
                    DirectoryStream directoryStreamE = a.e(directoryStreamNewDirectoryStream);
                    if (a.x(directoryStreamE)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamO = b.o(directoryStreamE);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamO, fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0036 A[Catch: Exception -> 0x0013, NoSuchFileException -> 0x003f, TRY_LEAVE, TryCatch #0 {NoSuchFileException -> 0x003f, blocks: (B:11:0x0030, B:12:0x0036), top: B:19:0x0021 }] */
    /* JADX WARN: Removed duplicated region for block: B:9:0x0023 A[Catch: Exception -> 0x0013, TRY_LEAVE, TryCatch #1 {Exception -> 0x0013, blocks: (B:4:0x0005, B:7:0x0015, B:9:0x0023, B:11:0x0030, B:12:0x0036), top: B:21:0x0005 }] */
    /*
    ...
    */
    private static final void handleEntry$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r2, java.nio.file.Path r3, java.nio.file.Path r4, kotlin.io.path.ExceptionsCollector r5) throws java.io.IOException {
        ...
        L15:
            ...
            java.nio.file.LinkOption r0 = java.nio.file.LinkOption.NOFOLLOW_LINKS     // Catch: java.lang.Exception -> L13
            r1 = 0
            ...
            if (r4 != r0) goto L3f
            r2.deleteDirectory(r3)     // Catch: java.lang.Exception -> L13 java.nio.file.NoSuchFileException -> L3f
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch: java.lang.Exception -> L13 java.nio.file.NoSuchFileException -> L3f
            goto L3f
        L36:
            r2.deleteFile(r3)     // Catch: java.lang.Exception -> L13 java.nio.file.NoSuchFileException -> L3f
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch: java.lang.Exception -> L13 java.nio.file.NoSuchFileException -> L3f
            goto L3f
        L3c:
            r5.collect(r2)
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        Intrinsics.checkNotNullParameter(onError, "onError");
        ...
        PathsKt__PathUtilsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            public /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(d.m(path), b.p(basicFileAttributes));
                }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPreVisitDirectory(new Function2<Path, BasicFileAttributes, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.1
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path5, BasicFileAttributes basicFileAttributes) {
                        return invoke2(d.m(path5), b.p(basicFileAttributes));
                    }
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path8, IOException iOException) {
                        return invoke2(d.m(path8), iOException);
                    }
                    ...
                    public final FileVisitResult invoke2(Path directory, IOException iOException) {
                        ...
                        return iOException == null ? FileVisitResult.CONTINUE : PathsKt__PathRecursiveFunctionsKt.copyToRecursively$error$PathsKt__PathRecursiveFunctionsKt(function33, path5, path6, path7, directory, iOException);
                    }
                });
            }
        }, 1, (Object) null);
    ...
    public static /* synthetic */ Path copyToRecursively$default(Path path, Path path2, Function3 function3, final boolean z, Function3 function32, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, d.m(path3), d.m(path4));
                }
