...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
            z = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    private static final void forEachDirectoryEntry(Path path, String glob, Function1<? super Path, Unit> action) throws IOException {
        ...
        try {
            ...
            Intrinsics.checkNotNull(directoryStreamE);
            Iterator it = directoryStreamE.iterator();
            while (it.hasNext()) {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamE = a.e(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamE);
            List<Path> list = CollectionsKt.toList(directoryStreamE);
            CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            return list;
        } finally {
        }
    ...
    public static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
            z = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamE = a.e(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamE);
            T tInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamE));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i2, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamE = a.e(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamE);
            Object objInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamE));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    public static final void visitFileTree(Path path, FileVisitor<Path> visitor, int i2, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(visitor, "visitor");
        Files.walkFileTree(path, z ? SetsKt.setOf(FileVisitOption.FOLLOW_LINKS) : SetsKt.emptySet(), i2, visitor);
    }

    public static /* synthetic */ void visitFileTree$default(Path path, FileVisitor fileVisitor, int i2, boolean z, int i3, Object obj) throws IOException {
        if ((i3 & 2) != 0) {
        ...
        visitFileTree(path, (FileVisitor<Path>) fileVisitor, i2, z);
    }
    ...
    public static /* synthetic */ void visitFileTree$default(Path path, int i2, boolean z, Function1 function1, int i3, Object obj) throws IOException {
        if ((i3 & 1) != 0) {
            i2 = Integer.MAX_VALUE;
        }
        if ((i3 & 2) != 0) {
        ...
        visitFileTree(path, i2, z, (Function1<? super FileVisitorBuilder, Unit>) function1);
    }
    ...
    public static final void visitFileTree(Path path, int i2, boolean z, Function1<? super FileVisitorBuilder, Unit> builderAction) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        visitFileTree(path, fileVisitor(builderAction), i2, z);
    }
}
