...
final class DecodeInputStream extends InputStream {
    ...
    private final void copyByteBufferInto(byte[] dst, int dstOffset, int length) {
        ...
        ArraysKt.copyInto(bArr, dst, dstOffset, i2, i2 + length);
    ...
    public int read() throws IOException {
        ...
        if (i2 < this.byteBufferEndIndex) {
            int i3 = this.byteBuffer[i2] & UByte.MAX_VALUE;
    ...
    */
    public int read(byte[] r10, int r11, int r12) throws java.io.IOException {
        ...
        L86:
            ...
            java.lang.String r3 = ", buffer size: "
            java.lang.StringBuilder r11 = J.d.q(r1, r11, r12, r2, r3)
            int r10 = r10.length
            r11.append(r10)
