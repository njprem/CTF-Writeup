...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static /* synthetic */ void appendText$default(File file, String str, Charset charset, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
    ...
    public static ByteBuffer byteBufferForEncoding(int i2, CharsetEncoder encoder) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        ByteBuffer byteBufferAllocate = ByteBuffer.allocate(i2 * ((int) Math.ceil(encoder.maxBytesPerChar())));
        Intrinsics.checkNotNullExpressionValue(byteBufferAllocate, "allocate(...)");
        return byteBufferAllocate;
    }

    public static final void forEachBlock(File file, Function2<? super byte[], ? super Integer, Unit> action) throws IOException {
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    public static /* synthetic */ void forEachLine$default(File file, Charset charset, Function1 function1, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    public static final byte[] readBytes(File file) throws IOException {
        ...
        try {
            ...
            int i4 = 0;
            while (i3 > 0) {
                int i5 = fileInputStream.read(bArrCopyInto, i4, i3);
                if (i5 < 0) {
                    break;
                }
                i3 -= i5;
    ...
    public static /* synthetic */ void writeText$default(File file, String str, Charset charset, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    public static void writeTextImpl(OutputStream outputStream, String text, Charset charset) throws IOException {
        ...
        while (i2 < text.length()) {
            int iMin = Math.min(8192 - i3, text.length() - i2);
            int i4 = i2 + iMin;
            char[] cArrArray = charBufferAllocate.array();
            Intrinsics.checkNotNullExpressionValue(cArrArray, "array(...)");
            text.getChars(i2, i4, cArrArray, i3);
            charBufferAllocate.limit(iMin + i3);
            i3 = 1;
            if (!charsetEncoderNewReplaceEncoder.encode(charBufferAllocate, byteBufferByteBufferForEncoding, i4 == text.length()).isUnderflow()) {
    ...
    public static final void forEachBlock(File file, int i2, Function2<? super byte[], ? super Integer, Unit> action) throws IOException {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        ?? r2 = new byte[RangesKt.coerceAtLeast(i2, 512)];
        FileInputStream fileInputStream = new FileInputStream(file);
        while (true) {
            try {
