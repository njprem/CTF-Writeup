...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo7812elapsedNowUwyO8pc() {
        return Duration.m7857minusLRDsOJo(this.mark.mo7812elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo7813minusLRDsOJo(long j2) {
        return TimeMark.DefaultImpls.m7959minusLRDsOJo(this, j2);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo7815plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7858plusLRDsOJo(this.adjustment, duration), null);
    }
