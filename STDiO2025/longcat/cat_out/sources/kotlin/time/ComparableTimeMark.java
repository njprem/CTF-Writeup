...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            ...
            return Duration.m7821compareToLRDsOJo(comparableTimeMark.mo7814minusUwyO8pc(other), Duration.INSTANCE.m7925getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m7817minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j2) {
            return comparableTimeMark.mo7815plusLRDsOJo(Duration.m7875unaryMinusUwyO8pc(j2));
        }
    }
    ...
    ComparableTimeMark mo7813minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo7814minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo7815plusLRDsOJo(long duration);
}
