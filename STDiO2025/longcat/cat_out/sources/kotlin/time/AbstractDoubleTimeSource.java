...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo7812elapsedNowUwyO8pc() {
            return Duration.m7857minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m7827equalsimpl0(mo7814minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m7925getZEROUwyO8pc());
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m7850hashCodeimpl(Duration.m7858plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo7814minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m7827equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m7854isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m7925getZEROUwyO8pc();
                    }
                    long jM7857minusLRDsOJo = Duration.m7857minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m7827equalsimpl0(duration, Duration.m7875unaryMinusUwyO8pc(jM7857minusLRDsOJo)) ? Duration.INSTANCE.m7925getZEROUwyO8pc() : Duration.m7858plusLRDsOJo(duration, jM7857minusLRDsOJo);
                }
            }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m7871toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
        ...
        public ComparableTimeMark mo7815plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m7858plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m7925getZEROUwyO8pc(), null);
    }
}
