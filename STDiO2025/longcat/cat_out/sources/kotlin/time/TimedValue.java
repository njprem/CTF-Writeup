...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m7980copyRFiDyg4$default(TimedValue timedValue, Object obj, long j2, int i2, Object obj2) {
        if ((i2 & 1) != 0) {
        ...
        return timedValue.m7982copyRFiDyg4(obj, j2);
    }
    ...
    public final TimedValue<T> m7982copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m7827equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m7983getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return Duration.m7850hashCodeimpl(this.duration) + ((t == null ? 0 : t.hashCode()) * 31);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m7871toStringimpl(this.duration)) + ')';
    }
