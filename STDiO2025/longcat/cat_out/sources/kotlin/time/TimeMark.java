...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(TimeMark timeMark) {
            return Duration.m7855isNegativeimpl(timeMark.mo7812elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m7959minusLRDsOJo(TimeMark timeMark, long j2) {
            return timeMark.mo7815plusLRDsOJo(Duration.m7875unaryMinusUwyO8pc(j2));
        }

        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7960plusLRDsOJo(TimeMark timeMark, long j2) {
    ...
    TimeMark mo7813minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo7815plusLRDsOJo(long duration);
}
