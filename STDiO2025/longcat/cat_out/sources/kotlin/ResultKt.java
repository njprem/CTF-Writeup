...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable thM6501exceptionOrNullimpl = Result.m6501exceptionOrNullimpl(obj);
        return thM6501exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM6501exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r2) {
        return Result.m6504isFailureimpl(obj) ? r2 : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM6501exceptionOrNullimpl = Result.m6501exceptionOrNullimpl(obj);
        return thM6501exceptionOrNullimpl == null ? obj : onFailure.invoke(thM6501exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m6505isSuccessimpl(obj) ? Result.m6498constructorimpl(transform.invoke(obj)) : Result.m6498constructorimpl(obj);
    }

    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m6505isSuccessimpl(obj)) {
            return Result.m6498constructorimpl(obj);
        }
        try {
            return Result.m6498constructorimpl(transform.invoke(obj));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6498constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable thM6501exceptionOrNullimpl = Result.m6501exceptionOrNullimpl(obj);
        if (thM6501exceptionOrNullimpl != null) {
            action.invoke(thM6501exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable thM6501exceptionOrNullimpl = Result.m6501exceptionOrNullimpl(obj);
        return thM6501exceptionOrNullimpl == null ? obj : Result.m6498constructorimpl(transform.invoke(thM6501exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        try {
            return Result.m6498constructorimpl(transform.invoke(thM6501exceptionOrNullimpl));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6498constructorimpl(createFailure(th));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6498constructorimpl(block.invoke());
        } catch (Throwable th) {
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6498constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m6498constructorimpl(createFailure(th));
        }
