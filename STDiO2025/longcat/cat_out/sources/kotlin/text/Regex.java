...
public final class Regex implements Serializable {
    ...
    public static final class C07141 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        public C07141(CharSequence charSequence, int i2, Continuation<? super C07141> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07141 c07141 = Regex.this.new C07141(this.$input, this.$limit, continuation);
            c07141.L$0 = obj;
            return c07141;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r10) {
            ...
            Laf:
                ...
                return r10
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.text.Regex.C07141.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07141) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Sequence<MatchResult> findAll(final CharSequence input, final int startIndex) {
        ...
        StringBuilder sbP = a.p(startIndex, "Start index out of bounds: ", ", input length: ");
        sbP.append(input.length());
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt__StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C07141(input, limit, null));
    }
