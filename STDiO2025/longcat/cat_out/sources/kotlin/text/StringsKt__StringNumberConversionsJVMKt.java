...
class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    private static final String toString(byte b2, int i2) {
        String string = Integer.toString(b2, CharsKt__CharJVMKt.checkRadix(i2));
    ...
    private static final String toString(short s2, int i2) {
        String string = Integer.toString(s2, CharsKt__CharJVMKt.checkRadix(i2));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }

    private static final String toString(int i2, int i3) {
        String string = Integer.toString(i2, CharsKt__CharJVMKt.checkRadix(i3));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
