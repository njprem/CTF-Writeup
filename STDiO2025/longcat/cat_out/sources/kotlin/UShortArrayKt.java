...
public final class UShortArrayKt {
    private static final short[] UShortArray(int i2, Function1<? super Integer, UShort> init) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            sArr[i3] = init.invoke(Integer.valueOf(i3)).getData();
        }
        return UShortArray.m6832constructorimpl(sArr);
    }

    /* renamed from: ushortArrayOf-rL5Bavg, reason: not valid java name */
    private static final short[] m6848ushortArrayOfrL5Bavg(short... elements) {
