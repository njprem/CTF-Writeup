...
public final class UByteArrayKt {
    private static final byte[] UByteArray(int i2, Function1<? super Integer, UByte> init) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            bArr[i3] = init.invoke(Integer.valueOf(i3)).getData();
        }
        return UByteArray.m6569constructorimpl(bArr);
    }

    /* renamed from: ubyteArrayOf-GBYM_sE, reason: not valid java name */
    private static final byte[] m6585ubyteArrayOfGBYM_sE(byte... elements) {
