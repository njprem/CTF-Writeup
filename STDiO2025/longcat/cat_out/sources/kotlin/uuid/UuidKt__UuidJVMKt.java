...
class UuidKt__UuidJVMKt {
    ...
    public static final Uuid getUuid(ByteBuffer byteBuffer, int i2) {
        ...
        if (i2 >= 0) {
            ...
            StringBuilder sbP = a.p(i2, "Not enough bytes to read a uuid at index: ", ", with limit: ");
            sbP.append(byteBuffer.limit());
            sbP.append(' ');
            throw new IndexOutOfBoundsException(sbP.toString());
        }
        throw new IndexOutOfBoundsException(a.n("Negative index: ", i2));
    }
    ...
    public static final ByteBuffer putUuid(ByteBuffer byteBuffer, int i2, Uuid uuid) {
        ...
        if (i2 >= 0) {
            ...
            StringBuilder sbP = a.p(i2, "Not enough capacity to write a uuid at index: ", ", with limit: ");
            sbP.append(byteBuffer.limit());
            sbP.append(' ');
            throw new IndexOutOfBoundsException(sbP.toString());
        }
