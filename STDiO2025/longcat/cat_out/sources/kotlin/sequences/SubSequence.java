...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public SubSequence(Sequence<? extends T> sequence, int i2, int i3) {
        ...
        this.endIndex = i3;
        if (i2 < 0) {
            throw new IllegalArgumentException(a.n("startIndex should be non-negative, but is ", i2).toString());
        }
        if (i3 < 0) {
            throw new IllegalArgumentException(a.n("endIndex should be non-negative, but is ", i3).toString());
        }
        if (i3 < i2) {
            throw new IllegalArgumentException(d.n("endIndex should be not less than startIndex, but was ", i3, i2, " < ").toString());
        }
    }
    ...
    public Sequence<T> take(int n2) {
        ...
        return new SubSequence(sequence, i2, n2 + i2);
    }
}
